//! # Mycelix Care - Sweettest Integration Tests
//!
...
mod timebank_tests {
    ...
    async fn test_create_and_get_offer() {
        ...
        let offer_record: Record = conductor
            .call(&cell.zome("timebank"), "create_service_offer", offer.clone())
            .await;
    ...
    async fn test_create_service_request() {
        ...
        let request_record: Record = conductor
            .call(&cell.zome("timebank"), "create_service_request", request.clone())
            .await;
        ...
        assert!(open_requests.len() >= 1, "Should have at least 1 open request");
...
mod integration_tests {
    ...
    async fn test_complete_care_exchange_flow() {
        ...
        let request_record: Record = conductor
            .call(&bob_cell.zome("timebank"), "create_service_request", request)
            .await;
        ...
        let exchange_record: Record = conductor
            .call(&alice_cell.zome("timebank"), "complete_exchange", exchange_input)
            .await;
