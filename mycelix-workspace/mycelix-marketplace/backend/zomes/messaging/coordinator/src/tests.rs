...
mod test_helpers {
    ...
    pub fn create_test_message(
        ...
        Message {
            ...
            conversation_id: ActionHash::from_raw_36(vec![0u8; 36]),
            sent_at: 1000,
            read_at: None,
    ...
    pub fn create_test_conversation(
        ...
        Conversation {
            ...
            transaction_hash: None,
            subject,
            first_message_hash: ActionHash::from_raw_36(vec![0u8; 36]),
            last_message_hash: ActionHash::from_raw_36(vec![0u8; 36]),
            message_count: 0,
