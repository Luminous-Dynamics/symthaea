...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! # Education Zome Integration Tests (Legacy Bridge)
//!
...
mod education_integration {
    ...
    async fn test_create_and_get_credential() {
        ...
        assert_eq!(
            cred.zk_commitment.len(),
            32,
            "ZK commitment should be 32 bytes"
        );
    }
    ...
    async fn test_revocation_request() {
        ...
        assert_ne!(
            ...
            "Revocation request should return a valid action hash"
        );
    }
}
