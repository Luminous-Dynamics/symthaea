...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Mycelix Property Shared Utilities
//!
//! This crate provides common functionality for all Mycelix Property zomes:
