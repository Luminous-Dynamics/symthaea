...
pub fn mock_contacts() -> Vec<ContactView> {
    vec![
        ContactView {
            hash: "c-001".into(),
            id: "alice".into(),
            display_name: "Alice Nakamura".into(),
            nickname: None,
        ...
        ContactView {
            hash: "c-004".into(),
            id: "dave".into(),
            display_name: "David Chen".into(),
            nickname: Some("Dave".into()),
        ...
        ContactView {
            hash: "c-007".into(),
            id: "grace".into(),
            display_name: "Grace Okonkwo".into(),
            nickname: None,
        ...
        ContactView {
            hash: "c-008".into(),
            id: "henry".into(),
            display_name: "Henry Pretorius".into(),
            nickname: None,
...
pub fn mock_calendar_events() -> Vec<CalendarEventView> {
    ...
    vec![
        CalendarEventView {
            id: "cal-001".into(),
            title: "Water Council Meeting".into(),
            description: Some("Monthly governance review for water stewardship".into()),
            location: Some("Community Hall, Room 3".into()),
            start_time: now + 2 * day + 14 * hour,
            end_time: now + 2 * day + 16 * hour,
            all_day: false,
            recurrence: Recurrence::Monthly,
            category: "Governance".into(),
            organizer: Some("Alice Nakamura".into()),
            attendees: vec![
                AttendeeView {
                    name: "Alice Nakamura".into(),
                    agent_key: Some("uhCAk_alice_pubkey_mock".into()),
            ...
            source: CalendarSource::Community,
            color: Some("#8b7ec8".into()),
        },
        CalendarEventView {
            id: "cal-002".into(),
            title: "EduNet Curriculum Sync".into(),
            description: Some("Review CAPS alignment for Gr10-12 mathematics".into()),
            location: None,
            start_time: now + day + 10 * hour,
            end_time: now + day + 11 * hour,
            all_day: false,
            recurrence: Recurrence::Weekly,
            category: "Education".into(),
            organizer: Some("Carol Dlamini".into()),
            attendees: vec![],
        ...
        CalendarEventView {
            ...
            attendees: vec![],
            rsvp_status: None,
            source: CalendarSource::Hearth,
            color: Some("#f59e0b".into()),
        },
        CalendarEventView {
            id: "cal-004".into(),
            title: "Infrastructure Maintenance Window".into(),
            description: Some("Scheduled node updates for Zone 4".into()),
            location: None,
            start_time: now + 3 * day,
            end_time: now + 3 * day + day,
            all_day: true,
            recurrence: Recurrence::None,
            category: "Operations".into(),
            organizer: Some("David Chen".into()),
            attendees: vec![],
            rsvp_status: None,
            source: CalendarSource::Community,
...
pub fn mock_chat_channels() -> Vec<ChatChannel> {
    ...
    vec![
        ChatChannel {
            ...
            unread_count: 2,
            last_message: Some("See you at the meeting!".into()),
            last_activity: now - 300,
            pinned: true,
        },
        ChatChannel {
            id: "dm-bob".into(),
            name: "Bob Mthembu".into(),
            description: None,
            is_direct: true,
            members: vec!["uhCAk_bob_pubkey_mock".into()],
            member_names: vec!["Bob Mthembu".into()],
            unread_count: 0,
            last_message: Some("Fixed the sync issue".into()),
            last_activity: now - 3600,
            pinned: false,
        },
        ChatChannel {
            id: "ch-governance".into(),
            name: "governance".into(),
            description: Some("Governance discussion and proposals".into()),
            is_direct: false,
            members: vec![
                "uhCAk_alice_pubkey_mock".into(),
                "uhCAk_bob_pubkey_mock".into(),
                "uhCAk_carol_pubkey_mock".into(),
            ],
            member_names: vec!["Alice".into(), "Bob".into(), "Carol".into()],
            unread_count: 5,
            last_message: Some("The proposal vote closes Friday".into()),
            last_activity: now - 600,
            pinned: true,
        },
        ChatChannel {
            id: "ch-engineering".into(),
            name: "engineering".into(),
            description: Some("Technical coordination".into()),
            is_direct: false,
            members: vec![
                "uhCAk_bob_pubkey_mock".into(),
                "uhCAk_dave_pubkey_mock".into(),
            ],
            member_names: vec!["Bob".into(), "Dave".into()],
            unread_count: 0,
            last_message: Some("Node 4B is back online".into()),
        ...
        ChatChannel {
            ...
            unread_count: 1,
            last_message: Some("New streaming model is live!".into()),
    ...
    match channel_id {
        "dm-alice" => vec![
            ChatMessage {
                ...
                sender: "uhCAk_alice_pubkey_mock".into(),
                sender_name: Some("Alice Nakamura".into()),
                content: "Hey, did you review the water proposal?".into(),
                timestamp: now - 600,
                reply_to: None,
                reactions: vec![],
                edited: false,
                channel_id: Some("dm-alice".into()),
            },
            ChatMessage {
                id: "cm-2".into(),
                sender: "uhCAk_self_mock".into(),
                sender_name: Some("You".into()),
                content: "Yes, the supermajority clause looks good. I'd add a sunset provision."
                    .into(),
                timestamp: now - 540,
                reply_to: None,
                reactions: vec![ChatReaction {
                    emoji: "\u{1F44D}".into(),
                    users: vec!["uhCAk_alice_pubkey_mock".into()],
                }],
                edited: false,
                channel_id: Some("dm-alice".into()),
            },
            ChatMessage {
                ...
                sender: "uhCAk_alice_pubkey_mock".into(),
                sender_name: Some("Alice Nakamura".into()),
                content: "Great idea. I'll update section 4.2. See you at the meeting!".into(),
                timestamp: now - 300,
                reply_to: None,
                reactions: vec![],
                edited: false,
        ...
        "ch-governance" => vec![
            ChatMessage {
                ...
                sender: "uhCAk_carol_pubkey_mock".into(),
                sender_name: Some("Carol Dlamini".into()),
                content: "Reminder: the budget proposal vote closes Friday at 5pm".into(),
                timestamp: now - 3600,
                reply_to: None,
                reactions: vec![],
                edited: false,
                channel_id: Some("ch-governance".into()),
            },
            ChatMessage {
                id: "cm-g2".into(),
                sender: "uhCAk_alice_pubkey_mock".into(),
                sender_name: Some("Alice Nakamura".into()),
                content: "Current tally: 12 yes, 3 no, 5 abstain. Need 15 for quorum.".into(),
                timestamp: now - 1800,
                reply_to: None,
                reactions: vec![],
                edited: false,
            ...
            ChatMessage {
                ...
                sender: "uhCAk_bob_pubkey_mock".into(),
                sender_name: Some("Bob Mthembu".into()),
                content: "I'll reach out to the remaining voters".into(),
                timestamp: now - 600,
                reply_to: Some("cm-g2".into()),
                reactions: vec![ChatReaction {
                    emoji: "\u{1F64F}".into(),
                    users: vec![
                        "uhCAk_alice_pubkey_mock".into(),
