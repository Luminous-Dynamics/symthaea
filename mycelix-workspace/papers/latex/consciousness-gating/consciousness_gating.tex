...
\title{Consciousness-Gated Governance: 4D Identity Profiles and Progressive Vote Weighting in Decentralized Systems}
...
voting, governance participation is determined by a 4-dimensional profile measuring
identity verification strength, cross-system reputation, peer community trust,
and domain-specific engagement. This profile maps to five progressive tiers
...
Holochain-based platform with 133+ zomes across 16 clusters, and validate it
with 295+ tests including property-based verification of tier monotonicity,
...
\section{The 4D Consciousness Profile}

\begin{definition}[Consciousness Profile]
A consciousness profile $\mathbf{P} = (I, R, C, E) \in [0,1]^4$ where:
\begin{itemize}[nosep]
  \item $I$: Identity verification strength
  \item $R$: Cross-system reputation with temporal decay
  \item $C$: Peer community trust attestations
  \item $E$: Domain-specific engagement
\end{itemize}
\end{definition}
...
solve all four dimensions for each Sybil identity, making the attack cost
...
295+ tests in the bridge-common crate cover the full surface area, including
...
\begin{enumerate}
  ...
  \item \textbf{Formal verification}: The Rust implementation has 295+ tests
...
scale: 133+ zomes across 16 clusters, all sharing the same consciousness
gating infrastructure through a single bridge-common crate with 295+ tests.
