...
implemented as a unified Holochain application with 133+ WebAssembly zomes
...
The technical challenge is not merely scale (133+ zomes) but
...
\textbf{Finance} (8 zomes): Three-currency economics (SAP stable unit,
TEND mutual credit with demurrage, MYCEL commons currency), treasury with
...
The governance primitives---\texttt{ConsciousnessProfile},
\texttt{ConsciousnessTier}, \texttt{GovernanceRequirement}---are defined
once in bridge-common and used identically at all three levels.
...
\textbf{bridge-common} (295+ tests): Coordinator dispatch logic, consciousness
...
control---provides a coherent framework for organizing 133+ zomes into a
