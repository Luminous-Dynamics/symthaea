...
//! Phi Time-Series Tracking for Coherence Evolution
//!
//! WASM-compatible time-series analysis of Phi measurements over federated
...
impl PhiTimeSeries {
    ...
    fn diagnose_anomaly_cause(&self, current: &PhiDataPoint, z_score: f32) -> String {
...
mod tests {
    ...
    fn test_trend_detection_rising() {
        let mut series =
            PhiTimeSeries::new(PhiTimeSeriesConfig::default().with_window_size(20));
    ...
    fn test_statistics_calculation() {
        let mut series =
            PhiTimeSeries::new(PhiTimeSeriesConfig::default().with_window_size(10));
