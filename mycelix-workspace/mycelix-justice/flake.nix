...
# Commercial licensing: see COMMERCIAL_LICENSE.md at repository root# Mycelix Justice - Holochain Development Environment
# Complaints, Evidence, Arbitration, Enforcement, Bridge
#
# Usage:
#   nix develop              # Enter dev shell
#   nix develop .#ci         # CI environment (minimal)
{
  description = "Mycelix Justice - Decentralized dispute resolution on Holochain";
      ...
      in {
        devShells = {
          default = holochainBase.mkHolochainShell {
            ...
            extraShellHook = ''
              echo "Zomes:"
              echo "  complaints/          - Complaint filing & management"
              echo "  evidence/            - Evidence submission & chain of custody"
              echo "  arbitration/         - Dispute resolution"
              echo "  enforcement/         - Decision enforcement"
