...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Projects Zome Unit Tests
//!
...
mod tests {
    ...
    fn test_project_credits_accumulation_over_milestones() {
        ...
        for (i, m) in milestones.iter_mut().enumerate() {
            ...
            complete_milestone(m, "did:mycelix:verifier", Some(credits), m.target_date).unwrap();
