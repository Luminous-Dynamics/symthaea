#!/usr/bin/env bash
# Deploy Craft to IPFS + Cloudflare gateway
# Usage: ./deploy.sh
#
...
# Try bearer token first, fall back to global API key
...
echo ""
echo "  IPFS: ipfs://$CID"
echo "  URL:  https://craft.mycelix.net"
