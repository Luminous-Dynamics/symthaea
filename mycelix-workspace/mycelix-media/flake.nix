...
# Commercial licensing: see COMMERCIAL_LICENSE.md at repository root# Mycelix Media - Holochain Development Environment
# Publication, Attribution, Curation, FactCheck, Bridge
#
# Usage:
#   nix develop              # Enter dev shell
#   nix develop .#ci         # CI environment (minimal)
{
  description = "Mycelix Media - Decentralized media verification on Holochain";
      ...
      in {
        devShells = {
          default = holochainBase.mkHolochainShell {
            ...
            extraShellHook = ''
              echo "Zomes:"
              echo "  publication/         - Content publishing"
              echo "  attribution/         - Creator attribution"
              echo "  curation/            - Community curation"
              echo "  factcheck/           - Fact verification"
