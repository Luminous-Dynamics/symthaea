...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! LUCID Reasoning Coordinator Zome
...
#[hdk_extern]
pub fn record_contradiction_analyzed(
    input: RecordContradictionAnalyzedInput,
) -> ExternResult<Record> {
    let now = sys_time()?;
