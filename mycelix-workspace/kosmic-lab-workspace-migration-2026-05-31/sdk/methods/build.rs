...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! RISC-0 Methods Build Script
//!
...
fn build_with_risc0() {
    ...
    embed_methods_with_options(&[guest_pkg], GuestOptions::default());
}
