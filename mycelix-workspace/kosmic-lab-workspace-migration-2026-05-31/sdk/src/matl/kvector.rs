...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! K-Vector - Multi-dimensional Trust Scoring
//!
...
pub const KVECTOR_WEIGHTS_ARRAY: [f32; 10] =
    [0.24, 0.11, 0.19, 0.11, 0.05, 0.07, 0.05, 0.04, 0.09, 0.05];
