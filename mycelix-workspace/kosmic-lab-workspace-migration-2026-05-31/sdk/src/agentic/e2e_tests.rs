...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! End-to-End Integration Tests for Epistemic-Aware AI Agency
//!
...
#[cfg(test)]
mod tests {
    use crate::agentic::cross_domain::{DomainRegistry, translate_trust};
    use crate::agentic::kvector_bridge::{
        KVectorBridgeConfig, calculate_kredit_from_trust, update_agent_kvector,
    };
    use crate::agentic::{
