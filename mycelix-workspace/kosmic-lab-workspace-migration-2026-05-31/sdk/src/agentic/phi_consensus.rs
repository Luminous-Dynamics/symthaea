...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! # Phi-Weighted Collective Consensus
//!
...
use super::phi_integration::{
    CollectiveCoherenceLevel, CollectivePhiResult, measure_collective_phi,
};
