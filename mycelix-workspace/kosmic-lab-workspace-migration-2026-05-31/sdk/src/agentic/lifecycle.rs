...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! # Agent Lifecycle Management
//!
...
use super::{
    AgentClass, AgentId, AgentStatus, InstrumentalActor, constraints::AgentConstraints,
    epistemic_classifier::EpistemicStats, kredit::calculate_kredit_cap, sponsor_requirements,
...
pub fn gate_action_on_coherence(
    ...
    use super::phi_bridge::{CoherenceCheckResult, check_coherence_for_action};
...
pub fn check_action_readiness(
    ...
    use super::phi_bridge::{CoherenceCheckResult, check_agent_coherence_gating};
