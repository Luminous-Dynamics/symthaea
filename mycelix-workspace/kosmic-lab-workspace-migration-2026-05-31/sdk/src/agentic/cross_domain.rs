...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! # Cross-Domain Trust Translation
//!
...
use crate::matl::{KVECTOR_WEIGHTS_ARRAY, KVector, KVectorDimension};
