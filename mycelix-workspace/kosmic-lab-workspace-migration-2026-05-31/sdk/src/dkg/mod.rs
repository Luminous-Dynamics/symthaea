...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! DKG (Distributed Knowledge Graph) - Verifiable Claims with Confidence Scoring
//!
...
pub use confidence::{
    ConfidenceFactors, ConfidenceInput, ConfidenceScore, ConfidenceThresholds,
    calculate_confidence, meets_threshold,
};
...
pub use phi_integration::{
    CoherenceState, ConsciousnessMetrics, PhiConfidenceFactors, apply_consciousness_to_confidence,
    apply_phi_to_confidence, coherence_allows_operation, phi_to_confidence_boost,
};
pub use phi_query_router::{
    CoherenceWeightedResult, PhiQuery, PhiQueryResult, PhiQueryRouter, QueryCostDeduction,
    QueryRestriction, QueryRouterConfig, QueryRoutingDecision, QueryType, deduct_query_cost,
};
...
pub use query::{
    AgentKreditBalance, KreditQueryExecutor, KreditQueryResult, ObjectFilter, QueryCostPreview,
    QueryFilter, WeightedQueryResult, query_by_predicate, query_by_subject, query_triples,
};
pub use query_index::{
