...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! DKG Attestation System
//!
...
mod tests {
    ...
    fn test_attestation_set_with_verified_add() {
        ...
        assert!(
            set.add_verified(attestation1.with_reputation(0.8), &registry1)
                .is_ok()
        );
    ...
    fn test_attestation_set_deduplication() {
        ...
        assert!(
            set.add_verified(attestation1.with_reputation(0.8), &registry)
                .is_ok()
        );
    ...
    fn test_rate_limiting_blocks_rapid_attestations() {
        ...
        assert!(
            set.add_verified(att1.with_reputation(0.8), &registry)
                .is_ok()
        );
