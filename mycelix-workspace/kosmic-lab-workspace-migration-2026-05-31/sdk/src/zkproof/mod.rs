...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! zkSTARK Gradient Proof Module
//!
...
pub use gradient_proof::{
    GradientConstraints, GradientProofInput, GradientProofOutput, GradientQualityResult,
    Risc0ProofConfig, compute_commitment, hash_gradient, verify_gradient_quality,
};
...
pub use risc0_integration::{
    GradientQualityInput, GradientQualityOutput, Risc0ProofReceipt, Risc0ProverConfig,
    Risc0ProverError, hash_gradient as risc0_hash_gradient, verify_gradient_constraints,
};
