...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! RISC-0 ZK Prover Integration
//!
...
use super::gradient_proof::{
    GradientConstraints, GradientProofOutput, compute_commitment, hash_gradient,
    verify_gradient_quality,
};
