...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! FL Aggregation Algorithms
//!
...
pub enum AggregationError {
    ...
    #[error(
        "Gradient size mismatch: expected {expected}, got {actual} for participant {participant_id}"
    )]
