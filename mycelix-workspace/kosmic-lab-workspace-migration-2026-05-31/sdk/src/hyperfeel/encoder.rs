...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! HyperFeel Encoder Implementation
//!
//! Core gradient compression using hyperdimensional computing.

use super::types::{EncodingConfig, HV16_BYTES, HyperGradient, SimilarityResult, TemporalEntry};
