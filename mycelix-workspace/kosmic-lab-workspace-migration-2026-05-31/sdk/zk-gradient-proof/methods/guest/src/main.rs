...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Gradient Quality Verification Guest Program
//!
...
use zk_gradient_core::{
    GradientProofInput, GradientProofOutput, compute_commitment, compute_gradient_hash,
    hash_to_bytes32, verify_gradient_quality,
};
...
fn main() {
    ...
    let (quality_valid, _l2_norm, _max_element) =
        verify_gradient_quality(&input.gradient, &input.constraints);
