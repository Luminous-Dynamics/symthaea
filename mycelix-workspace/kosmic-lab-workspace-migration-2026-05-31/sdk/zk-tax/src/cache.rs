...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Proof caching system for reusing ZK proofs within the same tax year.
//!
...
impl ProofCache {
    ...
    pub fn get_or_generate<F, E>(
        &self,
        key: &ProofCacheKey,
        generator: F,
    ) -> Result<TaxBracketProof, E>
    where
