...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Sub-national tax jurisdiction support.
//!
...
pub static TX_2024: [TaxBracket; 1] = [TaxBracket {
    index: 0,
    lower: 0,
    upper: u64::MAX,
    rate_bps: 0,
...
pub static FL_2024: [TaxBracket; 1] = [TaxBracket {
    index: 0,
    lower: 0,
    upper: u64::MAX,
    rate_bps: 0,
...
pub static IL_2024: [TaxBracket; 1] = [TaxBracket {
    index: 0,
    lower: 0,
    upper: u64::MAX,
    rate_bps: 495,
...
pub static MA_2024: [TaxBracket; 1] = [TaxBracket {
    index: 0,
    lower: 0,
    upper: u64::MAX,
    rate_bps: 500,
...
pub static CO_2024: [TaxBracket; 1] = [TaxBracket {
    index: 0,
    lower: 0,
    upper: u64::MAX,
    rate_bps: 440,
...
pub static AB_2024: [TaxBracket; 1] = [TaxBracket {
    index: 0,
    lower: 0,
    upper: u64::MAX,
    rate_bps: 1000,
...
pub fn get_brazilian_brackets(
    ...
    match (year, monthly) {
        ...
        _ => Err(format!(
            "Brazilian tax brackets not yet implemented for {}",
            year
        )),
    }
}
...
pub fn find_brazilian_bracket(
    ...
    Err(format!(
        "No bracket found for income {} in {}",
        income, state
    ))
}
...
pub fn get_uk_nation_brackets(
    ...
    match (nation, year) {
        ...
        (UKNation::England | UKNation::Wales | UKNation::NorthernIreland, 2024 | 2025) => {
            Ok(&UK_REST_2024)
        }
        _ => Err(format!(
            "Tax brackets not yet implemented for {} in {}",
...
mod tests {
    ...
    fn test_texas_no_tax() {
        ...
        let bracket =
            find_state_bracket(1_000_000, USState::TX, 2024, FilingStatus::Single).unwrap();
    ...
    fn test_ontario_brackets() {
        ...
        let bracket =
            find_provincial_bracket(100_000, CanadianProvince::ON, 2024, FilingStatus::Single)
                .unwrap();
    ...
    fn test_quebec_brackets() {
        ...
        let bracket =
            find_provincial_bracket(80_000, CanadianProvince::QC, 2024, FilingStatus::Single)
                .unwrap();
        assert_eq!(bracket.index, 1);
    ...
    fn test_alberta_flat_tax() {
        // Alberta has flat 10%
        let bracket =
            find_provincial_bracket(500_000, CanadianProvince::AB, 2024, FilingStatus::Single)
                .unwrap();
    ...
    fn test_canadian_province_parsing() {
        assert_eq!(
            "ON".parse::<CanadianProvince>().unwrap(),
            CanadianProvince::ON
        );
        assert_eq!(
            "ontario".parse::<CanadianProvince>().unwrap(),
            CanadianProvince::ON
        );
        assert_eq!(
            "QC".parse::<CanadianProvince>().unwrap(),
            CanadianProvince::QC
        );
        assert_eq!(
            "BC".parse::<CanadianProvince>().unwrap(),
            CanadianProvince::BC
        );
    }
    ...
    fn test_australian_state_parsing() {
        assert_eq!(
            "NSW".parse::<AustralianState>().unwrap(),
            AustralianState::NSW
        );
        assert_eq!(
            "new south wales".parse::<AustralianState>().unwrap(),
            AustralianState::NSW
        );
        assert_eq!(
            "VIC".parse::<AustralianState>().unwrap(),
            AustralianState::VIC
        );
        assert_eq!(
            "QLD".parse::<AustralianState>().unwrap(),
            AustralianState::QLD
        );
    }
    ...
    fn test_indian_state_parsing() {
        ...
        assert_eq!(
            "maharashtra".parse::<IndianState>().unwrap(),
            IndianState::MH
        );
    ...
    fn test_zurich_brackets() {
        ...
        let bracket =
            find_cantonal_bracket(50_000, SwissCanton::ZH, 2024, FilingStatus::Single).unwrap();
    ...
    fn test_zug_low_tax() {
        ...
        let bracket =
            find_cantonal_bracket(100_000, SwissCanton::ZG, 2024, FilingStatus::Single).unwrap();
    ...
    fn test_obwalden_lowest_tax() {
        ...
        let bracket =
            find_cantonal_bracket(200_000, SwissCanton::OW, 2024, FilingStatus::Single).unwrap();
        assert_eq!(bracket.index, 3);
    ...
    fn test_geneva_highest_tax() {
        ...
        let bracket =
            find_cantonal_bracket(200_000, SwissCanton::GE, 2024, FilingStatus::Single).unwrap();
    ...
    fn test_swiss_tax_comparison() {
        ...
        let zug =
            find_cantonal_bracket(100_000, SwissCanton::ZG, 2024, FilingStatus::Single).unwrap();
        let geneva =
            find_cantonal_bracket(100_000, SwissCanton::GE, 2024, FilingStatus::Single).unwrap();
        let zurich =
            find_cantonal_bracket(100_000, SwissCanton::ZH, 2024, FilingStatus::Single).unwrap();
    ...
    fn test_scotland_starter_rate() {
        ...
        let bracket =
            find_uk_nation_bracket(14_000, UKNation::Scotland, 2024, FilingStatus::Single).unwrap();
        assert_eq!(bracket.index, 1);
    ...
    fn test_scotland_intermediate_rate() {
        ...
        let bracket =
            find_uk_nation_bracket(35_000, UKNation::Scotland, 2024, FilingStatus::Single).unwrap();
        assert_eq!(bracket.index, 3);
    ...
    fn test_scotland_top_rate() {
        ...
        let bracket =
            find_uk_nation_bracket(100_000, UKNation::Scotland, 2024, FilingStatus::Single)
                .unwrap();
        assert_eq!(bracket.index, 5);
    ...
    fn test_scotland_vs_rest_uk() {
        ...
        let scotland =
            find_uk_nation_bracket(50_000, UKNation::Scotland, 2024, FilingStatus::Single).unwrap();
        let england =
            find_uk_nation_bracket(50_000, UKNation::England, 2024, FilingStatus::Single).unwrap();
    ...
    fn test_scotland_more_progressive() {
        ...
        let scotland_low =
            find_uk_nation_bracket(15_000, UKNation::Scotland, 2024, FilingStatus::Single).unwrap();
        let england_low =
            find_uk_nation_bracket(15_000, UKNation::England, 2024, FilingStatus::Single).unwrap();
    ...
    fn test_scotland_2025_advanced_rate() {
        ...
        let bracket =
            find_uk_nation_bracket(80_000, UKNation::Scotland, 2025, FilingStatus::Single).unwrap();
        assert_eq!(bracket.index, 5);
    ...
    fn test_brazilian_irpf_exempt() {
        ...
        let bracket =
            find_brazilian_bracket(2_000, BrazilianState::SP, 2024, FilingStatus::Single, true)
                .unwrap();
    ...
    fn test_brazilian_irpf_starter() {
        ...
        let bracket =
            find_brazilian_bracket(2_500, BrazilianState::SP, 2024, FilingStatus::Single, true)
                .unwrap();
        assert_eq!(bracket.index, 1);
    ...
    fn test_brazilian_irpf_max_rate() {
        ...
        let bracket =
            find_brazilian_bracket(10_000, BrazilianState::SP, 2024, FilingStatus::Single, true)
                .unwrap();
        assert_eq!(bracket.index, 4);
    ...
    fn test_brazilian_irpf_annual() {
        ...
        let bracket = find_brazilian_bracket(
            50_000,
            BrazilianState::RJ,
            2024,
            FilingStatus::Single,
    ...
    fn test_brazilian_same_rates_all_states() {
        ...
        let sp =
            find_brazilian_bracket(5_000, BrazilianState::SP, 2024, FilingStatus::Single, true)
                .unwrap();
        let rj =
            find_brazilian_bracket(5_000, BrazilianState::RJ, 2024, FilingStatus::Single, true)
                .unwrap();
        let am =
            find_brazilian_bracket(5_000, BrazilianState::AM, 2024, FilingStatus::Single, true)
                .unwrap();
