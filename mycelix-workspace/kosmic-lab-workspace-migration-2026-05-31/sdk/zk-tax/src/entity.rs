...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Business entity support for tax proofs.
//!
...
use crate::{Error, Jurisdiction, Result, TaxYear};
...
impl BusinessTaxProof {
    ...
    pub fn estimated_tax(&self) -> u64 {
        let base_tax =
            (self.taxable_income as u128 * self.effective_rate_bps as u128 / 10000) as u64;
...
impl BusinessProver {
    ...
    pub fn prove(
        ...
        let (marginal_rate_bps, effective_rate_bps) =
            self.calculate_rates(&info, jurisdiction, tax_year)?;
