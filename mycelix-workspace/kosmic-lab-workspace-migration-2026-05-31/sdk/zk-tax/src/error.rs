...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Error types for ZK tax SDK.
//!
...
pub enum Error {
    ...
    IncomeOutOfBounds { income: u64, lower: u64, upper: u64 },
