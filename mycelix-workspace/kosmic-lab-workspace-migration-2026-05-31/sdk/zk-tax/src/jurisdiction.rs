...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Jurisdiction and filing status definitions.
...
impl Jurisdiction {
    ...
    pub fn valid_filing_statuses(&self) -> &'static [FilingStatus] {
        match self {
            ...
            Jurisdiction::DE => &[FilingStatus::Single, FilingStatus::MarriedFilingJointly],
...
impl std::str::FromStr for FilingStatus {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().replace([' ', '_', '-'], "").as_str() {
            ...
            "marriedfilingseparately" | "mfs" | "separate" => {
...
mod tests {
    ...
    fn test_jurisdiction_parsing() {
        ...
        assert_eq!(
            "United States".parse::<Jurisdiction>().unwrap(),
            Jurisdiction::US
        );
    }
