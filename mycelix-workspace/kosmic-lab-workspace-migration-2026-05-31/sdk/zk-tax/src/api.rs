...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! REST API types for building tax proof services.
//!
...
use crate::{Error, FilingStatus, Jurisdiction, TaxBracketProof, TaxYear, error::Result};
...
impl ApiEndpoint {
    ...
    pub fn method(&self) -> &'static str {
        match self {
            ...
            ApiEndpoint::ListJurisdictions | ApiEndpoint::GetBrackets | ApiEndpoint::Health => {
                "GET"
            }
        }
    }
