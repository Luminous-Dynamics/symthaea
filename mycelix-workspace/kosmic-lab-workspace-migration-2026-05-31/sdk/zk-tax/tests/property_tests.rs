...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Property-based tests using proptest.
//!
//! These tests verify invariants that should hold for all inputs.

use mycelix_zk_tax::{
    FilingStatus, Jurisdiction, TaxBracketProof, TaxBracketProver,
