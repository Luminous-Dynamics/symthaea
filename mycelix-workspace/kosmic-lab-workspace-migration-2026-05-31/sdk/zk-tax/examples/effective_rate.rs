...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Example: Effective Tax Rate Proofs
//!
...
use mycelix_zk_tax::proof::{EffectiveTaxRateBuilder, EffectiveTaxRateProof};
...
fn main() {
    ...
    let proof =
        EffectiveTaxRateProof::prove_dev(income, Jurisdiction::US, FilingStatus::Single, 2024)
    ...
    let proof = EffectiveTaxRateBuilder::new(100_000, Jurisdiction::US, FilingStatus::Single, 2024)
        .build()
        .expect("Should generate proof");
