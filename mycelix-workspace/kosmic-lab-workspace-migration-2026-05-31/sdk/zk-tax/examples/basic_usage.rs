...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Basic usage example for the ZK-Tax SDK.
//!
//! Run with: `cargo run --example basic_usage --features prover`

use mycelix_zk_tax::{FilingStatus, Jurisdiction, TaxBracketProver, brackets::get_brackets};
