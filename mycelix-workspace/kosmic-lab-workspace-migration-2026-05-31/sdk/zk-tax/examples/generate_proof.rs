...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Example: Generate a real ZK proof of tax bracket membership.
//!
...
fn main() {
    ...
    println!("\nWhat this proves:");
    println!(
        "  'I have income in the {}% tax bracket'",
