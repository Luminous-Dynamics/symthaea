...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Benchmarks: Performance Measurement for All Proof Types
//!
...
use mycelix_zk_tax::proof::{
    BatchProofBuilder, CrossJurisdictionProofBuilder, EffectiveTaxRateProof, IncomeRangeProof,
    RangeProofBuilder,
};
...
fn main() {
    ...
    let (avg, min, max) = benchmark(iterations, || {
        IncomeRangeProof::prove_dev(85_000, 50_000, 150_000, 2024).expect("proof failed")
    });
