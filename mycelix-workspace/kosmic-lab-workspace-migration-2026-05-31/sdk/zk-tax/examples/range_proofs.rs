...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Example: Income Range Proofs
//!
...
fn main() {
    ...
    println!(
        "Scenario: Loan requires minimum income of ${}",
        minimum_for_loan
    );
    println!("  My income: ${}  (NEVER REVEALED)", my_income);
    ...
    println!(
        "Scenario: Benefit program requires income <= ${}",
        maximum_for_benefits
    );
    println!("  My income: ${}  (NEVER REVEALED)", my_income);
    ...
    println!(
        "  Verification: {}",
        if benefits_proof.verify().is_ok() {
            "VALID"
        } else {
            "INVALID"
        }
    ...
    println!(
        "Scenario: Prove income is between ${} and ${}",
    ...
    println!(
        "Scenario: Trying to prove income >= ${} with actual ${}",
        minimum_required, my_income
    );
