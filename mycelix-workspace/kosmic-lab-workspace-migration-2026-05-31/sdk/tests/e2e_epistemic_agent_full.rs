...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Full End-to-End Integration Test: Epistemic-Aware AI Agency
//!
...
use mycelix_sdk::agentic::epistemic_classifier::{
    AgentOutput, AgreementScope, ClassificationHints, EpistemicStats, OutputContent,
    RelevanceDuration, calculate_epistemic_weight, classify_output, create_classified_output,
};
use mycelix_sdk::agentic::kvector_bridge::{
    KVectorBridgeConfig, analyze_behavior, calculate_kredit_from_trust, compute_kvector_update,
    record_and_maybe_update,
};
use mycelix_sdk::agentic::phi_bridge::{
    CoherenceCheckResult, CoherenceHistory, CoherenceState, PhiMeasurementConfig,
    check_coherence_for_action, measure_phi_simple,
};
use mycelix_sdk::agentic::uncertainty::{
    MoralActionGuidance, MoralUncertainty, UncertainOutput, UncertaintyCalibration, maybe_escalate,
};
