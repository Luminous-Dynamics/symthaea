...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! # Epistemic-Aware AI Agency Demonstration
//!
...
use mycelix_sdk::agentic::{
    ActionOutcome, AgentClass, AgentConstraints, AgentId, AgentOutput, AgentOutputBuilder,
    AgentStatus, InstrumentalActor, KVectorBridgeConfig, MoralUncertainty, OutputContent,
    PhiMeasurementConfig, UncertainOutput, analyze_behavior, calculate_epistemic_weight,
    calculate_kredit_from_trust, check_coherence_for_action, compute_kvector_update,
    compute_trust_score, get_recommendations, maybe_escalate, measure_phi_simple, should_proceed,
};
