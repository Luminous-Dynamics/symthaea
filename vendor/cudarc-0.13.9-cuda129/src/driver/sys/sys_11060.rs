...
pub struct Lib {
    ...
    pub cuStreamIsCapturing: Result<
        ...
        ::libloading::Error,
    >,
    pub cuStreamGetCaptureInfo: Result<
        unsafe extern "C" fn(
            hStream: CUstream,
    ...
    pub cuStreamWaitValue32: Result<
        unsafe extern "C" fn(
            stream: CUstream,
            addr: CUdeviceptr,
            value: cuuint32_t,
        ...
        ::libloading::Error,
    >,
    pub cuStreamWaitValue64: Result<
        unsafe extern "C" fn(
            stream: CUstream,
            addr: CUdeviceptr,
            value: cuuint64_t,
        ...
        ::libloading::Error,
    >,
    pub cuStreamWriteValue32: Result<
        unsafe extern "C" fn(
            stream: CUstream,
            addr: CUdeviceptr,
            value: cuuint32_t,
        ...
        ::libloading::Error,
    >,
    pub cuStreamWriteValue64: Result<
        unsafe extern "C" fn(
            stream: CUstream,
            addr: CUdeviceptr,
            value: cuuint64_t,
    ...
    pub cuGraphCreate: Result<
        ...
        ::libloading::Error,
    >,
    pub cuGraphAddKernelNode: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cuGraphKernelNodeGetParams: Result<
        unsafe extern "C" fn(
            hNode: CUgraphNode,
        ...
        ::libloading::Error,
    >,
    pub cuGraphKernelNodeSetParams: Result<
        unsafe extern "C" fn(
            hNode: CUgraphNode,
            nodeParams: *const CUDA_KERNEL_NODE_PARAMS,
        ) -> CUresult,
    ...
    pub cuGraphInstantiate_v2: Result<
        unsafe extern "C" fn(
    ...
    pub cuGraphInstantiateWithFlags: Result<
        ...
        ::libloading::Error,
    >,
    pub cuGraphExecKernelNodeSetParams: Result<
        unsafe extern "C" fn(
...
impl Lib {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let cuStreamGetCaptureInfo = __library.get(b"cuStreamGetCaptureInfo\0").map(|sym| *sym);
        ...
        let cuDestroyExternalSemaphore = __library
            ...
            .map(|sym| *sym);
        let cuStreamWaitValue32 = __library.get(b"cuStreamWaitValue32\0").map(|sym| *sym);
        let cuStreamWaitValue64 = __library.get(b"cuStreamWaitValue64\0").map(|sym| *sym);
        let cuStreamWriteValue32 = __library.get(b"cuStreamWriteValue32\0").map(|sym| *sym);
        let cuStreamWriteValue64 = __library.get(b"cuStreamWriteValue64\0").map(|sym| *sym);
        let cuStreamBatchMemOp = __library.get(b"cuStreamBatchMemOp\0").map(|sym| *sym);
        ...
        let cuGraphAddKernelNode = __library.get(b"cuGraphAddKernelNode\0").map(|sym| *sym);
        ...
        let cuGraphInstantiate_v2 = __library.get(b"cuGraphInstantiate_v2\0").map(|sym| *sym);
        ...
        let cuGraphExecUpdate = __library.get(b"cuGraphExecUpdate\0").map(|sym| *sym);
        ...
        let cuGetProcAddress = __library.get(b"cuGetProcAddress\0").map(|sym| *sym);
    ...
    pub unsafe fn cuStreamGetCaptureInfo(
        ...
        (self
            .cuStreamGetCaptureInfo
            .as_ref()
            .expect("Expected function, got error."))(hStream, captureStatus_out, id_out)
    }
    ...
    pub unsafe fn cuGetProcAddress(
        ...
        (self
            .cuGetProcAddress
            .as_ref()
            .expect("Expected function, got error."))(symbol, pfn, cudaVersion, flags)
    }
