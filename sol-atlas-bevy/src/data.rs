...
const CLIMATE_JSON: &str =
    include_str!("../../sol-atlas-leptos/assets/data/climate-projects.json");
const INFRA_JSON: &str =
    include_str!("../../sol-atlas-leptos/assets/data/infrastructure.json");
...
const CHOKEPOINTS_JSON: &str =
    include_str!("../../sol-atlas-leptos/assets/data/chokepoints.json");
