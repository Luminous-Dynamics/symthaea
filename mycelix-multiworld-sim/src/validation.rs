...
impl ObservedData {
    ...
    pub fn world_population() -> Vec<(f64, f64)> {
        vec![
            (1970.0, 3.70), (1975.0, 4.07), (1980.0, 4.43), (1985.0, 4.83),
            (1990.0, 5.32), (1995.0, 5.74), (2000.0, 6.14), (2005.0, 6.54),
            (2010.0, 6.96), (2015.0, 7.38), (2020.0, 7.79), (2024.0, 8.12),
        ]
    }
    ...
    pub fn temperature_anomaly() -> Vec<(f64, f64)> {
        vec![
            (1970.0, 0.00), (1975.0, -0.02), (1980.0, 0.18), (1985.0, 0.11),
            (1990.0, 0.39), (1995.0, 0.40), (2000.0, 0.39), (2005.0, 0.62),
            (2010.0, 0.66), (2015.0, 0.87), (2020.0, 1.02), (2024.0, 1.29),
        ]
    }
    ...
    pub fn global_tfr() -> Vec<(f64, f64)> {
        vec![
            (1970.0, 4.7), (1975.0, 4.3), (1980.0, 3.7), (1985.0, 3.5),
            (1990.0, 3.2), (1995.0, 2.9), (2000.0, 2.7), (2005.0, 2.6),
            (2010.0, 2.5), (2015.0, 2.4), (2020.0, 2.3), (2024.0, 2.2),
        ]
    }
    ...
    pub fn co2_emissions() -> Vec<(f64, f64)> {
        vec![
            (1970.0, 14.9), (1975.0, 16.0), (1980.0, 19.5), (1985.0, 19.8),
            (1990.0, 22.0), (1995.0, 23.1), (2000.0, 25.0), (2005.0, 29.2),
            (2010.0, 33.4), (2015.0, 35.2), (2020.0, 34.8), (2024.0, 37.4),
        ]
    }
}
...
pub fn validate_metric(
    ...
    MetricValidation { metric: metric_name.into(), points, mape, max_ape, assessment }
}
...
fn interpolate_trajectory(trajectory: &[(f64, f64)], year: f64) -> f64 {
    ...
    if trajectory.len() == 1 { return trajectory[0].1; }
...
pub fn format_validation_report(validations: &[MetricValidation]) -> String {
    ...
    // Overall assessment
    let overall_mape: f64 = validations.iter().map(|v| v.mape).sum::<f64>()
        / validations.len().max(1) as f64;
...
mod tests {
    ...
    fn test_validate_metric_perfect() {
        ...
        assert!(result.mape < 0.1, "Perfect match should have MAPE ~0: {}", result.mape);
    }
    ...
    fn test_observed_data_plausible() {
        ...
        assert!(t_2024 > t_1970 + 1.0,
            "Temperature should rise >1°C: {} vs {}", t_2024, t_1970);
    }
