//! Bridge Integrity Zome - Cross-hApp verification for mutual aid
//!
...
impl std::fmt::Display for BridgeError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::InvalidTrustScore => write!(f, "Invalid trust score: must be between 0.0 and 1.0"),
...
fn validate_verification_record(record: &VerificationRecord) -> ExternResult<ValidateCallbackResult> {
    // Validate IDs
