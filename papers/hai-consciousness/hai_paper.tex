...
\textbf{Test suite:} 9,700+ tests in main crate, 24,800+ across workspace, 0 failures, 60 ignored (see Figure~\ref{fig:radar} for full validation radar).
...
\textbf{Test suite:} 9,700+ main crate tests, 24,800+ across workspace, 60 ignored, 0 failures\par
