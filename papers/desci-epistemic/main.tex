...
systematic bias of $-962$~keV (RMS = 1012~keV). This reproducible
under-prediction reveals a Coulomb-correction deficit in the DZ10 formula
when computing binding-energy \emph{differences} across $\Delta Z = 2$
transitions.
...
$N = 82$ shell quenching from Sn to Nd; and identification of the superheavy
