...
\textbf{Creativity} & \textbf{0.80} & \textbf{0.52} & \textbf{0.34} & \textbf{1.21} & \textbf{$-$0.27} & \textbf{0.52} & \textbf{0.491} \\
...
\midrule
\multicolumn{6}{l}{\emph{Grand mean (unweighted domain)}} & 1.27 & 0.024 \\
\end{longtable}

\noindent The Creativity domain shows anomalously high cross-seed variance (SD $= 0.491$), primarily driven by the RemoteAssociates benchmark whose semantic associations are seed-dependent (see Discussion). Mathematics (SD $= 0.187$), MemoryAgent (SD $= 0.199$), and Executive (SD $= 0.172$) show moderate variance reflecting genuine sensitivity to stimulus configuration. The remaining 23 domains have SD $< 0.12$, with 8 domains showing SD $< 0.01$ (effectively deterministic).
