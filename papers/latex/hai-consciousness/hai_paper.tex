...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Psychological validation:} All 14 of 14 Butlin et al.\ consciousness indicators present (mean score 0.85), with human-like capacity limits (change detection drop at $K{>}4$, binding deficit at $K{=}6$, FIFO eviction at $L{=}9$) and 100\% test-time learning correction via activation decay.
\end{enumerate}
