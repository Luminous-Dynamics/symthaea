...
Language      & Lexical Decision   & $-0.27$ & $-0.27$ & 0.011 & Stable      & Poor \\
...
\node[font=\scriptsize, hlbred, anchor=south] at (axis cs:-2.75,77) {$n=6$};
\node[font=\scriptsize, hlbyellow!80!black, anchor=south] at (axis cs:-1.5,77) {$n=7$};
\node[font=\scriptsize, hlbgreen!80!black, anchor=south] at (axis cs:0,77) {$n=42$};
\node[font=\scriptsize, hlbyellow!80!black, anchor=south] at (axis cs:1.5,77) {$n=10$};
\node[font=\scriptsize, hlbred, anchor=south] at (axis cs:2.75,77) {$n=11$};
\end{axis}
\end{tikzpicture}
\caption{Forest plot of normative z-scores for 76 benchmarks with matched human baselines (z-scores clamped to $\pm 3$ for readability; 9 benchmarks exceed this range in raw values). Background shading indicates clinical interpretation bands \citep{cicchetti1994guidelines}. Band counts: 42 Average ($|z| \leq 1$), 10 Above Average, 7 Below Average, 11 Superior ($z > 2$), 6 Impaired ($z < -2$). Data loaded from \texttt{normative\_zscores.csv}.}
\label{fig:forest}
\end{figure}
