...
We define four perturbation types, applied mid-episode without warning:
...
This mirrors biological arousal responses where temporal resolution increases under threat.
