...
\node[font=\scriptsize, hlbred, anchor=south] at (axis cs:-2.75,84) {$n=1$};
\node[font=\scriptsize, hlbyellow!80!black, anchor=south] at (axis cs:-1.5,84) {$n=5$};
\node[font=\scriptsize, hlbgreen!80!black, anchor=south] at (axis cs:0,84) {$n=44$};
\node[font=\scriptsize, hlbyellow!80!black, anchor=south] at (axis cs:1.5,84) {$n=14$};
\node[font=\scriptsize, hlbred, anchor=south] at (axis cs:2.75,84) {$n=19$};
\end{axis}
\end{tikzpicture}
\caption{Forest plot of normative z-scores for 83 benchmarks with matched human baselines (z-scores clamped to $\pm 3$ for readability). Background shading indicates clinical interpretation bands \citep{cicchetti1994guidelines}. Band counts: 44 Average ($|z| \leq 1$), 14 Above Average, 5 Below Average, 19 Superior ($z > 2$), 1 Impaired ($z < -2$). Data loaded from \texttt{normative\_zscores.csv}.}
\label{fig:forest}
\end{figure}
