...
\psychbench{} is open-source under AGPL-3.0. The complete source code, including all 98 benchmark implementations, harness infrastructure, and data generation scripts, is available at:
