...
% Shaded bands
\fill[hlbgreen!10] (axis cs:-1,0) rectangle (axis cs:1,84);
\fill[hlbyellow!10] (axis cs:1,0) rectangle (axis cs:2,84);
\fill[hlbyellow!10] (axis cs:-2,0) rectangle (axis cs:-1,84);
\fill[hlbred!10] (axis cs:2,0) rectangle (axis cs:3.5,84);
\fill[hlbred!10] (axis cs:-3.5,0) rectangle (axis cs:-2,84);

% Zero line
\draw[gray, dashed] (axis cs:0,0) -- (axis cs:0,84);
