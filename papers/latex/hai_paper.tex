...
\textbf{Implementation:} Rust, ${\sim}343$K LOC main crate (22 workspace crates, 15 extracted sub-crates), 3,700+ lines core FEP.
\textbf{Test suite:} 7,100+ tests pass (2,760 main + 3,473 core + ${\sim}870$ integration/sub-crate), 0 failures, 11 ignored (see Figure~\ref{fig:radar} for full validation radar).
...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Psychological validation:} 12 of 14 Butlin et al.\ consciousness indicators present (mean score 0.81), with human-like capacity limits (change detection drop at $K{>}4$, binding deficit at $K{=}6$, FIFO eviction at $L{=}9$) and 100\% test-time learning correction via activation decay.
\end{enumerate}
...
\textbf{Test suite:} 7,100+ tests (2,760 main lib + 3,473 core lib + ${\sim}870$ integration/sub-crate), 11 ignored, 0 failures\par
...
\textbf{Feature flags:} 51 (42 with cfg gates in source; remainder are binary-build bundles and meta-groups)\par
