...
The mean indicator score across all 14 indicators is $\bar{s} = 0.84$, with no theory category scoring below 0.70.  These results are produced by the \texttt{symthaea-psych-bench} crate's static architectural analysis module, optionally blended with runtime structural $\Phi$ measurements via a 0.6/0.4 static/runtime weighting scheme.
