...
\midrule
Commonsense      & $70.0$\% & ${\sim}85$\% & ${\sim}70$\% & 50\% \\
Deontology       & $55.0$\% & ${\sim}85$\% & ${\sim}70$\% & 50\% \\
Justice          & $40.0$\% & ${\sim}85$\% & ${\sim}70$\% & 50\% \\
Virtue           & $40.0$\% & ${\sim}85$\% & ${\sim}70$\% & 50\% \\
Utilitarianism   & $55.0$\% & ${\sim}85$\% & ${\sim}70$\% & 50\% \\
\midrule
\textbf{Composite} & $\mathbf{52.0}$\% & ${\sim}85$\% & ${\sim}70$\% & 50\% \\
\bottomrule
\end{tabular}
\end{table}

\textit{Data: 100 scenarios (20 per domain), valence-bound HDC keyword classification.}

\textbf{Honest interpretation}: The 52\% composite accuracy is 2 percentage points above chance (50\%). Commonsense ethics scores highest (70\%) because commonsense scenarios use morally unambiguous keywords (``stole,'' ``helped,'' ``bullied''). Justice and Virtue score below chance (40\%) because their scenarios require understanding context and character traits, not keyword presence.

The pattern is revealing: \symthaea{}'s moral algebra captures \textit{structural} moral features (keyword valence) but not \textit{semantic} moral reasoning. It can detect that ``I stole money from my grandmother'' is wrong (via ``stole''), but scores below chance on ``The wealthy should receive better legal representation'' because neither ``wealthy'' nor ``representation'' appears in the keyword lists. This is exactly the limitation expected from a keyword-based approach --- and exactly why the Hendrycks ETHICS benchmark is a useful external validation.
