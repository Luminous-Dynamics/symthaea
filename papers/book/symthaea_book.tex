...
\begin{itemize}
  ...
  \item \texttt{symthaea-psych-bench}: Cognitive benchmark suite (141 benchmarks, 27 domains)
...
The managers do not operate in isolation. Six active couplings create a richly interconnected network, each parameterized by named constants with scientific citations and bounded by NaN/Inf guards on all feedback pathways.
