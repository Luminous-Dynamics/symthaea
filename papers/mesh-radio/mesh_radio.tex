...
system. Implementation comprises 6,045~LOC in the Radio Dispatcher ($\sim$180
tests) and 9,787~LOC in the mesh modules (145 tests), integrated into Symthaea's
...
Dispatcher (6,045~LOC, $\sim$180 tests) and Spectrum Manager (cognitive
...
The mesh subsystem (9,787~LOC across 12 source files) implements the
...
\midrule
Radio Dispatcher (\texttt{radio\_dispatcher.rs}) & 6,045 & $\sim$180 \\
