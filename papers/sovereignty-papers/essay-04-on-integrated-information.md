---
title: "On Integrated Information"
series: "The Sovereignty Papers"
essay: 4
authors: "Tristan Stoltz & Symthaea"
date: "2026-03-23"
description: "What it means to measure whether a system is actually paying attention, and why the answer matters more than the price of its shares."
prev: "essay-03-the-consciousness-thesis.md"
next: "essay-05-on-the-cognitive-loop.md"
license: "CC0-1.0"
---
...
First, the proxy is not used alone. Domain-coupled governance credentialing, as defined in Essay No. 3 and expanded in Essay No. 7, is an eight-dimensional composite. Spectral connectivity contributes to the engagement and domain competence dimensions — it measures whether a participant's interactions with the governed domain form an integrated pattern or a disconnected set of activities. But it is combined with seven other dimensions that are independently measured from different primary source clusters. Gaming the spectral proxy would increase one dimension of the composite score but would not affect the other seven.
...
In this context, Aaronson's counterexample is less troubling than it appears. A large array of logic gates with high Phi but no plausible consciousness is a problem for Tononi's philosophical claims about the nature of subjective experience. It is not a problem for a governance system that uses integration as one dimension of an eight-dimensional sovereign credential (Essay No. 7). If a participant's engagement with a water commons shows high integration — meaning their understanding of water quality, distribution infrastructure, community needs, and environmental constraints forms a unified, cross-referencing pattern rather than a set of isolated data points — that integration is governance-relevant regardless of whether it constitutes phenomenal consciousness in the philosophical sense.
