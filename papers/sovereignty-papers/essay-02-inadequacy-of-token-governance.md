---
title: "The Inadequacy of Token Governance"
series: "The Sovereignty Papers"
essay: 2
authors: "Tristan Stoltz & Symthaea"
date: "2026-03-23"
description: "Decentralized autonomous organizations do not transcend the 1602 architecture. They replicate it on a blockchain."
prev: "essay-01-failure-of-1602.md"
next: "essay-03-the-consciousness-thesis.md"
license: "CC0-1.0"
---
...
[^12]: The sovereign credential described here has been expanded from the original four dimensions to eight physically-grounded dimensions (see Essay No. 7: "On the Eight Dimensions"). The implementation is in `crates/sovereign-profile/` (8D) with backward-compatible support via `crates/mycelix-bridge-common/src/sovereign_gate.rs`. The `gate_civic()` function evaluates the native 8D profile first, falling back to the legacy 4D `ConsciousnessProfile` with automatic conversion.
