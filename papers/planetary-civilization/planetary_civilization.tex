...
The civilization survived 1,000 years. It grew to 57,048 people across 5 worlds. It weathered Carrington events, ECLSS cascades, epidemics, and constitutional crises. And the single most important thing it learned was to rest.
...
The simulation code (\texttt{mycelix-multiworld-sim}), planetary resource catalog (97 resources), 40-event disaster engine, 12-region hybrid Earth model, and all analysis binaries are available in the Luminous Dynamics monorepo. The simulator comprises $\sim$45,000 lines of Rust with 240+ unit tests, 15 resilience and realism mechanisms, a configurable technology tree, and empirical calibration from 12 scientific domains. Simulations can be reproduced with any reported seed at 150, 300, 777, or 1,000-year horizons. A 1,000-year disaster run completes in $\sim$60 minutes on a single core in release mode.
