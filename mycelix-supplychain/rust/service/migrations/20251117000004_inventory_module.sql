...
-- Unique constraint using index for nullable location_id
CREATE UNIQUE INDEX IF NOT EXISTS idx_inv_stock_levels_unique
    ON inv_stock_levels(tenant_id, product_id, warehouse_id, COALESCE(location_id, '00000000-0000-0000-0000-000000000000'::uuid));
