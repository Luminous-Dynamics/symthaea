...
-- Disable foreign key checks temporarily for bulk seed data insert
-- This allows inserting parent/child records in any order
...
VALUES
    -- December invoices
    ('f1000000-0000-0000-0000-000000000001', 'INV-2024-0001', 'c1000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '30 days', NOW(), 'USD', 12500.00, 1031.25, 13531.25, 'PAID', NOW() - INTERVAL '30 days', NOW()),
    ('f2000000-0000-0000-0000-000000000001', 'INV-2024-0002', 'c2000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '28 days', NOW() + INTERVAL '17 days', 'USD', 8750.00, 721.88, 9471.88, 'SENT', NOW() - INTERVAL '28 days', NOW()),
    ('f3000000-0000-0000-0000-000000000001', 'INV-2024-0003', 'c3000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '25 days', NOW() + INTERVAL '5 days', 'USD', 15000.00, 1237.50, 16237.50, 'SENT', NOW() - INTERVAL '25 days', NOW()),
    -- Recent invoices
    ('f4000000-0000-0000-0000-000000000001', 'INV-2024-0004', 'c4000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '15 days', NOW() + INTERVAL '45 days', 'USD', 45000.00, 3712.50, 48712.50, 'SENT', NOW() - INTERVAL '15 days', NOW()),
    ('f5000000-0000-0000-0000-000000000001', 'INV-2024-0005', 'c5000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '10 days', NOW() + INTERVAL '35 days', 'USD', 22500.00, 1856.25, 24356.25, 'SENT', NOW() - INTERVAL '10 days', NOW()),
    ('f6000000-0000-0000-0000-000000000001', 'INV-2024-0006', 'c1000000-0000-0000-0000-000000000001',
...
VALUES
    ('01100000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', 1, 'Industrial Sensors - Model A1', 50, 150.00, 7500.00, 8.25, 618.75),
    ('01100001-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', 2, 'Installation Services', 10, 500.00, 5000.00, 8.25, 412.50),
    ('02200000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000001', 1, 'Organic Feed Supplies - Bulk', 175, 50.00, 8750.00, 8.25, 721.88),
    ('03300000-0000-0000-0000-000000000001', 'f3000000-0000-0000-0000-000000000001', 1, 'Commercial Kitchen Equipment', 5, 2500.00, 12500.00, 8.25, 1031.25),
    ('03300001-0000-0000-0000-000000000001', 'f3000000-0000-0000-0000-000000000001', 2, 'Setup and Training', 5, 500.00, 2500.00, 8.25, 206.25),
    ('04400000-0000-0000-0000-000000000001', 'f4000000-0000-0000-0000-000000000001', 1, 'Medical Monitoring Systems', 15, 3000.00, 45000.00, 8.25, 3712.50),
    ('05500000-0000-0000-0000-000000000001', 'f5000000-0000-0000-0000-000000000001', 1, 'Educational Technology Package', 45, 500.00, 22500.00, 8.25, 1856.25),
    ('06600000-0000-0000-0000-000000000001', 'f6000000-0000-0000-0000-000000000001', 1, 'Advanced Sensors - Model B2', 75, 250.00, 18750.00, 8.25, 1546.88)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('b1000000-0000-0000-0000-000000000001', 'BILL-GM-12001', 'e1000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '35 days', NOW() - INTERVAL '5 days', 'USD', 25000.00, 2062.50, 27062.50, 'PAID', NOW() - INTERVAL '35 days', NOW()),
    ('b2000000-0000-0000-0000-000000000001', 'BILL-PS-12002', 'e2000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '20 days', NOW() - INTERVAL '5 days', 'USD', 4500.00, 371.25, 4871.25, 'PAID', NOW() - INTERVAL '20 days', NOW()),
    ('b3000000-0000-0000-0000-000000000001', 'BILL-TC-12003', 'e3000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '15 days', NOW() + INTERVAL '30 days', 'USD', 18000.00, 1485.00, 19485.00, 'APPROVED', NOW() - INTERVAL '15 days', NOW()),
    ('b4000000-0000-0000-0000-000000000001', 'BILL-OS-12004', 'e4000000-0000-0000-0000-000000000001',
     NOW() - INTERVAL '10 days', NOW() + INTERVAL '20 days', 'USD', 2500.00, 206.25, 2706.25, 'APPROVED', NOW() - INTERVAL '10 days', NOW()),
    ('b5000000-0000-0000-0000-000000000001', 'BILL-UP-12005', 'e5000000-0000-0000-0000-000000000001',
...
VALUES
    ('00100000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 1, 'Raw Materials - Steel Grade A', 500, 50.00, 25000.00, 8.25, 2062.50, 'a5100000-0000-0000-0000-000000000001'),
    ('00200000-0000-0000-0000-000000000001', 'b2000000-0000-0000-0000-000000000001', 1, 'Freight Charges - December', 1, 4500.00, 4500.00, 8.25, 371.25, 'a5300000-0000-0000-0000-000000000001'),
    ('00300000-0000-0000-0000-000000000001', 'b3000000-0000-0000-0000-000000000001', 1, 'Electronic Components Batch', 600, 30.00, 18000.00, 8.25, 1485.00, 'a5100000-0000-0000-0000-000000000001'),
    ('00400000-0000-0000-0000-000000000001', 'b4000000-0000-0000-0000-000000000001', 1, 'Office Supplies - Q4', 1, 2500.00, 2500.00, 8.25, 206.25, 'a6400000-0000-0000-0000-000000000001'),
    ('00500000-0000-0000-0000-000000000001', 'b5000000-0000-0000-0000-000000000001', 1, 'Electricity - December', 1, 3200.00, 3200.00, 8.25, 264.00, 'a6300000-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('d1000000-0000-0000-0000-000000000001', 'PMT-R-2024-0001', 'RECEIVABLE', NOW() - INTERVAL '10 days', 13531.25, 'USD', 'BANK_TRANSFER', 'Wire Transfer #WT12345', 'f1000000-0000-0000-0000-000000000001', NULL, NOW() - INTERVAL '10 days'),
    -- Vendor payments made
    ('d2000000-0000-0000-0000-000000000001', 'PMT-P-2024-0001', 'PAYABLE', NOW() - INTERVAL '8 days', 27062.50, 'USD', 'CHECK', 'Check #10234', NULL, 'b1000000-0000-0000-0000-000000000001', NOW() - INTERVAL '8 days'),
    ('d3000000-0000-0000-0000-000000000001', 'PMT-P-2024-0002', 'PAYABLE', NOW() - INTERVAL '6 days', 4871.25, 'USD', 'BANK_TRANSFER', 'ACH #ACH98765', NULL, 'b2000000-0000-0000-0000-000000000001', NOW() - INTERVAL '6 days')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('ae100000-0000-0000-0000-000000000001', 'JE-2024-0001', NOW() - INTERVAL '90 days',
...
VALUES
    -- Opening balances
    ('af100001-0000-0000-0000-000000000001', 'ae100000-0000-0000-0000-000000000001', 1, 'a1010000-0000-0000-0000-000000000001', 150000.00, NULL, 'Opening cash balance'),
    ('af100002-0000-0000-0000-000000000001', 'ae100000-0000-0000-0000-000000000001', 2, 'a1230000-0000-0000-0000-000000000001', 75000.00, NULL, 'Opening inventory'),
    ('af100003-0000-0000-0000-000000000001', 'ae100000-0000-0000-0000-000000000001', 3, 'a1510000-0000-0000-0000-000000000001', 50000.00, NULL, 'Opening equipment'),
    ('af100004-0000-0000-0000-000000000001', 'ae100000-0000-0000-0000-000000000001', 4, 'a2510000-0000-0000-0000-000000000001', NULL, 25000.00, 'Opening bank loan'),
    ('af100005-0000-0000-0000-000000000001', 'ae100000-0000-0000-0000-000000000001', 5, 'a3100000-0000-0000-0000-000000000001', NULL, 200000.00, 'Opening capital'),
    ('af100006-0000-0000-0000-000000000001', 'ae100000-0000-0000-0000-000000000001', 6, 'a3200000-0000-0000-0000-000000000001', NULL, 50000.00, 'Retained earnings')
ON CONFLICT (id) DO NOTHING;

-- Monthly rent entry
INSERT INTO journal_entries (id, entry_number, entry_date, description, reference, status, lines_hash, created_by, created_at, posted_at)
VALUES
    ('ae200000-0000-0000-0000-000000000001', 'JE-2024-0010', NOW() - INTERVAL '15 days',
...
INSERT INTO journal_lines (id, entry_id, line_number, account_id, debit_amount, credit_amount, description)
VALUES
    ('af200001-0000-0000-0000-000000000001', 'ae200000-0000-0000-0000-000000000001', 1, 'a6200000-0000-0000-0000-000000000001', 8500.00, NULL, 'Rent expense'),
    ('af200002-0000-0000-0000-000000000001', 'ae200000-0000-0000-0000-000000000001', 2, 'a1010000-0000-0000-0000-000000000001', NULL, 8500.00, 'Cash payment')
ON CONFLICT (id) DO NOTHING;

-- Payroll entry
INSERT INTO journal_entries (id, entry_number, entry_date, description, reference, status, lines_hash, created_by, created_at, posted_at)
VALUES
    ('ae300000-0000-0000-0000-000000000001', 'JE-2024-0015', NOW() - INTERVAL '7 days',
...
INSERT INTO journal_lines (id, entry_id, line_number, account_id, debit_amount, credit_amount, description)
VALUES
    ('af300001-0000-0000-0000-000000000001', 'ae300000-0000-0000-0000-000000000001', 1, 'a6100000-0000-0000-0000-000000000001', 25000.00, NULL, 'Gross wages'),
    ('af300002-0000-0000-0000-000000000001', 'ae300000-0000-0000-0000-000000000001', 2, 'a2220000-0000-0000-0000-000000000001', NULL, 3825.00, 'Payroll taxes withheld'),
    ('af300003-0000-0000-0000-000000000001', 'ae300000-0000-0000-0000-000000000001', 3, 'a1020000-0000-0000-0000-000000000001', NULL, 21175.00, 'Net pay from payroll account')
ON CONFLICT (id) DO NOTHING;
