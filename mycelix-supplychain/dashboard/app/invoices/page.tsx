...
export default function InvoicesPage() {
  ...
  return (
    <DashboardLayout title="Invoices" subtitle="Manage customer invoices and track payments">
      {/* Stats */}
                    ...
                    <tr key={invoice.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center">
                          <span className={`inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full ${statusColors[invoice.status]}`}>
