...
use mycelix_space_shared::{
    ...
    requirement_for_observation, validate_string_field, PaginatedResponse, PaginationParams,
    SpaceError, SpaceErrorCode, SpaceTimestamp,
};
...
pub fn create_conjunction_proposal(input: CreateProposalInput) -> ExternResult<ActionHash> {
    gate_space_operation(&requirement_for_negotiation(), "create_conjunction_proposal")?;
