...
impl ExperimentDesigner {
    ...
    fn design_phase_2_mechanism() -> ExperimentPhase {
        ExperimentPhase {
            ...
            goal: "Discriminate between hot spot, phonon cascade, and screening hypotheses".to_string(),
            experiments: vec![
        ...
        ExperimentDesign {
            ...
            instrumentation: vec![
                Instrument {
                    ...
                    specifications: "³He proportional counter, >10% efficiency at 2.45 MeV".to_string(),
                    cost_usd: 15000.0,
