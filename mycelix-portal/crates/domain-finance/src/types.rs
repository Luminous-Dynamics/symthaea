...
pub enum PaymentType { Direct, TreasuryContribution, CommonsContribution, Escrow, Recurring }

#[derive(Clone, Debug, Serialize, Deserialize, PartialEq)]
pub enum TransferStatus { Pending, Processing, Completed, Failed, Cancelled, Refunded }
...
#[derive(Clone, Debug, Serialize, Deserialize, PartialEq)]
pub enum ContributionType { Deposit, Yield, Fee, Grant, Other }
...
#[derive(Clone, Debug, Serialize, Deserialize, PartialEq)]
pub enum StakeStatus { Active, Unbonding, Withdrawn, Slashed, Jailed }
...
pub enum SlashingReason {
    DoubleSigning, Downtime, ByzantineConsensus,
    InvalidGradient, CartelActivity, GovernanceManipulation,
}
