...
use portal_games::math::unit_circle::UnitCircleExplorer;
use portal_games::physics::projectile::ProjectileExplorer;
use portal_games::progress::provide_progress_store;
...
fn GameSelector() -> impl IntoView {
    ...
    let games = vec![
        ("unit-circle", "Unit Circle", "Explore sin, cos, tan", "#2563EB"),
        ("projectile", "Projectile Motion", "h = v\u{2080}t - \u{00bd}gt\u{00b2}", "#22c55e"),
        ("parabola", "Parabola Explorer", "y = a(x-p)\u{00b2} + q", "#8b5cf6"),
        ("circuits", "Electric Circuits", "Ohm's law, series/parallel", "#f59e0b"),
        ("tangent", "Tangent Lines", "Derivative as slope", "#ec4899"),
        ("stats", "Statistics", "Mean, median, distributions", "#06b6d4"),
        ("analytical", "Analytical Geometry", "Distance, midpoint", "#059669"),
    ];
