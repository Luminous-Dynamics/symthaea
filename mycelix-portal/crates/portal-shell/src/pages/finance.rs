...
enum FinView { Overview, Payments, Staking, Recognition }
...
impl FinState {
    fn new() -> Self {
        Self {
            balance: RwSignal::new(SapBalance { member_did: "did:me".into(), balance: 4_280_000, last_demurrage_at: 1711900800 }),
            stake: RwSignal::new(Some(CollateralStake { id: "s-1".into(), staker_did: "did:me".into(), sap_amount: 1_200_000, mycel_score: 0.72, stake_weight: 1.72, staked_at: 1710000000, unbonding_until: None, status: StakeStatus::Active, pending_rewards: 45_000 })),
            mycel: RwSignal::new(MemberMycelState { member_did: "did:me".into(), mycel_score: 0.72, participation: 0.85, recognition: 0.65, validation: 0.70, longevity: 0.68, active_months: 14, is_apprentice: false }),
            payments: RwSignal::new(vec![
                Payment { id: "p-1".into(), from_did: "did:me".into(), to_did: "did:elena".into(), amount: 150_000, fee: 1500, currency: "SAP".into(), payment_type: PaymentType::Direct, status: TransferStatus::Completed, memo: Some("Care coordination".into()), created: 1711900800, completed: Some(1711900900) },
                Payment { id: "p-2".into(), from_did: "did:commune".into(), to_did: "did:me".into(), amount: 320_000, fee: 0, currency: "SAP".into(), payment_type: PaymentType::CommonsContribution, status: TransferStatus::Completed, memo: Some("Solar garden yield".into()), created: 1711814400, completed: Some(1711814500) },
                Payment { id: "p-3".into(), from_did: "did:me".into(), to_did: "did:treasury".into(), amount: 50_000, fee: 500, currency: "SAP".into(), payment_type: PaymentType::TreasuryContribution, status: TransferStatus::Completed, memo: None, created: 1711728000, completed: Some(1711728100) },
            ]),
        }
    }
}
