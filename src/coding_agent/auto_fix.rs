...
impl CodingAgent {
    ...
    pub(crate) fn try_structured_auto_fix(&mut self) -> bool {
    ...
    pub(crate) fn try_apply_compiler_suggestions(
        code: &str,
    ...
    pub(crate) fn try_category_aware_fix(
        &self,
        code: &str,
        errors: &[crate::language::code_executor::CompileError],
    ) -> Option<String> {
    ...
    pub(crate) fn extract_unresolved_name(msg: &str) -> Option<String> {
        Self::extract_between_backticks(msg)
    }

    /// Extract variable name from "unused variable: `x`" messages.
    pub(crate) fn extract_unused_var(msg: &str) -> Option<String> {
    ...
    pub(crate) fn extract_between_backticks(msg: &str) -> Option<String> {
    ...
    pub(crate) fn store_fix_strategies(
        &mut self,
        errors: &[crate::language::code_executor::CompileError],
        strategy: &str,
    ) {
    ...
    pub(crate) fn sanitize_generated_code(code: &str) -> String {
    ...
    pub(crate) fn strip_main_wrapper(code: &str) -> String {
    ...
    pub(crate) fn fix_undeclared_generics(code: &str) -> String {
    ...
    pub(crate) fn body_uses_generic_t(lines: &[&str], start: usize) -> bool {
        let mut depth = 1usize;
    ...
    pub(crate) fn line_references_type_t(line: &str) -> bool {
    ...
    pub(crate) fn signature_uses_t(sig: &str) -> bool {
    ...
    pub(crate) fn impl_uses_t(line: &str) -> bool {
    ...
    pub(crate) fn insert_generic_param_on_item(line: &str) -> String {
    ...
    pub(crate) fn insert_generic_param_on_fn(line: &str) -> String {
