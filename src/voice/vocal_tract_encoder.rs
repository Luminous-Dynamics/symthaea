...
mod tests {
    ...
    fn test_encoder_extreme_values() {
        ...
        let extreme = VoiceCognitiveState {
            prediction_error: 10.0,      // way above range
            emotional_valence: -5.0,     // way below range
            emotional_arousal: 100.0,    // way above range
            unified_quality: -1.0,       // below range
            epistemic_confidence: 2.0,   // above range
            coherence_velocity: -10.0,   // way below range
            cross_agreement: 50.0,       // way above range
            consciousness_level: -0.5,   // below range
            articulation_quality: 1.5,   // above range
            rate_stability: -0.1,        // below range
        };
