...
impl CognitiveLoopService {
    cognitive_accessors! {
        ...
        pub fn stats(&self) -> &LoopStats { &self.stats }

        /// Export neurochemistry checkpoint for persistence across sessions.
        pub fn neurochemistry_checkpoint(&self) -> super::neuromodulators::NeurochemistryCheckpoint { self.neuromodulator_bath.checkpoint() }

        /// Get a complete neurochemical state snapshot for telemetry/visualization.
        pub fn neuromod_snapshot(&self) -> super::neuromodulators::NeuromodSnapshot { self.neuromodulator_bath.snapshot() }
        ...
        pub fn config(&self) -> &CognitiveLoopConfig { &self.config }
        ...
        pub fn bath_phase_tracker(&self) -> &super::neuromodulators::BathPhaseTracker { &self.bath_phase_tracker }
        ...
        pub fn bath_phase_detector(&self) -> &super::neuromodulators::PhaseTransitionDetector { &self.bath_phase_detector }
        ...
        pub fn coherence_summary(&self) -> CoherenceSummary { self.coherence_bridge.summary() }
        ...
        pub fn stability_regime(&self) -> &StabilityRegimeProcessor { &self.stability_regime }
        ...
        pub fn self_assessment(&self) -> SelfAssessment { self.self_reflection.self_assessment }

        /// Get self-reflection summary
        pub fn reflection_summary(&self) -> ReflectionSummary { self.self_reflection.summary() }

        /// Get adapted thresholds from self-reflection
        pub fn adapted_thresholds(&self) -> ReflectionThresholds { self.self_reflection.get_thresholds() }

        /// Get current recommendations from self-reflection
        pub fn recommendations(&self) -> &[Recommendation] { &self.self_reflection.recommendations }

        /// Get number of reflections performed
        pub fn reflection_count(&self) -> u64 { self.self_reflection.reflection_count }

        /// Get learning effectiveness score
        pub fn learning_effectiveness(&self) -> f32 { self.self_reflection.learning_effectiveness() }

        /// Check if system needs calibration
        pub fn needs_calibration(&self) -> bool { self.self_reflection.self_assessment == SelfAssessment::NeedsCalibration }

        /// Check if system is performing optimally
        pub fn is_optimal(&self) -> bool { self.self_reflection.self_assessment == SelfAssessment::Optimal }

        /// Get self-reflection reference
        pub(crate) fn self_reflection(&self) -> &SelfReflection { &self.self_reflection }
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // NON-TRIVIAL METHODS (multi-line, &mut self, extra params, closures)
    // ═══════════════════════════════════════════════════════════════════════
