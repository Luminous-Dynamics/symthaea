...
pub const FAB_NEUROMOD_FLOOR: f64 = 0.01;
...
pub const FAB_ANOMALY_NE_DOSE: f64 = 0.06;
...
pub const FAB_QUALITY_TREND_SHT_NUDGE: f64 = 0.03;
...
pub const FAB_HIGH_POG_OXY_DOSE: f64 = 0.03;
...
pub const FAB_POG_HIGH_THRESHOLD: f64 = 0.7;
...
pub const FAB_LOW_QUALITY_THRESHOLD: f64 = 0.5;
...
pub const FAB_POOR_QUALITY_THRESHOLD: f64 = 0.3;

/// EMA alpha for anomaly severity tracking.
pub const FAB_ANOMALY_EMA_ALPHA: f64 = 0.15;

/// EMA alpha for PoGF score tracking.
pub const FAB_POG_EMA_ALPHA: f64 = 0.1;
...
pub const FAB_EMERGENCY_AROUSAL: f64 = 0.15;

/// Arousal delta on ManufacturingSafetyLevel::Orange (elevated concern).
pub const FAB_ORANGE_AROUSAL: f64 = 0.05;
