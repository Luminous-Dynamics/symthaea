...
/// Prediction error above this threshold triggers negative reward scaling.
pub const REWARD_HIGH_ERROR_THRESHOLD: f32 = 0.5;

// ═══════════════════════════════════════════════════════════════════════════════
// PHYSICS EXPLORATION / EXPLOITATION
// ═══════════════════════════════════════════════════════════════════════════════

/// Physics module exploitation confidence threshold.
pub const PHYSICS_EXPLOIT_THRESHOLD: f32 = 0.5;
/// Scale factor for exploitation reward.
pub const PHYSICS_EXPLOIT_SCALE: f32 = 0.3;
/// Physics module exploration curiosity threshold.
pub const PHYSICS_EXPLORE_THRESHOLD: f32 = 0.2;
/// Scale factor for exploration bonus.
...
/// High coherence threshold — prediction quality boost above this.
pub const PRED_COHERENCE_HIGH_THRESHOLD: f32 = 0.8;
/// Low coherence threshold — learning rate dampened below this.
pub const PRED_COHERENCE_LOW_THRESHOLD: f32 = 0.4;
/// Boost scale when prediction coherence is high.
pub const PRED_COHERENCE_HIGH_BOOST_SCALE: f32 = 0.1;
/// Dampen scale when prediction coherence is low.
...
/// EMA alpha for prediction error tracking.
pub const ERROR_EMA_ALPHA: f32 = 0.1;
/// EMA alpha for cycle timing tracking.
pub const TIMING_EMA_ALPHA: f32 = 0.01;

// ═══════════════════════════════════════════════════════════════════════════════
// EXPERIENCE / PREFRONTAL
// ═══════════════════════════════════════════════════════════════════════════════
