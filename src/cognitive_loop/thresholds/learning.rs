...
pub const FEP_SURPRISE_SCALE: f64 = 3.0;
...
pub const FEP_LR_DECAY: f64 = 0.95;
...
pub const POLICY_FULL_AGREEMENT_BOOST: f64 = 1.2;
...
pub const MEMORY_CONTEXT_BOOST_SCALE: f64 = 0.1;
...
pub const SURPRISE_BOREDOM_DAMPEN: f64 = 0.7;
...
pub const MEMORY_RECALL_SIM_THRESHOLD: f64 = 0.3;
...
pub const INPUT_MEMO_THRESHOLD: f64 = 0.95;
...
pub const PERCEPTION_COHERENCE_HIGH: f64 = 0.7;
...
pub const PERCEPTION_BINDING_HIGH: f64 = 0.7;
...
pub const EPISTEMIC_UNCERTAINTY_EMA_PRIOR: f64 = 0.8;

/// EMA current weight for epistemic uncertainty smoothing (alpha).
pub const EPISTEMIC_UNCERTAINTY_EMA_CURRENT: f64 = 0.2;
...
pub const COMPOUND_INSTABILITY_AGREEMENT: f64 = 0.5;
...
pub const PROPOSAL_CONFLICT_EXPLORATION: f64 = 0.3;
...
pub const FLOW_INTENSITY_FEEDBACK: f64 = 0.5;
...
pub const SELF_MODEL_ACCURACY_EMA: f64 = 0.9;

/// High self-model accuracy → trust boost multiplier.
pub const SELF_MODEL_HIGH_TRUST_BOOST: f64 = 0.03;

/// Low self-model accuracy → confidence scaling.
pub const SELF_MODEL_LOW_CONFIDENCE_SCALE: f64 = 0.98;

/// Self-model accuracy threshold for "high" classification.
pub const SELF_MODEL_HIGH_THRESHOLD: f64 = 0.7;

/// Self-model accuracy threshold for "low" classification.
pub const SELF_MODEL_LOW_THRESHOLD: f64 = 0.3;
...
pub const TEMPORAL_CHAIN_DEEP_LR_SCALE: f64 = 0.85;
...
pub const TEMPORAL_CHAIN_SHALLOW_LR_SCALE: f64 = 1.15;
...
pub const COHERENCE_VELOCITY_BUDGET_THRESHOLD: f64 = 0.05;
...
pub const WORLD_MODEL_STIFFNESS_THRESHOLD: f64 = 0.5;

/// World model stiffness → LR nudge scale.
pub const WORLD_MODEL_STIFFNESS_LR_SCALE: f64 = 0.05;

/// World model sponginess threshold → learning rate reduction.
pub const WORLD_MODEL_SPONGINESS_THRESHOLD: f64 = 0.2;

/// Sponginess → LR dampen scale.
pub const WORLD_MODEL_SPONGY_LR_SCALE: f64 = 0.15;
...
pub const EPISTEMIC_REJECTION_LR_SCALE: f64 = 0.3;

/// Epistemic gate: rejection → confidence scaling factor.
pub const EPISTEMIC_REJECTION_CONFIDENCE_SCALE: f64 = 0.15;

/// Epistemic gate: approval threshold for LR boost.
pub const EPISTEMIC_APPROVAL_THRESHOLD: f64 = 0.6;

/// Epistemic gate: approval → LR boost scale.
pub const EPISTEMIC_APPROVAL_LR_SCALE: f64 = 0.08;

/// Caution threshold for epistemic gate (hedging behavior).
pub const EPISTEMIC_CAUTION_THRESHOLD: f64 = 0.4;

/// Caution → threshold scaling factor.
pub const EPISTEMIC_CAUTION_SCALE: f64 = 0.3;

/// Trust threshold for epistemic gate (full endorsement).
pub const EPISTEMIC_TRUST_THRESHOLD: f64 = 0.8;

/// Trust → threshold relief scale.
pub const EPISTEMIC_TRUST_SCALE: f64 = 0.15;
...
pub const TEMPORAL_REPLAY_TRIGGER: f64 = 0.3;
...
pub const TEMPORAL_CHAIN_BOOST_FACTOR: f64 = 0.005;
...
pub const Q_VALUE_INITIAL: f64 = 0.5;
...
pub const EXPLORATION_RATE_INITIAL: f64 = 0.2;
...
pub const EXPLORATION_DECAY_RATE: f64 = 0.999;

/// Minimum exploration rate floor.
pub const EXPLORATION_RATE_MIN: f64 = 0.05;
...
pub const REWARD_NEGATIVE_THRESHOLD: f64 = -0.2;
...
pub const FEP_LEARNING_PLASTICITY_THRESHOLD: f64 = 0.5;
...
pub const FEP_COMPLEXITY_LR_DAMPEN: f64 = 0.85;

/// FEP complexity minimum learning rate multiplier floor.
pub const FEP_COMPLEXITY_LR_FLOOR: f64 = 0.1;

/// FEP complexity pause multiplier: scales pause duration when complexity is high.
pub const FEP_COMPLEXITY_PAUSE_MULT: f64 = 1.2;

/// FEP complexity maximum pause multiplier.
pub const FEP_COMPLEXITY_PAUSE_MAX: f64 = 2.0;
...
pub const SELF_MODEL_CONFIDENCE_WEIGHT: f64 = 0.7;

/// Urgency match weight in self-model accuracy composite.
pub const SELF_MODEL_URGENCY_WEIGHT: f64 = 0.3;
...
pub const PE_VARIANCE_THRESHOLD: f64 = 0.01;

/// Maximum PE variance effect (above threshold + this = full dampen).
pub const PE_VARIANCE_MAX_EFFECT: f64 = 0.05;

/// PE variance → confidence dampen multiplier.
pub const PE_VARIANCE_DAMPEN_SCALE: f64 = 2.0;
...
pub const EPISTEMIC_SEMANTIC_CAUTION_THRESHOLD: f64 = 0.4;

/// Epistemic confidence threshold for semantic LR boost.
pub const EPISTEMIC_SEMANTIC_BOOST_THRESHOLD: f64 = 0.8;

/// Base caution factor applied when epistemic confidence is low.
pub const EPISTEMIC_SEMANTIC_CAUTION_BASE: f64 = 0.8;

/// Caution scaling from epistemic confidence (additive).
pub const EPISTEMIC_SEMANTIC_CAUTION_SCALE: f64 = 0.5;

/// Boost scaling from epistemic confidence (multiplicative on excess).
pub const EPISTEMIC_SEMANTIC_BOOST_SCALE: f64 = 1.0;
...
pub const EPISTEMIC_EXPLORE_THRESHOLD: f64 = 0.4;

/// Epistemic uncertainty → exploration scale.
pub const EPISTEMIC_EXPLORE_SCALE: f64 = 0.1;

/// Low epistemic uncertainty threshold for exploration dampening.
pub const EPISTEMIC_LOW_THRESHOLD: f64 = 0.15;

/// Low epistemic → exploration dampen amount.
pub const EPISTEMIC_LOW_DAMPEN: f64 = 0.02;
...
pub const EPISTEMIC_OSCILLATION_THRESHOLD: f64 = 0.5;

/// Oscillation × uncertainty exploration multiplier.
pub const EPISTEMIC_OSCILLATION_MULTIPLIER: f64 = 1.5;
...
pub const MCTS_EFFECTIVENESS_HIGH: f64 = 0.6;

/// MCTS effectiveness threshold for exploration trigger.
pub const MCTS_EFFECTIVENESS_LOW: f64 = 0.3;

/// MCTS effective → confidence scale.
pub const MCTS_EFFECTIVENESS_CONFIDENCE_SCALE: f64 = 0.03;

/// MCTS poor plan → exploration scale.
pub const MCTS_EFFECTIVENESS_EXPLORE_SCALE: f64 = 0.02;

/// MCTS effectiveness EMA decay.
pub const MCTS_EFFECTIVENESS_EMA: f64 = 0.9;

/// MCTS plan confidence threshold for application.
pub const MCTS_PLAN_CONFIDENCE_THRESHOLD: f64 = 0.7;

/// MCTS plan → action weight scale.
pub const MCTS_PLAN_WEIGHT_SCALE: f64 = 0.4;

/// MCTS exploit → LR scale per unit plan weight.
pub const MCTS_EXPLOIT_LR_SCALE: f64 = 0.1;

/// MCTS consolidate → confidence scale per unit plan weight.
pub const MCTS_CONSOLIDATE_CONFIDENCE_SCALE: f64 = 0.05;

/// MCTS explore → exploration scale per unit plan weight.
pub const MCTS_EXPLORE_SCALE: f64 = 0.08;
...
pub const EPISTEMIC_UNCERTAINTY_DEFAULT: f64 = 0.5;

/// Default aleatoric uncertainty when insufficient prediction data.
pub const ALEATORIC_UNCERTAINTY_DEFAULT: f64 = 0.1;
...
pub const AGREEMENT_HIGH_CONFIDENCE_SCALE: f64 = 0.05;

/// Confidence dampen scale when cross-module agreement is low.
pub const AGREEMENT_LOW_CONFIDENCE_SCALE: f64 = 0.1;
...
pub const COMPOUND_INSTABILITY_VELOCITY: f64 = -0.10;

/// Error slope threshold for compound instability detection.
pub const COMPOUND_INSTABILITY_ERROR_SLOPE: f64 = 0.02;

/// Learning rate scale during compound instability (protective dampening).
pub const COMPOUND_INSTABILITY_LR_SCALE: f64 = 0.93;

/// Exploration boost during compound instability.
pub const COMPOUND_INSTABILITY_EXPLORATION: f64 = 0.025;

/// Agreement velocity threshold for rapid-drop preemptive response.
pub const AGREEMENT_VELOCITY_DROP_THRESHOLD: f64 = -0.15;

/// Learning rate scale during rapid agreement drop.
pub const AGREEMENT_VELOCITY_DROP_LR: f64 = 0.97;

/// Exploration boost during rapid agreement drop.
pub const AGREEMENT_VELOCITY_DROP_EXPLORATION: f64 = 0.015;
...
pub const AGREEMENT_CONFIDENCE_COUPLING_SCALE: f64 = 0.98;

/// Coherence velocity threshold for agreement-confidence coupling detection.
pub const AGREEMENT_COHERENCE_VELOCITY_THRESHOLD: f64 = -0.01;
...
pub const SURPRISE_PE_THRESHOLD: f64 = 0.2;
/// Maximum PE excess for scale computation.
pub const SURPRISE_PE_EXCESS_CAP: f64 = 0.5;
/// PE scale factor for exploration intensity.
pub const SURPRISE_PE_SCALE_FACTOR: f64 = 0.3;
...
pub const MEMO_DIVERSITY_LOW: f64 = 0.4;
/// Adjustment scale for low diversity → threshold reduction.
pub const MEMO_DIVERSITY_LOW_SCALE: f64 = 0.1;
/// Minimum memo threshold floor.
pub const MEMO_THRESHOLD_FLOOR: f64 = 0.88;
/// High codebook diversity threshold → raise memo threshold (less memoization).
pub const MEMO_DIVERSITY_HIGH: f64 = 0.8;
/// Adjustment scale for high diversity → threshold increase.
pub const MEMO_DIVERSITY_HIGH_SCALE: f64 = 0.05;
/// Maximum memo threshold ceiling.
pub const MEMO_THRESHOLD_CEILING: f64 = 0.98;
...
pub const MEMORY_CODEBOOK_UTIL_EMA_DECAY: f64 = 0.8;

/// Codebook utilization EMA new-data weight.
pub const MEMORY_CODEBOOK_UTIL_EMA_NEW: f64 = 0.2;

/// Novelty threshold increase rate when codebook utilization is low.
pub const MEMORY_NOVELTY_THRESHOLD_INCREASE: f64 = 0.02;

/// Novelty threshold decrease rate when codebook utilization is high.
pub const MEMORY_NOVELTY_THRESHOLD_DECREASE: f64 = 0.01;

/// Low utilization trigger (below this, increase novelty threshold).
pub const MEMORY_CODEBOOK_LOW_UTILIZATION: f64 = 0.2;

/// High utilization trigger (above this, decrease novelty threshold).
pub const MEMORY_CODEBOOK_HIGH_UTILIZATION: f64 = 0.6;
...
pub const CAUSAL_CONFIDENCE_DENSE_THRESHOLD: f64 = 0.5;

/// Confidence boost scale for dense causal graph.
pub const CAUSAL_DENSE_CONFIDENCE_SCALE: f64 = 0.03;
...
pub const CAUSAL_CONFIDENCE_MODERATE_THRESHOLD: f64 = 0.4;

/// Confidence boost scale for emerging causal graph.
pub const CAUSAL_MODERATE_CONFIDENCE_SCALE: f64 = 0.01;
...
pub const SLEEP_PRESSURE_LR_THRESHOLD: f64 = 0.7;

/// Scale factor for sleep pressure LR dampening.
pub const SLEEP_PRESSURE_LR_DAMPEN_SCALE: f64 = 0.5;

/// Minimum LR factor under maximal sleep pressure.
pub const SLEEP_PRESSURE_LR_FACTOR_MIN: f64 = 0.5;
...
pub const EPISTEMIC_CONFLICT_EXPLORE_SCALE: f64 = 0.015;
...
pub const GOAL_PRIORITY_LR_THRESHOLD: f64 = 0.5;

/// Goal priority above this → boost exploration in goal pursuit direction.
pub const GOAL_PRIORITY_EXPLORATION_THRESHOLD: f64 = 0.3;
...
pub const RESONATOR_SIMILARITY_PRIME_THRESHOLD: f64 = 0.3;
...
pub const MCTS_EFFECTIVENESS_HIGH_THRESHOLD: f64 = 0.6;

/// Confidence boost when MCTS plans are highly effective.
pub const MCTS_EFFECTIVENESS_CONFIDENCE_BOOST: f64 = 0.01;
...
pub const MCTS_EFFECTIVENESS_LOW_THRESHOLD: f64 = 0.2;

/// Exploration boost when MCTS planning is ineffective.
pub const MCTS_EFFECTIVENESS_LOW_EXPLORE_BOOST: f64 = 0.015;
...
pub const DRIVE_BOREDOM_PLASTICITY_THRESHOLD: f64 = 0.5;
...
pub const DRIVE_BOREDOM_PLASTICITY_GAIN: f64 = 0.33;
...
pub const MEMORY_CONSOLIDATION_PLASTICITY_THRESHOLD: f64 = 0.6;
...
pub const MEMORY_CONSOLIDATION_PLASTICITY_GAIN: f64 = 0.15;
...
pub const MEMORY_RECALL_QUALITY_DAMPEN_THRESHOLD: f64 = 0.3;
...
pub const MEMORY_RECALL_QUALITY_DAMPEN_SCALE: f64 = 0.2;
...
pub const PERCEPTION_LOW_COHERENCE_THRESHOLD: f64 = 0.3;
...
pub const PERCEPTION_LOW_COHERENCE_EXPLORE_GAIN: f64 = 0.08;
...
pub const RESONATOR_CAUSAL_CONSOLIDATION_BOOST: f64 = 0.1;

/// Confidence boost when resonator factor is high (strong recall).
pub const RESONATOR_FACTOR_HIGH_CONFIDENCE: f64 = 0.02;

/// Scale for best-match similarity → resonator recall confidence boost.
pub const RESONATOR_RECALL_PRIME_SCALE: f64 = 0.05;

/// Confidence boost when resonator error is sustained low across many cycles.
pub const RESONATOR_SUSTAINED_LOW_CONFIDENCE: f64 = 0.01;
...
pub const SPARSE_CAUSAL_EXPLORATION_BOOST: f64 = 0.03;
...
pub const TEMPORAL_BINDING_HIGH_EXPLORE_SCALE: f64 = 1.02;
...
pub const PHI_SCALE_BOOST_MAX_AMPLITUDE: f64 = 0.15;

/// Sigmoid slope for Phi scale boost activation.
pub const PHI_SCALE_BOOST_SIGMOID_SLOPE: f64 = -2.0;

/// Center of sigmoid: CV = 1.0 is the half-activation point.
pub const PHI_SCALE_BOOST_CV_CENTER: f64 = 1.0;
...
pub const GOAL_PRIORITY_LR_SCALE: f64 = 0.1;
...
pub const SOCIAL_TRUST_ITHOU_THRESHOLD: f64 = 0.3;
...
pub const WORLD_MODEL_CONFUSION_RATIO: f64 = 1.5;

/// World model sensory/abstract error ratio for sensory mismatch.
pub const WORLD_MODEL_MISMATCH_RATIO: f64 = 2.0;

/// Minimum absolute error before confusion/mismatch detection fires.
pub const WORLD_MODEL_ERROR_FLOOR: f64 = 0.1;
...
pub const MCTS_EFFECTIVENESS_NORM_SCALE: f64 = 0.5;

/// MCTS effectiveness normalization offset.
pub const MCTS_EFFECTIVENESS_NORM_OFFSET: f64 = 0.5;
...
pub const MORAL_VALUE_FEEDBACK_SCALE: f64 = 0.1;
...
pub const CROSS_MODAL_LINGUISTIC_CONFIDENCE: f64 = 0.8;

/// Cross-modal binding precision boost threshold.
/// Basis: Talsma (2015) — predictive-binding bidirectional coupling.
pub const CROSS_MODAL_PRECISION_BOOST_THRESHOLD: f64 = 0.5;
...
pub const CROSS_MODAL_FE_DAMPEN_MIN: f64 = 0.5;

/// Self-reflection confidence threshold for applying recommendations.
pub const REFLECTION_CONFIDENCE_THRESHOLD: f64 = 0.5;

/// Self-reflection LR decrease factor.
pub const REFLECTION_LR_DECREASE: f64 = 0.9;

/// Self-reflection LR increase factor.
pub const REFLECTION_LR_INCREASE: f64 = 1.1;

/// Self-reflection exploration increase delta.
pub const REFLECTION_EXPLORATION_INCREASE: f64 = 0.12;

/// Self-reflection exploration decrease scale.
pub const REFLECTION_EXPLORATION_DECREASE: f64 = 0.75;
