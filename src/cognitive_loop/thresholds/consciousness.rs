...
pub const CANTOR_DREAM_QUALITY_THRESHOLD: f64 = 0.7;
...
pub const CANTOR_RESONANCE_SIMILARITY_THRESHOLD: f64 = 0.8;
...
pub const CANTOR_RESONANCE_CONFIDENCE_BOOST: f64 = 0.02;
...
pub const CANTOR_SURPRISE_EXPLORATION_THRESHOLD: f64 = 0.3;

/// Exploration boost scale from dream surprise.
pub const CANTOR_SURPRISE_EXPLORATION_BOOST: f64 = 0.04;

/// Resonance threshold for exploration dampening.
/// Above this, attractor found → exploit mode (stop exploring).
pub const CANTOR_RESONANCE_EXPLORATION_DAMPEN_THRESHOLD: f64 = 0.5;

/// Exploration dampening scale from resonance.
pub const CANTOR_RESONANCE_EXPLORATION_DAMPEN: f64 = -0.03;
...
pub const CANTOR_RADIAL_BINDING_THRESHOLD: f64 = 0.6;
...
pub const CANTOR_SURPRISE_BROCA_THRESHOLD: f64 = 0.4;
...
pub const MCE_LR_BOOST_SCALE: f64 = 0.2;

/// MCE LR boost decay per cycle (multiplicative).
pub const MCE_BOOST_DECAY: f64 = 0.9;
...
pub const FLOW_PSI_WEIGHT: f64 = 0.2;
...
pub const RELATIONAL_PSI_WEIGHT: f64 = 0.15;
...
pub const MCE_BOTTLENECK_LR_BOOST: f64 = 1.08;

/// Confidence boost when MCE bottleneck is NOT integration (system is well-integrated).
pub const MCE_NON_BOTTLENECK_CONFIDENCE_BOOST: f64 = 0.005;
...
pub const BINDING_CONFIDENCE_THRESHOLD: f64 = 0.7;

/// Binding strength low threshold for caution/penalty.
pub const BINDING_LOW_THRESHOLD: f64 = 0.3;

/// Strong binding → threshold relief scale.
pub const BINDING_STRONG_RELIEF_SCALE: f64 = 0.3;

/// Weak binding → threshold caution scale.
pub const BINDING_WEAK_CAUTION_SCALE: f64 = 0.2;

/// Strong binding → confidence boost scale.
pub const BINDING_STRONG_CONFIDENCE_SCALE: f64 = 0.1;

/// Weak binding → confidence dampen scale.
pub const BINDING_WEAK_CONFIDENCE_SCALE: f64 = 0.15;
...
pub const COHERENCE_PREDICTION_EMA: f64 = 0.9;

/// Low coherence threshold for confidence dampening.
pub const COHERENCE_LOW_THRESHOLD: f64 = 0.5;

/// Low coherence → confidence dampen scale.
pub const COHERENCE_LOW_DAMPEN_SCALE: f64 = 0.04;

/// High coherence threshold for confidence boost.
pub const COHERENCE_HIGH_THRESHOLD: f64 = 0.8;

/// Coherence → confidence boost factor.
pub const COHERENCE_CONFIDENCE_BOOST: f64 = 0.02;
...
pub const REASONING_CONFIDENCE_BOOST_THRESHOLD: f64 = 0.7;

/// Reasoning chain confidence boost factor (multiplicative on delta).
pub const REASONING_CONFIDENCE_BOOST_FACTOR: f64 = 0.03;
...
pub const SPECTRAL_WEIGHT_BASE: f64 = 0.6;

/// Spectral weight adjustment scale per unit correlation delta.
pub const SPECTRAL_WEIGHT_SCALE: f64 = 0.67;
...
pub const CAUSAL_BINDING_THRESHOLD: f64 = 0.5;
...
pub const REASONING_CHAIN_CONFIDENCE_THRESHOLD: f64 = 0.7;

/// Scale factor for reasoning chain confidence boost (per unit above threshold).
pub const REASONING_CHAIN_BOOST_SCALE: f64 = 0.05;
...
pub const THETA_DEFAULT_SALIENCE: f64 = 0.1;
/// Minimum salience clamp for theta-phase binding.
pub const THETA_SALIENCE_CLAMP_MIN: f64 = 0.05;
/// Minimum binding strength clamp.
pub const THETA_BINDING_CLAMP_MIN: f64 = 0.1;
/// Maximum binding strength clamp.
pub const THETA_BINDING_CLAMP_MAX: f64 = 0.9;
/// Binding strength threshold for temporal binding boost.
pub const THETA_BINDING_BOOST_THRESHOLD: f64 = 0.25;
...
pub const EQ_V2_WORKSPACE_CONFIDENCE_BOOST: f64 = 0.015;
...
pub const EQ_V2_RECURSION_LR_SCALE: f64 = 1.05;
...
pub const EQ_V2_INTEGRATION_CONFIDENCE_BOOST: f64 = 0.02;
...
pub const EQ_V2_KNOWLEDGE_EXPLORATION_BOOST: f64 = 0.04;
...
pub const AFFECT_AROUSAL_HIGH_THRESHOLD: f64 = 0.6;

/// LR scale for high arousal (boost learning during salient events).
pub const AFFECT_AROUSAL_HIGH_LR_SCALE: f64 = 1.06;

/// Arousal threshold below which exploration is dampened (low arousal = low drive).
pub const AFFECT_AROUSAL_LOW_THRESHOLD: f64 = 0.2;

/// Exploration dampening for low arousal.
pub const AFFECT_AROUSAL_LOW_EXPLORE_DAMPEN: f64 = 0.97;
...
pub const AFFECT_VALENCE_NEGATIVE_THRESHOLD: f64 = -0.3;

/// Exploration boost for negative valence.
pub const AFFECT_VALENCE_NEGATIVE_EXPLORE_BOOST: f64 = 0.03;
...
pub const AFFECT_VALENCE_POSITIVE_THRESHOLD: f64 = 0.3;

/// Confidence boost for positive valence.
pub const AFFECT_VALENCE_POSITIVE_CONFIDENCE_BOOST: f64 = 0.01;
...
pub const EMBODIED_AGENCY_CAUTION_FLOOR: f64 = 0.7;
...
pub const EPISTEMIC_PHI_LOW_CONFIDENCE_SCALE: f64 = 0.96;
...
pub const EPISTEMIC_PHI_HIGH_CONFIDENCE_SCALE: f64 = 0.008;
...
pub const PHENOMENAL_BINDING_LOW_EXPLORE_BOOST: f64 = 0.015;
...
pub const PHENOMENAL_BINDING_HIGH_LR_DAMPEN: f64 = 0.97;
...
pub const TEMPORAL_COHERENCE_CONFIDENCE_SCALE: f64 = 0.006;
...
pub const TEMPORAL_COHERENCE_LOW_EXPLORE_BOOST: f64 = 0.01;
...
pub const HOLOGRAPHIC_UNITY_LOW_LR_DAMPEN: f64 = 0.93;
...
pub const HOLOGRAPHIC_UNITY_HIGH_CONFIDENCE_SCALE: f64 = 0.005;
...
pub const VALUE_CACHE_HIT_CONFIDENCE_THRESHOLD: f64 = 0.6;

/// Confidence boost scale for high cache hit rate.
pub const VALUE_CACHE_HIT_CONFIDENCE_SCALE: f64 = 0.02;
...
pub const CONSCIOUSNESS_STATE_HIGH_LR_SCALE: f64 = 1.04;
...
pub const CONSCIOUSNESS_STATE_LOW_LR_DAMPEN: f64 = 0.95;
...
pub const LIVING_MIND_VITALITY_CONFIDENCE_BOOST: f64 = 0.008;
...
pub const LIVING_MIND_VITALITY_LOW_LR_DAMPEN: f64 = 0.96;
...
pub const LIVING_MIND_COHERENCE_HIGH_EXPLORE_DAMPEN: f64 = 0.98;
...
pub const LIVING_MIND_COHERENCE_LOW_EXPLORE_BOOST: f64 = 0.012;
...
pub const HIER_LTC_PHI_MIN_THRESHOLD: f64 = 0.1;
...
pub const HIER_LTC_PHI_CONVERGE_THRESHOLD: f64 = 0.2;
...
pub const HIER_LTC_PHI_CONVERGE_BOOST: f64 = 0.05;
...
pub const HIER_LTC_PHI_DIVERGE_PENALTY_SCALE: f64 = 0.015;
...
pub const HOLOGRAPHIC_BINDING_STRONG_LR: f64 = 1.01;
...
pub const HOLOGRAPHIC_BINDING_WEAK_LR: f64 = 0.99;
...
pub const EPISTEMIC_GATE_LOW_THRESHOLD: f64 = 0.3;

/// Confidence penalty when epistemic gate rejects.
pub const EPISTEMIC_GATE_LOW_PENALTY: f64 = 0.03;
...
pub const PRIMITIVE_VALIDATION_NEGATIVE_LR: f64 = 0.98;
...
pub const GRADIENT_STRONG_BOREDOM_REDUCE: f64 = 0.05;
...
pub const GRADIENT_PLATEAU_BOREDOM_INCREMENT: f64 = 0.03;
...
pub const HOLOGRAPHIC_UNITY_LR_BOOST_FACTOR: f64 = 1.02;

/// LR clamp bounds for holographic unity modulation.
pub const HOLOGRAPHIC_UNITY_LR_CLAMP_LOW: f64 = 0.8;
pub const HOLOGRAPHIC_UNITY_LR_CLAMP_HIGH: f64 = 1.2;
...
pub const HOLOGRAPHIC_UNITY_LR_DAMPEN_FACTOR: f64 = 0.98;
...
pub const PIPELINE_CONSCIOUSNESS_EPISTEMIC_NUDGE: f64 = 0.02;
...
pub const EMPATHIC_COMPASSION_LR_SCALE: f64 = 0.02;

/// Empathic LR factor clamp bounds.
pub const EMPATHIC_LR_CLAMP_LOW: f64 = 0.8;
pub const EMPATHIC_LR_CLAMP_HIGH: f64 = 1.2;
...
pub const PFC_WORKING_MEMORY_CAPACITY: f64 = 7.0;
...
pub const META_COGNITIVE_ACCURACY_LR_THRESHOLD: f64 = 0.7;

/// Meta-cognitive LR boost scale — up to 1.15x at accuracy=1.0 (Koriat 2007).
pub const META_COGNITIVE_LR_BOOST_SCALE: f64 = 0.5;
...
pub const BODY_VALENCE_POSITIVE_THRESHOLD: f64 = 0.3;

/// Negative body valence threshold for confidence dampen (Damasio 1999).
pub const BODY_VALENCE_NEGATIVE_THRESHOLD: f64 = -0.3;

/// Positive body valence confidence scale (Damasio 1999).
pub const BODY_VALENCE_CONFIDENCE_POS_SCALE: f64 = 0.02;

/// Negative body valence confidence scale — stronger than positive (Damasio 1999).
pub const BODY_VALENCE_CONFIDENCE_NEG_SCALE: f64 = 0.03;
...
pub const AFFECTIVE_VALENCE_BROADEN_THRESHOLD: f64 = 0.2;

/// Exploration broadening factor from positive affect (Fredrickson 2001).
pub const AFFECTIVE_VALENCE_CURIOSITY_FACTOR: f64 = 1.05;
...
pub const PREDICTIVE_PHI_MAX_MODULATION: f64 = 0.15;

/// Coherence baseline for predictive phi scaling (Friston 2010).
pub const PREDICTIVE_PHI_COHERENCE_BASELINE: f64 = 0.5;

/// Predictive phi LR contribution scale (Friston 2010: ±1.5% max).
pub const PREDICTIVE_PHI_LR_SCALE: f64 = 0.10;
...
pub const ATTENTION_FOCUS_GAIN_THRESHOLD: f64 = 0.3;

/// Attention control signal threshold for negative gain (Baars 1988).
pub const ATTENTION_DEFOCUS_THRESHOLD: f64 = 0.2;

/// Attention gain scaling factor (Baars 1988).
pub const ATTENTION_GAIN_SCALE: f64 = 0.6;

/// Maximum gain from attention control (stability cap).
pub const ATTENTION_MAX_GAIN: f64 = 0.3;

/// Negative gain floor (prevents excessive suppression).
pub const ATTENTION_NEGATIVE_GAIN: f64 = -0.1;

/// Deep focus threshold for focus lock (Baars 1988).
pub const ATTENTION_DEEP_FOCUS_THRESHOLD: f64 = 0.8;

/// Focus lock scale (Baars 1988).
pub const ATTENTION_FOCUS_LOCK_SCALE: f64 = 0.15;

/// Minimum exploration factor during focus lock.
pub const ATTENTION_MIN_EXPLORATION_IN_FOCUS: f64 = 0.7;

/// Novelty push scale when attention is scattered (Baars 1988).
pub const ATTENTION_DEFICIT_NOVELTY_SCALE: f64 = 0.06;

/// Vigilance fatigue threshold (Mackworth 1948 AST).
pub const VIGILANCE_FATIGUE_THRESHOLD: f64 = 0.5;

/// Vigilance fatigue exploration push scale (Mackworth 1948).
pub const VIGILANCE_FATIGUE_EXPLORATION_SCALE: f64 = 0.08;
...
pub const PHI_GATE_SUPPRESS_EXPLORATION: f64 = 0.85;
...
pub const QUANTUM_DECOHERENCE_CONFIDENCE_SCALE: f64 = 0.98;
...
pub const PHENOMENAL_BINDING_LR_BOOST_SCALE: f64 = 0.2;

/// Boredom scale when consciousness is fragmented
pub const PHENOMENAL_FRAGMENTATION_BOREDOM_SCALE: f64 = 0.8;

/// Exploration scale when consciousness is fragmented
pub const PHENOMENAL_FRAGMENTATION_EXPLORATION_SCALE: f64 = 0.7;

// ── Temporal coherence (Varela 1999, Damasio 2010) ──

/// Confidence scale applied on temporal discontinuity
pub const TEMPORAL_DISCONTINUITY_CONFIDENCE_SCALE: f64 = 0.8;
...
pub const TEMPORAL_COHERENCE_THRESHOLD_BOOST: f64 = 1.01;
...
pub const TEMPORAL_DISCONTINUITY_PERSISTENT_LR_BOOST: f64 = 1.5;

// ── Thermodynamic responses (Friston 2010, Ulanowicz 2009) ──

/// Exploration boost during critical phase (edge of chaos)
pub const THERMODYNAMIC_STRESS_EXPLORATION_BOOST: f64 = 1.15;

/// Exploration scale during chaotic phase
pub const THERMODYNAMIC_RECOVERY_EXPLORATION_SCALE: f64 = 0.5;
...
pub const SIGMA_CONFIDENCE_SCALE: f64 = 0.5;
...
pub const STRUCTURAL_EXPLORATION_NUDGE: f64 = 0.01;
...
pub const STRUCTURAL_CONFIDENCE_NUDGE: f64 = 0.01;
...
pub const STRUCTURAL_BOTTLENECK_LR_BOOST: f64 = 1.02;
...
pub const PHI_VALIDATION_BOOST_SCALE: f64 = 0.1;

/// Scale for validation-based confidence attenuation.
pub const PHI_VALIDATION_ATTENUATION_SCALE: f64 = 0.05;
...
pub const EQ_V2_EXPLORATION_NUDGE: f64 = 0.02;
...
pub const RESONANCE_ATTENTION_SCALE: f64 = 0.1;
...
pub const WM_BINDING_MIN_SENSITIVITY: f64 = 0.8;
...
pub const RESONATOR_MATCH_BOOST: f64 = 0.2;
...
pub const USER_STATE_ERROR_THRESHOLD: f64 = 0.8;
...
pub const MATH_REGRESSION_WEAK_FIT_THRESHOLD: f64 = 0.5;
