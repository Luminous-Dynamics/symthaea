...
pub const NEUROMOD_SEROTONIN_CRASH_PRODUCTION: f64 = -0.1;
...
pub const NEUROMOD_GABA_INHIBITION_THRESHOLD: f64 = 0.95;
...
pub const NEUROMOD_SEIZURE_EXPLORATION_FREEZE: f64 = 0.1;
...
pub const HOMEOSTASIS_RECALIBRATE_HIGH: f64 = 1.15;

/// Homeostasis efficiency undershoot threshold → boost neuromods.
pub const HOMEOSTASIS_RECALIBRATE_LOW: f64 = 0.85;

/// Neuromodulator baseline adjustment step per cycle of mistuning.
pub const HOMEOSTASIS_NEUROMOD_STEP: f64 = 0.01;
...
pub const NEUROMOD_EMA_ALPHA: f64 = 0.05;
