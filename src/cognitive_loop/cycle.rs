...
impl CognitiveLoopService {
    ...
    pub fn cycle(&mut self, input: &str) -> CycleResult {
        ...
        let init = self.run_cycle_init(&mut module_timings);
        ...
        let effective_threshold = self.config.learning_threshold
            ...
            * confidence_scale
            * exploration_scale;
        // ── Urgency computation: hysteresis, error patterns, mode transitions ──
        ...
        // ── End-of-cycle stats: neuromod telemetry, resonator stats, feedback trace ──
