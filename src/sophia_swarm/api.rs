// sophia_swarm/api.rs - Core types and traits for Sophia ↔ Mycelix integration
//
// This module defines the interface between Sophia's Holographic Liquid Brain
...
// ============================================================================
// Sophia Pattern Types
// ============================================================================

/// A learned pattern from Sophia's experience
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SophiaPattern {
    pub pattern_id: Uuid,
...
pub trait DkgClient: Send + Sync {
    ...
    async fn publish_pattern_claim(&self, pattern: SophiaPattern) -> Result<ClaimId, SwarmError>;
...
pub trait MfdiClient: Send + Sync {
    /// Ensure Sophia instance is registered as Instrumental Actor
...
/// Combined Sophia ↔ Mycelix swarm client
pub trait SophiaSwarmClient: DkgClient + MatlClient + MfdiClient + Send + Sync {}

// Auto-implement SophiaSwarmClient for any type implementing all three traits
impl<T> SophiaSwarmClient for T where T: DkgClient + MatlClient + MfdiClient + Send + Sync {}
    ...
    pub fn to_epistemic_claim(&self, did: &Did) -> EpistemicClaim {
        ...
        EpistemicClaim {
            ...
            verifiability: Verifiability {
                method: "SophiaLocalValidation".to_string(),
