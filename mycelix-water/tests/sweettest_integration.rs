//! # Mycelix Water - Sweettest Integration Tests
//!
...
mod flow_tests {
    ...
    async fn test_allocate_shares() {
        ...
        let allocations: Vec<Record> = conductor
            .call(&steward_cell.zome("flow"), "get_source_allocations", source_hash)
            .await;
...
mod integration_tests {
    ...
    async fn test_complete_water_management_flow() {
        ...
        println!("  3. User initial balance: {} liters", balance.balance_liters);
        ...
        let updated: Record = conductor
            .call(&steward_cell.zome("flow"), "update_source_status", update_input)
            .await;
