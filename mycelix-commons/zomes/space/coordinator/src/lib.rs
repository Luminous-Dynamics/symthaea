...
pub fn create_space(input: CreateSpaceInput) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_basic(), "create_space")?;
    let now = sys_time()?;
...
pub fn invite_member(input: InviteMemberInput) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_basic(), "invite_member")?;
    let now = sys_time()?;
    let caller = agent_info()?.agent_initial_pubkey;
...
pub fn grant_access(input: GrantAccessInput) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_proposal(), "grant_access")?;
    let now = sys_time()?;
    let caller = agent_info()?.agent_initial_pubkey;
...
pub fn revoke_access(input: RevokeAccessInput) -> ExternResult<bool> {
    require_consciousness(&civic_requirement_proposal(), "revoke_access")?;
    let caller = agent_info()?.agent_initial_pubkey;
...
pub fn approve_invitation(input: ApproveInvitationInput) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_proposal(), "approve_invitation")?;
    let now = sys_time()?;
    let caller = agent_info()?.agent_initial_pubkey;
...
pub fn reject_invitation(invitation_hash: ActionHash) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_proposal(), "reject_invitation")?;
    let caller = agent_info()?.agent_initial_pubkey;
...
pub fn book_resource(input: BookResourceInput) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_basic(), "book_resource")?;
    let now = sys_time()?;
    let caller = agent_info()?.agent_initial_pubkey;
...
pub fn cancel_booking(booking_hash: ActionHash) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_proposal(), "cancel_booking")?;
    let caller = agent_info()?.agent_initial_pubkey;
...
pub fn create_schedule(input: CreateScheduleInput) -> ExternResult<Record> {
    require_consciousness(&civic_requirement_basic(), "create_schedule")?;
    let now = sys_time()?;
    let caller = agent_info()?.agent_initial_pubkey;
