\chapter{Chapter 16: The Freedom to Walk Away}\label{chapter-16-the-freedom-to-walk-away}

\emph{In which the one finding that survives the revision tells us something about choice.}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{What Survived}\label{what-survived}
...
Under the original thesis, this was about cooperation and commitment. Under the revised thesis, it is about something simpler and more fundamental: \textbf{the freedom to leave a resource point}.

\section{By-Product Mutualism Requires Co-Location}\label{by-product-mutualism-requires-co-location}
...
\section{The U-Curve Is About Resource Access, Not Commitment}\label{the-u-curve-is-about-resource-access-not-commitment}
...
\section{The Bowling Alone Reinterpretation}\label{the-bowling-alone-reinterpretation}
...
\textbf{Social structure persists exactly as long as agents co-locate at shared resources. It collapses exactly when agents gain the freedom --- and exercise the choice --- to leave.}
