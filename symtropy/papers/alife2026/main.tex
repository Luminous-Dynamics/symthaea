...
\textbf{Finding 1:} The FEP gradient is the clustering mechanism (15.1$\to$1.8). Epistemic offloading is the survival mechanism (72\%$\to$45\% collapse). Neither alone is sufficient.
...
\textbf{Finding 8: Consciousness bends space.} A test body launched past a stationary consciousness source ($\Phi = 0.8$) deflects proportionally to curvature scale (Table~\ref{tab:curvature}). At $\kappa = 0.05$, deflection is 12.4 units (62\% of closest approach). Mann-Whitney $U = 0.0$, $p = 0.009$, Cohen's $d = -35.5$.
