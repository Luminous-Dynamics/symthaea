...
\begin{enumerate}[label=(\roman*)]
  \item Mechanics that implement well-established physical or
    mathematical laws and can be validated against nature;
  \item Mechanics that draw loose analogy from real systems but
    do not faithfully implement their equations; and
  \item Mechanics that have no published precedent and are
