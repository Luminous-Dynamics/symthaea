...
pub fn all_elements() -> Vec<Element> {
    vec![
        // Period 1
        Element::new(1,  "H",  "Hydrogen",      1.008,    2.20, 1, 1,  Block::S, 1312.0,  72.8,  0.0,     14.01,  20.28),
        Element::new(2,  "He", "Helium",         4.0026,   0.00, 1, 18, Block::S, 2372.3,   0.0,  0.0,      0.95,   4.22),
        // Period 2
        Element::new(3,  "Li", "Lithium",        6.941,    0.98, 2, 1,  Block::S,  520.2,  59.6,  0.534,  453.65, 1615.0),
        Element::new(4,  "Be", "Beryllium",      9.0122,   1.57, 2, 2,  Block::S,  899.5,   0.0,  1.848, 1560.0,  2742.0),
        Element::new(5,  "B",  "Boron",         10.811,    2.04, 2, 13, Block::P,  800.6,  26.7,  2.370, 2349.0,  4200.0),
        Element::new(6,  "C",  "Carbon",        12.011,    2.55, 2, 14, Block::P, 1086.5, 153.9,  2.267, 3800.0,  5100.0),
        Element::new(7,  "N",  "Nitrogen",      14.007,    3.04, 2, 15, Block::P, 1402.3,   7.0,  0.0,     63.15,  77.36),
        Element::new(8,  "O",  "Oxygen",        15.999,    3.44, 2, 16, Block::P, 1313.9, 141.0,  0.0,     54.36,  90.20),
        Element::new(9,  "F",  "Fluorine",      18.998,    3.98, 2, 17, Block::P, 1681.0, 328.0,  0.0,     53.53,  85.03),
        Element::new(10, "Ne", "Neon",          20.180,    0.00, 2, 18, Block::P, 2080.7,   0.0,  0.0,     24.56,  27.07),
        // Period 3
        Element::new(11, "Na", "Sodium",        22.990,    0.93, 3, 1,  Block::S,  495.8,  52.8,  0.971,  370.87, 1156.0),
        Element::new(12, "Mg", "Magnesium",     24.305,    1.31, 3, 2,  Block::S,  737.7,   0.0,  1.738,  923.0,  1363.0),
        Element::new(13, "Al", "Aluminium",     26.982,    1.61, 3, 13, Block::P,  577.5,  42.5,  2.700,  933.47, 2792.0),
        Element::new(14, "Si", "Silicon",       28.086,    1.90, 3, 14, Block::P,  786.5, 133.6,  2.329, 1687.0,  3538.0),
        Element::new(15, "P",  "Phosphorus",    30.974,    2.19, 3, 15, Block::P, 1011.8,  72.0,  1.823,  317.30,  550.0),
        Element::new(16, "S",  "Sulfur",        32.06,     2.58, 3, 16, Block::P, 1000.0, 200.4,  2.067,  388.36,  717.87),
        Element::new(17, "Cl", "Chlorine",      35.45,     3.16, 3, 17, Block::P, 1251.2, 348.6,  0.0,    171.65,  239.11),
        Element::new(18, "Ar", "Argon",         39.948,    0.00, 3, 18, Block::P, 1520.6,   0.0,  0.0,     83.80,  87.30),
        // Period 4
        Element::new(19, "K",  "Potassium",     39.098,    0.82, 4, 1,  Block::S,  418.8,  48.4,  0.862,  336.53, 1032.0),
        Element::new(20, "Ca", "Calcium",       40.078,    1.00, 4, 2,  Block::S,  589.8,   2.4,  1.550, 1115.0,  1757.0),
        Element::new(21, "Sc", "Scandium",      44.956,    1.36, 4, 3,  Block::D,  633.1,  18.1,  2.985, 1814.0,  3109.0),
        Element::new(22, "Ti", "Titanium",      47.867,    1.54, 4, 4,  Block::D,  658.8,   7.6,  4.507, 1941.0,  3560.0),
        Element::new(23, "V",  "Vanadium",      50.942,    1.63, 4, 5,  Block::D,  650.9,  50.6,  6.110, 2183.0,  3680.0),
        Element::new(24, "Cr", "Chromium",      51.996,    1.66, 4, 6,  Block::D,  652.9,  64.3,  7.150, 2180.0,  2944.0),
        Element::new(25, "Mn", "Manganese",     54.938,    1.55, 4, 7,  Block::D,  717.3,   0.0,  7.440, 1519.0,  2334.0),
        Element::new(26, "Fe", "Iron",          55.845,    1.83, 4, 8,  Block::D,  762.5,  15.7,  7.874, 1811.0,  3134.0),
        Element::new(27, "Co", "Cobalt",        58.933,    1.88, 4, 9,  Block::D,  760.4,  63.7,  8.900, 1768.0,  3200.0),
        Element::new(28, "Ni", "Nickel",        58.693,    1.91, 4, 10, Block::D,  737.1, 112.0,  8.908, 1728.0,  3186.0),
        Element::new(29, "Cu", "Copper",        63.546,    1.90, 4, 11, Block::D,  745.5, 118.4,  8.960, 1357.77, 2835.0),
        Element::new(30, "Zn", "Zinc",          65.38,     1.65, 4, 12, Block::D,  906.4,   0.0,  7.133,  692.68, 1180.0),
        Element::new(31, "Ga", "Gallium",       69.723,    1.81, 4, 13, Block::P,  578.8,  28.9,  5.904,  302.91, 2477.0),
        Element::new(32, "Ge", "Germanium",     72.630,    2.01, 4, 14, Block::P,  762.2, 119.0,  5.323, 1211.40, 3106.0),
        Element::new(33, "As", "Arsenic",       74.922,    2.18, 4, 15, Block::P,  947.0,  78.0,  5.727, 1090.0,   887.0),
        Element::new(34, "Se", "Selenium",      78.971,    2.55, 4, 16, Block::P,  941.0, 195.0,  4.809,  494.0,   958.0),
        Element::new(35, "Br", "Bromine",       79.904,    2.96, 4, 17, Block::P, 1139.9, 324.6,  3.103,  265.85,  332.0),
        Element::new(36, "Kr", "Krypton",       83.798,    3.00, 4, 18, Block::P, 1350.8,   0.0,  0.0,    115.79,  119.93),
        // Period 5
        Element::new(37, "Rb", "Rubidium",      85.468,    0.82, 5, 1,  Block::S,  403.0,  46.9,  1.532,  312.46,  961.0),
        Element::new(38, "Sr", "Strontium",     87.62,     0.95, 5, 2,  Block::S,  549.5,   5.0,  2.640, 1050.0,  1655.0),
        Element::new(39, "Y",  "Yttrium",       88.906,    1.22, 5, 3,  Block::D,  600.0,  29.6,  4.472, 1799.0,  3609.0),
        Element::new(40, "Zr", "Zirconium",     91.224,    1.33, 5, 4,  Block::D,  640.1,  41.1,  6.511, 2128.0,  4682.0),
        Element::new(41, "Nb", "Niobium",       92.906,    1.60, 5, 5,  Block::D,  652.1,  86.1,  8.570, 2750.0,  5017.0),
        Element::new(42, "Mo", "Molybdenum",    95.96,     2.16, 5, 6,  Block::D,  684.3,  71.9, 10.220, 2896.0,  4912.0),
        Element::new(43, "Tc", "Technetium",    98.0,      1.90, 5, 7,  Block::D,  702.0,  53.0, 11.000, 2430.0,  4538.0),
        Element::new(44, "Ru", "Ruthenium",    101.07,     2.20, 5, 8,  Block::D,  710.2, 101.3, 12.370, 2607.0,  4423.0),
        Element::new(45, "Rh", "Rhodium",      102.906,    2.28, 5, 9,  Block::D,  719.7, 109.7, 12.450, 2237.0,  3968.0),
        Element::new(46, "Pd", "Palladium",    106.42,     2.20, 5, 10, Block::D,  804.4,  53.7, 12.023, 1828.05, 3236.0),
        Element::new(47, "Ag", "Silver",       107.868,    1.93, 5, 11, Block::D,  731.0, 125.6, 10.490, 1234.93, 2435.0),
        Element::new(48, "Cd", "Cadmium",      112.411,    1.69, 5, 12, Block::D,  867.8,   0.0,  8.650,  594.22, 1040.0),
        Element::new(49, "In", "Indium",       114.818,    1.78, 5, 13, Block::P,  558.3,  28.9,  7.310,  429.75, 2345.0),
        Element::new(50, "Sn", "Tin",          118.710,    1.96, 5, 14, Block::P,  708.6, 107.3,  7.287,  505.08, 2875.0),
        Element::new(51, "Sb", "Antimony",     121.760,    2.05, 5, 15, Block::P,  834.0, 103.2,  6.685,  903.78, 1860.0),
        Element::new(52, "Te", "Tellurium",    127.60,     2.10, 5, 16, Block::P,  869.3, 190.2,  6.232,  722.66, 1261.0),
        Element::new(53, "I",  "Iodine",       126.904,    2.66, 5, 17, Block::P, 1008.4, 295.2,  4.933,  386.85,  457.4),
        Element::new(54, "Xe", "Xenon",        131.293,    2.60, 5, 18, Block::P, 1170.4,   0.0,  0.0,    161.40,  165.03),
        // Period 6
        Element::new(55, "Cs", "Caesium",      132.905,    0.79, 6, 1,  Block::S,  375.7,  45.5,  1.873,  301.59,  944.0),
        Element::new(56, "Ba", "Barium",       137.327,    0.89, 6, 2,  Block::S,  502.9,  13.9,  3.510, 1000.0,  2143.0),
        // Lanthanides (period 6, group 0 = f-block)
        Element::new(57, "La", "Lanthanum",    138.905,    1.10, 6, 0,  Block::F,  538.1,  48.3,  6.162, 1193.0,  3737.0),
        Element::new(58, "Ce", "Cerium",       140.116,    1.12, 6, 0,  Block::F,  534.4,  50.0,  6.770, 1068.0,  3716.0),
        Element::new(59, "Pr", "Praseodymium", 140.908,    1.13, 6, 0,  Block::F,  527.0,  50.0,  6.773, 1208.0,  3793.0),
        Element::new(60, "Nd", "Neodymium",    144.242,    1.14, 6, 0,  Block::F,  533.1,  50.0,  7.007, 1297.0,  3347.0),
        Element::new(61, "Pm", "Promethium",   145.0,      1.13, 6, 0,  Block::F,  540.0,  50.0,  7.260, 1315.0,  3273.0),
        Element::new(62, "Sm", "Samarium",     150.36,     1.17, 6, 0,  Block::F,  544.5,  50.0,  7.520, 1345.0,  2067.0),
        Element::new(63, "Eu", "Europium",     151.964,    1.20, 6, 0,  Block::F,  547.1,  50.0,  5.244, 1099.0,  1802.0),
        Element::new(64, "Gd", "Gadolinium",   157.25,     1.20, 6, 0,  Block::F,  593.4,  50.0,  7.895, 1585.0,  3546.0),
        Element::new(65, "Tb", "Terbium",      158.925,    1.10, 6, 0,  Block::F,  565.8,  50.0,  8.229, 1629.0,  3503.0),
        Element::new(66, "Dy", "Dysprosium",   162.500,    1.22, 6, 0,  Block::F,  573.0,  50.0,  8.550, 1680.0,  2840.0),
        Element::new(67, "Ho", "Holmium",      164.930,    1.23, 6, 0,  Block::F,  581.0,  50.0,  8.795, 1734.0,  2993.0),
        Element::new(68, "Er", "Erbium",       167.259,    1.24, 6, 0,  Block::F,  589.3,  50.0,  9.066, 1802.0,  3141.0),
        Element::new(69, "Tm", "Thulium",      168.934,    1.25, 6, 0,  Block::F,  596.7,  50.0,  9.321, 1818.0,  2223.0),
        Element::new(70, "Yb", "Ytterbium",    173.045,    1.10, 6, 0,  Block::F,  603.4,  50.0,  6.965, 1092.0,  1469.0),
        Element::new(71, "Lu", "Lutetium",     174.967,    1.27, 6, 3,  Block::D,  523.5,  50.0,  9.841, 1925.0,  3675.0),
        // d-block period 6
        Element::new(72, "Hf", "Hafnium",      178.49,     1.30, 6, 4,  Block::D,  658.5,   0.0, 13.310, 2506.0,  4876.0),
        Element::new(73, "Ta", "Tantalum",     180.948,    1.50, 6, 5,  Block::D,  728.4,  31.0, 16.650, 3290.0,  5731.0),
        Element::new(74, "W",  "Tungsten",     183.84,     2.36, 6, 6,  Block::D,  758.8,  78.6, 19.250, 3695.0,  5828.0),
        Element::new(75, "Re", "Rhenium",      186.207,    1.90, 6, 7,  Block::D,  755.8,   5.8, 21.020, 3459.0,  5869.0),
        Element::new(76, "Os", "Osmium",       190.23,     2.20, 6, 8,  Block::D,  840.0, 106.1, 22.590, 3306.0,  5285.0),
        Element::new(77, "Ir", "Iridium",      192.217,    2.20, 6, 9,  Block::D,  880.0, 151.0, 22.560, 2719.0,  4701.0),
        Element::new(78, "Pt", "Platinum",     195.084,    2.28, 6, 10, Block::D,  870.4, 205.3, 21.450, 2041.4,  4098.0),
        Element::new(79, "Au", "Gold",         196.967,    2.54, 6, 11, Block::D,  890.1, 222.8, 19.300, 1337.33, 3129.0),
        Element::new(80, "Hg", "Mercury",      200.592,    2.00, 6, 12, Block::D, 1007.1,   0.0, 13.534,  234.43,  629.88),
        Element::new(81, "Tl", "Thallium",     204.38,     1.62, 6, 13, Block::P,  589.4,  19.2, 11.850,  577.0,  1746.0),
        Element::new(82, "Pb", "Lead",         207.2,      2.33, 6, 14, Block::P,  715.6,  35.1, 11.340,  600.61, 2022.0),
        Element::new(83, "Bi", "Bismuth",      208.980,    2.02, 6, 15, Block::P,  703.2,  91.2,  9.780,  544.55, 1837.0),
        Element::new(84, "Po", "Polonium",     209.0,      2.00, 6, 16, Block::P,  812.1, 136.0,  9.196,  527.0,  1235.0),
        Element::new(85, "At", "Astatine",     210.0,      2.20, 6, 17, Block::P,  899.0, 270.0,  0.0,    575.0,   610.0),
        Element::new(86, "Rn", "Radon",        222.0,      0.00, 6, 18, Block::P, 1037.0,   0.0,  0.0,    202.0,   211.3),
        // Period 7
        Element::new(87, "Fr", "Francium",     223.0,      0.70, 7, 1,  Block::S,  380.0,  46.9,  1.870,  300.0,   950.0),
        Element::new(88, "Ra", "Radium",       226.0,      0.90, 7, 2,  Block::S,  509.3,   9.6,  5.500,  973.0,  2010.0),
        // Actinides (period 7, group 0)
        Element::new(89, "Ac", "Actinium",     227.0,      1.10, 7, 0,  Block::F,  499.0,  33.8, 10.070, 1323.0,  3471.0),
        Element::new(90, "Th", "Thorium",      232.038,    1.30, 7, 0,  Block::F,  587.0,  112.0, 11.720, 2023.0,  5061.0),
        Element::new(91, "Pa", "Protactinium", 231.036,    1.50, 7, 0,  Block::F,  568.0,   53.0, 15.370, 1845.0,  4300.0),
        Element::new(92, "U",  "Uranium",      238.029,    1.38, 7, 0,  Block::F,  597.6,   51.0, 18.950, 1408.0,  4404.0),
        Element::new(93, "Np", "Neptunium",    237.0,      1.36, 7, 0,  Block::F,  604.5,   45.9, 20.450, 912.0,   4175.0),
        Element::new(94, "Pu", "Plutonium",    244.0,      1.28, 7, 0,  Block::F,  584.7,   -48.0, 19.816, 912.5,  3505.0),
        Element::new(95, "Am", "Americium",    243.0,      1.30, 7, 0,  Block::F,  578.0,    9.0, 13.670, 1449.0,  2880.0),
        Element::new(96, "Cm", "Curium",       247.0,      1.30, 7, 0,  Block::F,  581.0,   27.7, 13.510, 1613.0,  3383.0),
        Element::new(97, "Bk", "Berkelium",    247.0,      1.30, 7, 0,  Block::F,  601.0,   27.7, 14.780, 1259.0,  2900.0),
        Element::new(98, "Cf", "Californium",  251.0,      1.30, 7, 0,  Block::F,  608.0,   27.7, 15.100, 1173.0,  1743.0),
        Element::new(99, "Es", "Einsteinium",  252.0,      1.30, 7, 0,  Block::F,  619.0,   27.7,  8.840, 1133.0,  1269.0),
        Element::new(100,"Fm", "Fermium",      257.0,      1.30, 7, 0,  Block::F,  627.0,   27.7,  0.0,   1800.0,  0.0  ),
        Element::new(101,"Md", "Mendelevium",  258.0,      1.30, 7, 0,  Block::F,  635.0,   27.7,  0.0,   1100.0,  0.0  ),
        Element::new(102,"No", "Nobelium",     259.0,      1.30, 7, 0,  Block::F,  642.0,   27.7,  0.0,   1100.0,  0.0  ),
        Element::new(103,"Lr", "Lawrencium",   266.0,      1.30, 7, 3,  Block::D,  470.0,   27.7,  0.0,   1900.0,  0.0  ),
        // d-block period 7
        Element::new(104,"Rf", "Rutherfordium",267.0,      0.00, 7, 4,  Block::D,  580.0,   0.0,  23.20, 2400.0,  5800.0),
        Element::new(105,"Db", "Dubnium",      268.0,      0.00, 7, 5,  Block::D,  665.0,   0.0,  29.30, 0.0,     0.0  ),
        Element::new(106,"Sg", "Seaborgium",   271.0,      0.00, 7, 6,  Block::D,  757.0,   0.0,  35.00, 0.0,     0.0  ),
        Element::new(107,"Bh", "Bohrium",      272.0,      0.00, 7, 7,  Block::D,  742.0,   0.0,  37.10, 0.0,     0.0  ),
        Element::new(108,"Hs", "Hassium",      277.0,      0.00, 7, 8,  Block::D,  730.0,   0.0,  40.70, 0.0,     0.0  ),
        Element::new(109,"Mt", "Meitnerium",   278.0,      0.00, 7, 9,  Block::D,  800.0,   0.0,  37.40, 0.0,     0.0  ),
        Element::new(110,"Ds", "Darmstadtium", 281.0,      0.00, 7, 10, Block::D,  955.0,   0.0,  34.80, 0.0,     0.0  ),
        Element::new(111,"Rg", "Roentgenium",  282.0,      0.00, 7, 11, Block::D, 1022.7,   0.0,  28.70, 0.0,     0.0  ),
        Element::new(112,"Cn", "Copernicium",  285.0,      0.00, 7, 12, Block::D, 1155.0,   0.0,  23.70,  283.0,   340.0),
        Element::new(113,"Nh", "Nihonium",     286.0,      0.00, 7, 13, Block::P,  704.0,   0.0,  16.00,  700.0,  1430.0),
        Element::new(114,"Fl", "Flerovium",    289.0,      0.00, 7, 14, Block::P,  832.2,   0.0,  14.00,  340.0,   420.0),
        Element::new(115,"Mc", "Moscovium",    290.0,      0.00, 7, 15, Block::P,  538.3,   0.0,  13.50,  670.0,  1400.0),
        Element::new(116,"Lv", "Livermorium",  293.0,      0.00, 7, 16, Block::P,  723.6,   0.0,  12.90,  637.0,  1035.0),
        Element::new(117,"Ts", "Tennessine",   294.0,      0.00, 7, 17, Block::P,  736.0,   0.0,   7.17,  723.0,  883.0 ),
        Element::new(118,"Og", "Oganesson",    294.0,      0.00, 7, 18, Block::P,  860.1,   0.0,   5.00,  258.0,  263.0 ),
    ]
}
...
pub fn balance_equation(
    ...
    for (col, (formula_map, is_product)) in parsed.iter().zip(
        (0..reactants.len()).map(|_| false).chain((0..products.len()).map(|_| true))
    ).enumerate() {
    ...
    fn rat_sub(a: Rat, b: Rat) -> Rat { rat_add(a, (- b.0, b.1)) }
    ...
    fn rat_div(a: Rat, b: Rat) -> Rat { rat_mul(a, (b.1, b.0)) }
    fn rat_is_zero(a: Rat) -> bool { a.0 == 0 }

    // Build rational matrix: n_elem rows, n_species cols
    let mut rmat: Vec<Vec<Rat>> = mat.iter().map(|row| {
        row.iter().map(|&v| rat_from_f64(v)).collect()
    }).collect();
    ...
    let result: Vec<i32> = int_solution.iter().enumerate().map(|(i, &x)| {
        if i < n_react { x as i32 } else { (-x) as i32 }
    }).collect();
...
impl ThermochemicalData {
    const fn new(formula: &'static str, dhf: f64, sf: f64, dgf: f64) -> Self {
        Self { formula, delta_hf_kj_mol: dhf, delta_sf_j_mol_k: sf, delta_gf_kj_mol: dgf }
    }
}
...
pub fn find_thermo<'a>(formula: &str, data: &'a [ThermochemicalData]) -> Option<&'a ThermochemicalData> {
...
pub fn hess_law(
    reaction_formulas: &[(&str, f64)],
    data: &[ThermochemicalData],
) -> f64 {
    reaction_formulas.iter().fold(0.0, |acc, (formula, coeff)| {
        let dhf = find_thermo(formula, data).map(|d| d.delta_hf_kj_mol).unwrap_or(0.0);
        acc + coeff * dhf
    })
}
...
pub fn solve_ice(
    ...
    let keq_expr = |x: f64| -> f64 {
        ...
        if denominator < 1e-300 { return f64::INFINITY; }
    ...
    let x_min_raw = stoich_coeffs.iter().zip(initial_concentrations.iter())
        .filter(|(&c, _)| c < 0)
        .map(|(&c, &conc)| -conc / (c as f64))  // c < 0, so this is positive upper bound
        .fold(f64::INFINITY, f64::min);
    let x_max = if x_min_raw.is_infinite() || x_min_raw < 1e-12 { 1e6 } else { x_min_raw * 0.9999 };

    // For reverse direction
    let x_min = stoich_coeffs.iter().zip(initial_concentrations.iter())
        .filter(|(&c, _)| c > 0)
    ...
    if f(lo) * f(hi) > 0.0 {
        ...
        if !found {
            return Err("Could not bracket equilibrium solution; check Keq and initial conditions".to_string());
        }
    }
    ...
    let equilibrium: Vec<f64> = initial_concentrations.iter().zip(change.iter())
...
pub fn reaction_rate(rate_constant: f64, concentrations: &[f64], orders: &[f64]) -> f64 {
    let product = concentrations.iter().zip(orders.iter())
...
mod tests {
    ...
    fn test_hess_law_methane_combustion() {
        ...
        assert!(approx_eq(dh, -890.3, 5.0), "CH4 combustion ΔH = {dh} kJ/mol");
    }
    ...
    fn test_le_chatelier_add_reactant() {
        assert_eq!(le_chatelier("exothermic", Perturbation::AddReactant), "shifts right");
    }

    #[test]
    fn test_le_chatelier_increase_temp_exothermic() {
        assert_eq!(le_chatelier("exothermic", Perturbation::IncreaseTemp), "shifts left");
    }

    #[test]
    fn test_le_chatelier_increase_temp_endothermic() {
        assert_eq!(le_chatelier("endothermic", Perturbation::IncreaseTemp), "shifts right");
    }
    ...
    fn test_activation_energy_roundtrip() {
        ...
        assert!(approx_eq(ea_calc, ea_true, 1.0), "Ea roundtrip: {ea_calc} vs {ea_true}");
    }
    ...
    fn test_half_life_first_order() {
        ...
        assert!(approx_eq(c_at_half, 0.5, 1e-6), "c at half-life should be 0.5, got {c_at_half}");
    }
