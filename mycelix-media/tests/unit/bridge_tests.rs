...
mod tests {
    ...
    fn test_verification_workflow() {
        ...
        assert!(matches!(event.event_type, TestMediaEventType::ContentVerified));
    }
    ...
    fn test_author_reputation_workflow() {
        ...
        assert!(matches!(event.event_type, TestMediaEventType::AuthorVerified));
    }
    ...
    fn test_content_dispute_event() {
        ...
        assert!(matches!(event.event_type, TestMediaEventType::ContentDisputed));
    }
    ...
    fn test_content_retraction_event() {
        ...
        assert!(matches!(event.event_type, TestMediaEventType::ContentRetracted));
    }
}
