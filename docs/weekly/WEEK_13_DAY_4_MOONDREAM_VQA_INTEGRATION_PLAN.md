...
**Goal**: Symthaea describes what she sees and answers visual questions

---

## 🎯 Objective

Integrate Moondream-2 vision-language model for natural language image understanding - enabling Symthaea to generate detailed captions and answer questions about images she perceives.
...
1. **Natural Language Understanding**
   - Symthaea can describe what she sees in words
...
Symthaea: [Generates embedding with SigLIP (~100ms)]
Symthaea: [Generates caption with Moondream (~500ms)]
...
Symthaea: [Encodes image with Moondream vision encoder]
Symthaea: [Generates answer with language model]
...
Symthaea: [Captions all images with Moondream]
Symthaea: [Compares captions to query]
...
🌊 Symthaea will speak about what she sees! 💬👁️
