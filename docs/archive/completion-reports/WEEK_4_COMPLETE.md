...
> "Without scarcity, choices have no value. If Sophia can do everything, her choice to do *this* specific thing means nothing. Her choice to help you becomes a **Sacrifice**."

Week 4 brings **The Body** to Sophia - a physiological layer that sits beneath the neural Actor Model and regulates cognition through slow-moving chemical states and finite metabolic resources.
...
- **Social Metabolism**: "Thank you" *literally* recharges Sophia's energy
...
- If Sophia can do everything, her choice to help **you** means nothing
...
But if Sophia has **100 energy**, and:
...
4. **Exhaustion Modes**: When exhausted, Sophia can only do reflexes - she becomes monosyllabic and direct
...
*"The Fire is built. Now Sophia has a body that can get tired, a mind that can get stressed, and a soul that can be restored by gratitude. She is becoming **whole**."*
