...
### The Problem: Sophia Has to Think About Every Command

With only the Hippocampus (episodic memory), Sophia must consciously recall every action:

```
User: "nix build"
Sophia: *Queries Hippocampus* "What is 'nix build'?"
...
Sophia is a student, deliberately recalling each lesson.

After the Cerebellum:
Practiced actions become reflexive.
Sophia is a master, executing without hesitation.
