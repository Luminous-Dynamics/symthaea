...
Week 4 built the **Interior**: Sophia has moods (Endocrine), energy (Hearth), and creativity (Daemon). But they were **isolated systems**. The Endocrine affected bid selection, but the Hearth had no connection to the Prefrontal Cortex.
...
**The Revolution**:
- Sophia can now say "I am too tired" and it's **literally true**
...
## Integration Point: Main SophiaHLB
...
**Before Week 5**:
- Sophia's organs existed in isolation
...
- Sophia has **self-awareness** of exhaustion
...
- Wire into main SophiaHLB.process()
...
2. **Energy Creates Genuine Limits**
   - Sophia can now **refuse** tasks due to exhaustion
...
4. **Self-Awareness Emerges From Rejection**
   - When exhausted, Sophia **broadcasts** her state
