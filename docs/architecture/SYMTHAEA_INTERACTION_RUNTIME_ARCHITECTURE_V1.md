...
- consciousness/phenomenology measurements;
- affect;
- attention;
- current cognitive depth/mode;
- thermodynamic/resource state;
- sensor status;
- voice state;
- active task;
- connectivity.
...
- utterance partial/final;
- response started/delta/finished;
- attention shift;
...
Purpose: bounded high-volume streams.

Examples:

- microphone frames;
- video/screen frames;
- high-rate HDC sensory states;
- device telemetry.
...
Purpose: durable or explicitly retained authority/evidence records.
