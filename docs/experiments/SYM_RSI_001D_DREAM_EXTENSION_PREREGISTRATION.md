...
D's frozen v3 action-scoring rule is:

`domain-conditioned action memory; mean predicted task quality across 5 legality-aware deterministic action perturbations - 0.10 × predicted task-regression probability`
