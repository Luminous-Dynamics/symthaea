#!/usr/bin/env python3
"""F0 per-note analysis of 1.5's cover-task renders, same methodology
as the v1 audio2audio comparison."""
import glob
import os
import re
...
def main():
    paths = sorted(glob.glob("/var/lib/symthaea/training-runs/ace-step-1.5/cover_compare_out/*.wav"))
    for path in paths:
