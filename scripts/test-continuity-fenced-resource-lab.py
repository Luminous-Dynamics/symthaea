...
def require_deny(result, code) -> None:
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        stale_after_stop = run("actuate", "--db", db, "--token", p3, "--delta", 1, "--operation-digest", hx(24), expect=2)
        ...
        mark("emergency_stop_dominates", {"stale": stale_after_stop.stderr, "sticky": sticky.stderr})
        ...
        mark("boundary_identity", {"resource_id": rid, "backend_id": bid, "profile_id": pid, "wrong_resource": wrong_resource.stderr})
        ...
        mark("durable_monotonic_fence", {"generation_2": snap2["current_generation"], "generation_3": snap_after_crash["current_generation"], "generation_4": final["current_generation"]})
