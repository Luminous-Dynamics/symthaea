...
def main() -> int:
    ...
    lines = [
        ...
        f"- Avg structured translation validity: {fmt(decoder_agg.get('avg_structured_translation_validity'))}",
        f"- Structured translation grounding rate: {fmt(decoder_agg.get('structured_translation_grounding_rate'))}",
        f"- Structured translation hallucination rate: {fmt(decoder_agg.get('structured_translation_hallucination_rate'))}",
        f"- Avg structured translation semantic drift: {fmt(decoder_agg.get('avg_structured_translation_semantic_drift'))}",
