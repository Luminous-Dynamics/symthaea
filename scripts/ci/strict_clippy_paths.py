...
This keeps focused qualification strict without allowing unrelated dependency or
crate-wide lint debt to impersonate a failure of the evidence surface under test.
Cargo/Clippy compile failures remain authoritative through the caller's exit code.
"""
