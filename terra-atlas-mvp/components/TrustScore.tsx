...
/**
 * Displays trust scores (Phi + Harmony Alignment) for a project.
 * Used on project cards and detail pages in the Trust-Weighted Allocation Network.
 */
  ...
  if (!hasData) {
    return (
      <span className={`inline-flex items-center rounded-full bg-gray-800/60 border border-gray-700/50 ${sizeClasses[size]} ${className}`}>
        <span className="text-gray-500">No trust data</span>
      </span>
    )
  }
