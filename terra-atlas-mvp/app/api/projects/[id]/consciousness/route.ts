...
/**
 * GET /api/projects/:id/consciousness
 *
 * Returns consciousness scores for a project, synced from Symthaea via Holochain.
 * Public endpoint — consciousness scores are part of the project's public profile.
 */
