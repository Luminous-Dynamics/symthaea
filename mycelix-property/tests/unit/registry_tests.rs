...
mod tests {
    ...
    fn test_property_has_unique_id() {
        ...
        assert!(property.id.contains(&property.owner_did.replace("did:", "")));
    }
    ...
    fn test_property_types_supported() {
        ...
        for prop_type in types {
            ...
            assert!(matches!(property.property_type, TestPropertyType::Land |
                TestPropertyType::Building | TestPropertyType::Unit |
                TestPropertyType::Equipment | TestPropertyType::Intellectual |
                TestPropertyType::Digital | TestPropertyType::Other(_)));
        }
    }
    ...
    fn test_title_deed_types_supported() {
        ...
        for deed_type in types {
            ...
            assert!(matches!(deed.deed_type, TestDeedType::Original |
                TestDeedType::Transfer | TestDeedType::Inheritance |
                TestDeedType::CourtOrder | TestDeedType::Fractional));
        }
    }
    ...
    fn test_encumbrance_types_supported() {
        ...
        for enc_type in types {
            ...
            assert!(matches!(enc.encumbrance_type, TestEncumbranceType::Mortgage |
                TestEncumbranceType::Lien | TestEncumbranceType::Easement |
                TestEncumbranceType::Restriction | TestEncumbranceType::Lease));
        }
    }
    ...
    fn test_deed_chain_integrity() {
        ...
        assert_eq!(transfer_deed.previous_deed_id, Some(original_deed.id.clone()));
        assert_eq!(inheritance_deed.previous_deed_id, Some(transfer_deed.id.clone()));
