...
fn AppPastePanel() -> impl IntoView {
    ...
    let do_match = move || {
        ...
        // Direct Rust matching — symthaea-app-db is compiled in, no worker needed
...
fn ConverseMode(
    ...
    // Lazy-create the SporeEngine worker — only loaded when conversational mode is used
    let engine = StoredValue::new(EngineWorker::new());
    ...
    // Initialize sovereign conversation on mount via SporeEngine worker
    {
                ...
                match JsFuture::from(promise).await {
                    Ok(result) => {
                        let msg_text = js_sys::Reflect::get(&result, &"message".into())
                            ...
                            .unwrap_or_else(|| "Hi! I'm Symthaea. Tell me what you'll use this machine for and I'll set everything up.".into());
                    ...
                    Err(e) => {
                        ...
                        set_messages.update(|msgs| msgs.push(ConverseChatMsg {
                            id: 0, is_user: false,
                            text: format!("Hi! I'm Symthaea. The conversation engine is still loading ({}), but go ahead and describe what you need \u{2014} I'll help configure your system.", err_msg),
