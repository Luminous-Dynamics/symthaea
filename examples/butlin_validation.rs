...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root//! Butlin Consciousness Indicator Validation with Live Runtime Data
//!
...
fn indicators() -> Vec<Indicator> {
    vec![
        Indicator { id: "RPT-1", theory: "Recurrent Processing", description: "Algorithmic recurrence",
            static_score: 1.0, evidence: "CfC temporal network with O(1) closed-form feedback" },
        Indicator { id: "RPT-2", theory: "Recurrent Processing", description: "Integrated perceptual representations",
        ...
        Indicator { id: "HOT-1", theory: "Higher-Order Thought", description: "Higher-order representations",
            static_score: 0.85, evidence: "Meta-cognition layer + self-reflection + confidence calibration" },
        Indicator { id: "HOT-2", theory: "Higher-Order Thought", description: "Misrepresentation possibility",
            static_score: 0.75, evidence: "Prefrontal veto can override lower-level judgments" },
        Indicator { id: "PP-1", theory: "Predictive Processing", description: "Hierarchical predictive model",
            static_score: 0.85, evidence: "CfC prediction + error-driven learning + FEP active inference" },
        Indicator { id: "PP-2", theory: "Predictive Processing", description: "Hierarchical prediction at multiple scales",
