...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("[THOUGHT] Throttled Cycle: {:?} (Confidence: {:.4})", duration_throttle, res.confidence);
    ...
    println!("[THOUGHT] Full-Resolution Cycle: {:?} (Confidence: {:.4})", duration_full, res.confidence);
