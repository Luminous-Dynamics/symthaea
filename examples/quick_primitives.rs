...
// Commercial licensing: see COMMERCIAL_LICENSE.md at repository root// Quick test of principled causal primitives (skips slow unified method)
...
fn main() {
    println!("Quick Symthaea Causal Primitives Test\n");
