...
pub enum ModelSpec {
    ...
    /// OCRS detection model for OCR
    OcrsDetection,

    /// OCRS recognition model for OCR
    OcrsRecognition,
}
...
impl ModelSpec {
    ...
    pub fn repo_id(&self) -> &'static str {
        match self {
            ...
            ModelSpec::Kokoro => "hexgrad/Kokoro-82M",
            ModelSpec::OcrsDetection => "robertknight/ocrs-models",
            ModelSpec::OcrsRecognition => "robertknight/ocrs-models",
        }
    }
    ...
    pub fn local_name(&self) -> &'static str {
        match self {
            ...
            ModelSpec::Kokoro => "kokoro-82m",
            ModelSpec::OcrsDetection => "ocrs-detection",
            ModelSpec::OcrsRecognition => "ocrs-recognition",
        }
    }
    ...
    pub fn required_files(&self) -> &'static [&'static str] {
        match self {
            ...
            ModelSpec::Kokoro => &["kokoro-v0_19.onnx", "voices.bin"],
            ModelSpec::OcrsDetection => &["text-detection.rten"],
            ModelSpec::OcrsRecognition => &["text-recognition.rten"],
        }
    }
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ModelSpec::Qwen3Embedding => "Text embeddings (1024D)",
            ModelSpec::SigLIP => "Image embeddings (768D)",
            ModelSpec::Moondream => "Image captioning VLM",
            ModelSpec::BGE => "Text embeddings (768D, legacy)",
            ModelSpec::Kokoro => "Speech synthesis (82M params)",
            ModelSpec::OcrsDetection => "OCR text detection",
            ModelSpec::OcrsRecognition => "OCR text recognition",
        }
    }
    ...
    pub fn size_mb(&self) -> usize {
        match self {
            ModelSpec::Qwen3Embedding => 600,
            ModelSpec::SigLIP => 400,
            ModelSpec::Moondream => 1500,
            ModelSpec::BGE => 420,
            ModelSpec::Kokoro => 160,
            ModelSpec::OcrsDetection => 4,
            ModelSpec::OcrsRecognition => 4,
        }
    }
}
...
impl ModelHub {
    ...
    /// Download all models (useful for pre-caching)
    #[cfg(feature = "vision")]
