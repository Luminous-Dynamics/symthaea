...
fn phases() -> Vec<Phase> {
    vec![
        Phase {
            ...
            consciousness: 0.6, prediction_error: 0.1,
        ...
        Phase {
            ...
            consciousness: 0.8, prediction_error: 0.2,
        ...
        Phase {
            ...
            consciousness: 0.4, prediction_error: 0.1,
        ...
        Phase {
            ...
            consciousness: 0.3, prediction_error: 0.7,
        ...
        Phase {
            ...
            consciousness: 0.9, prediction_error: 0.3,
        ...
        Phase {
            ...
            consciousness: 0.5, prediction_error: 0.0,
...
fn main() {
    ...
    for (i, phase) in all_phases.iter().enumerate() {
        ...
        println!("        V={:+.1} A={:.1} DA={:.1} 5HT={:.1} NE={:.1} Ψ={:.1} PE={:.1}",
            phase.valence, phase.arousal, phase.dopamine, phase.serotonin,
            phase.noradrenaline, phase.consciousness, phase.prediction_error);
    ...
    println!();
    println!("  Done. {} seconds of consciousness-driven audio.", global_t as u32);
    output.stop();
}
