...
mod tests {
        ...
        REQUIRED_QUALIFICATION_PREDECESSOR_ROLES_V1
            ...
            .map(|(index, role)| {
                ...
                QualificationExecutionRecordV1 {
                    ...
                    evidence_artifact_name: format!("{}-qualification-evidence", role.id()),
    ...
    #[test]
    fn zero_run_attempt_fails_closed() {
        let mut records = passed_records();
        records[4].run_attempt = 0;
        let manifest = AuthorityPromotionPrerequisiteManifestV1::from_records(records);
    ...
    #[test]
    fn passed_record_requires_bound_artifact_identity_and_digest() {
