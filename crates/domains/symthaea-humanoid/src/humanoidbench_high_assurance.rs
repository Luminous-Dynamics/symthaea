...
use crate::humanoidbench_evaluation_matrix::{
    ...
    HumanoidBenchMatrixCoverageReceiptV1, HumanoidBenchMatrixCoverageStatusV1,
    assess_humanoidbench_matrix_results_v1,
};
    ...
    fn result(
        ...
        HumanoidBenchMatrixCaseResultV1 {
            ...
            episode: HumanoidBenchEpisodeResultV1 {
                ...
                infrastructure_failure: (!completed).then(|| "runner-lost".into()),
