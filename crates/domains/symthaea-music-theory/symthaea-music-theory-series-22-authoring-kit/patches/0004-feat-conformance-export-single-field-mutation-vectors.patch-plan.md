# Patch 0004: feat: conformance export single field mutation vectors

## Objective

Generate controlled tampering fixtures with recomputed outer hashes and exact expected rejection stages.
