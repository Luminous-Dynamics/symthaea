# Patch 0011: feat: tools export offline independent verification kit

## Objective

Package public contracts, vectors, expected policies, verifier requests, and limitations without private records.
