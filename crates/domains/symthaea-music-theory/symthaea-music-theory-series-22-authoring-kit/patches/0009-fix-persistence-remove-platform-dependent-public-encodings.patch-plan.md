# Patch 0009: fix: persistence remove platform dependent public encodings

## Objective

Migrate any remaining usize/isize or debug-derived persistence and provide strict compatibility migration.
