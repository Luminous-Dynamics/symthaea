# Patch 0007: feat: publication verify resumption with external adapters

## Objective

Reuse no-shell JSON-over-stdin verifiers while requiring caller-supplied expected policy equality.
