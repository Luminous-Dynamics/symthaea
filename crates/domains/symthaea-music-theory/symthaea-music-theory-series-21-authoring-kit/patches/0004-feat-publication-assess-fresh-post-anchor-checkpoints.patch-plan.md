# Patch 0004: feat: publication assess fresh post anchor checkpoints

## Objective

Add deterministic readiness checks for strictly post-anchor checkpoints and exact recovery-branch lineage.
