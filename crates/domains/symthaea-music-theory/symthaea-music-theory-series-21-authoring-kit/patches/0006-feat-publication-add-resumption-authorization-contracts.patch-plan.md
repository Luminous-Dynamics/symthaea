# Patch 0006: feat: publication add resumption authorization contracts

## Objective

Add expected-policy-bound canonical payloads, signed envelopes, thresholds, and distinct-signer accounting.
