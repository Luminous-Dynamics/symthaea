# Patch 0015: test: publication reject resumption boundary attacks

## Objective

Add negative fixtures for stale witnesses, policy substitution, old delegation reuse, cross-segment mutation, and anchor substitution.
