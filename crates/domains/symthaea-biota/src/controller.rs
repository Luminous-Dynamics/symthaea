...
use crate::types::{BiotaCommand, BiotaConfig, NUM_ACTUATORS};
...
impl BiotaController {
    pub fn new(g: &GenesisSeed, c: &BiotaConfig) -> Self {
        ...
        let wh = ContinuousHV::from_genesis(g, "biota::out_w", NUM_ACTUATORS * HDC_DIM);
    ...
    pub fn forward(&mut self, hv: &ContinuousHV, dt: f32) -> BiotaCommand {
    ...
    /// makes `BiotaTrainer` actually train (Tier 2 of
    /// SYMTHAEA_UNAUDITED_PLATFORMS_REVIEW_2026-07-07.md).
    pub fn train_step(&mut self, target: &BiotaCommand) -> f32 {
...
mod tests {
    ...
    #[test]
    fn test_fwd() {
        let mut c = BiotaController::new(&GenesisSeed::from_phrase("t"), &BiotaConfig::default());
