...
use c0_enumeration::{
    ...
    C0SelectionPolicyV1, select_c0_candidate,
};
use c0_enumeration_guard::enumerate_c0_domain_bounded;
...
#[test]
fn synthetic_c0_pipeline_selects_compiles_screens_and_checks_robustness() {
    ...
    let robustness = assess_c0_tolerance_robustness(
        DesignLengthUm::from_micrometres(20_000),
        DesignLengthUm::from_micrometres(6_000),
        C0DimensionBoxV1 {
            width_lower: DesignLengthUm::from_micrometres(15_950),
            width_upper: DesignLengthUm::from_micrometres(16_050),
            height_lower: DesignLengthUm::from_micrometres(7_150),
            height_upper: DesignLengthUm::from_micrometres(7_250),
        },
