...
#[path = "perceptual_stimulus_qualification.rs"]
pub mod perceptual_stimulus_qualification;
#[path = "perceptual_stimulus_qualification_receipt.rs"]
pub mod perceptual_stimulus_qualification_receipt;
