...
use crate::types::{ClimeCommand, ClimeConfig, NUM_ACTUATORS};
...
impl ClimeController {
    pub fn new(g: &GenesisSeed, c: &ClimeConfig) -> Self {
        ...
        let wh = ContinuousHV::from_genesis(g, "clime::out_w", NUM_ACTUATORS * HDC_DIM);
    ...
    pub fn forward(&mut self, hv: &ContinuousHV, dt: f32) -> ClimeCommand {
    ...
    /// makes `ClimeTrainer` actually train (Tier 2 of
    /// SYMTHAEA_UNAUDITED_PLATFORMS_REVIEW_2026-07-07.md).
    pub fn train_step(&mut self, target: &ClimeCommand) -> f32 {
...
mod tests {
    ...
    #[test]
    fn test_fwd() {
        let mut c = ClimeController::new(&GenesisSeed::from_phrase("t"), &ClimeConfig::default());
