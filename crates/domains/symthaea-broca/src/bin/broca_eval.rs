...
fn build_quality_metadata(opts: &EvalOpts) -> evaluation::QualityRunMetadata {
    evaluation::QualityRunMetadata {
        ...
        train_thought_logit_prefit_epochs: parse_env_usize(
            "BROCA_TRAIN_THOUGHT_LOGIT_PREFIT_EPOCHS",
        ),
        train_thought_logit_prefit_weight: parse_env_f32("BROCA_TRAIN_THOUGHT_LOGIT_PREFIT_WEIGHT"),
        train_thought_logit_prefit_lr_scale: parse_env_f32(
            "BROCA_TRAIN_THOUGHT_LOGIT_PREFIT_LR_SCALE",
        ),
        ...
        train_common_token_prior: parse_env_f32("BROCA_TRAIN_COMMON_TOKEN_PRIOR"),
        train_common_token_slack: parse_env_f32("BROCA_TRAIN_COMMON_TOKEN_SLACK"),
        train_common_token_margin: parse_env_f32("BROCA_TRAIN_COMMON_TOKEN_MARGIN"),
