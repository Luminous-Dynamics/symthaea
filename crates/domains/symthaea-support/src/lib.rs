...
pub mod legacy_qualification_profile_v2;
...
pub use legacy_qualification_profile_v2::{
    ...
    LegacyQualificationRequirementAssessmentV2,
    LEGACY_QUALIFICATION_PROFILE_ASSESSMENT_SCHEMA_V2,
};
