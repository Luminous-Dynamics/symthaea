...
pub mod legacy_blocker_matrix_v3;
...
pub mod legacy_source_capture_plan_v3;
...
pub use legacy_blocker_matrix_v3::{
    blocker_matrix_from_assessment_v3, legacy_blocker_matrix_v3, LegacyBlockerCellV3,
    LegacyBlockerClassV3, LegacyBlockerMatrixErrorV3, LegacyBlockerMatrixV3,
    LEGACY_BLOCKER_MATRIX_SCHEMA_V3,
};
...
pub use legacy_qualification_source_ledger_v3::{
    ...
    legacy_procedure_source_bindings_v3, legacy_procedure_verification_binding_v3,
    LegacyClaimVerificationReceiptV3, LegacyKnowledgeVerificationMethodV3,
    LegacyProcedureSourceBindingV3, LegacyProcedureVerificationReceiptV3,
...
pub use legacy_source_continuity::{
    assess_legacy_source_continuity_v1, require_legacy_source_continuity_v1,
    LegacySourceContinuityAssessmentV1, LegacySourceContinuityErrorV1,
    LegacySourceContinuityItemV1, LegacySourceContinuityStatusV1,
