...
impl AnomalyAnalysis {
        ...
        vec![
            ...
            AnomalyHypothesis {
                ...
                description: "Screening enhancement beyond measured values due to \
                    coherent electronic effects in loaded lattice"
                    .to_string(),
            ...
            AnomalyHypothesis {
                ...
                description: "Multiple phonons coherently adding energy to D-D pairs, \
                    effectively raising CM energy by hundreds of meV"
                    .to_string(),
            ...
            AnomalyHypothesis {
                ...
                description: "X-ray absorption creates transient hot spots where \
                    local temperature briefly reaches thousands of K"
                    .to_string(),
            ...
            AnomalyHypothesis {
                ...
                description: "The periodic potential of the lattice modifies the \
                    D-D nuclear interaction at short range"
                    .to_string(),
            ...
            AnomalyHypothesis {
                ...
                description: "The observed signal is not from D-D fusion but from \
                    background, cosmic rays, or electronic noise"
                    .to_string(),
    ...
    pub fn suggest_experiments(gap: &AnomalyGap) -> Vec<String> {
        ...
        match gap.significance {
            GapSignificance::WithinUncertainty => {
                suggestions
                    .push("Gap is within uncertainty - improve measurement precision".to_string());
            }
            GapSignificance::Significant => {
            ...
            GapSignificance::Extraordinary => {
                ...
                suggestions
                    .push("3. Multiple detection methods (n, γ, charged particles)".to_string());
