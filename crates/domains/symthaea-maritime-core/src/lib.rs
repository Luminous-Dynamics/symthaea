...
//! progressive-failure recording, authenticated-session evidence contracts, and
//! session-bound observation association reusable by AUVs, USVs, research vessels,
//! logistics craft and other maritime platforms.
