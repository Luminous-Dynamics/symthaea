...
//! industrial-closure/substitution/genome/flow-support analysis and progressive-failure
//! recording contracts reusable by AUVs, USVs, research vessels, logistics craft and
