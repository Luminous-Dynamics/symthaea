...
/// previous `obs_dim: 10` against a 32-channel state silently underused it).
...
mod tests {
    ...
    fn test_fep_perceiving_changes_agent_belief() {
        ...
        let mut hot_state = ScavengerState::home();
