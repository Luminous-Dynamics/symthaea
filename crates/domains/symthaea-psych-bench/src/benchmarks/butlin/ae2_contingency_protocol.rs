...
/// Two actions and two distinguishable consequences with a deterministic
/// reversal after the acquisition phase. The theoretical signature is not
/// raw action diversity: it is selective adaptation to changed consequences.
