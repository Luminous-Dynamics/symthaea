...
#[cfg(feature = "symthaea-backend")]
pub use gwt1_causal_promotion_capsule::{
    ...
    Gwt1CausalPromotionCapsuleFailureV1, Gwt1CausalPromotionCapsuleV1,
    map_gwt1_causal_outcome_to_eligibility_v1, validate_gwt1_causal_promotion_capsule_v1,
};
#[cfg(feature = "symthaea-backend")]
...
pub use gwt1_verified_final_artifact::{
    GWT1_AUTHORITATIVE_REPORT_SCHEMA_V1, GWT1_VERIFIED_RESOLVED_ARTIFACT_SCHEMA_V1,
    Gwt1AuthoritativeReportV1, VerifiedGwt1ResolvedArtifactV1,
    render_verified_gwt1_authoritative_report_v1,
};
