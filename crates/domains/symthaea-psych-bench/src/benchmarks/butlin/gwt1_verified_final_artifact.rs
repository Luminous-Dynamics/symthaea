...
/// opaque verified final-artifact capability. It deliberately does not
/// implement `Deserialize`: receiving report-shaped JSON must not be confused
/// with possessing verified reporting authority.
///
...
pub struct Gwt1AuthoritativeReportV1 {
    ...
    pub final_archive_sha256: String,
    pub final_attestation_verification_sha256: String,
    pub final_resolution_workflow_sha: String,
    ...
    pub consciousness_or_sentience_established: bool,
}
