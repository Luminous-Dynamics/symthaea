...
const SCHEDULE_REVISION: &str = "EUREKA.002.V2.CONSTRUCT_SCHEDULE.prototype.v3";
...
fn row_identity(
    ...
    let mut bytes = Vec::new();
    encode_bytes(&mut bytes, b"EUREKA.002.V2.ROW.prototype.v3");
    bytes.push(family.tag());
...
mod tests {
    ...
    #[test]
    fn construct_capsule_proves_coverage_and_attainable_headroom() {
