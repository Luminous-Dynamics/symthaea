...
// ═══════════════════════════════════════════════════════════════════════════════
// GENOME DECODING (simplified version for WASM — no full NeuralGenome import)
// ═══════════════════════════════════════════════════════════════════════════════
...
/// Decode a BinaryHV genome into a UnifiedNetworkConfig (same loci as symthaea-neuroevolution).
