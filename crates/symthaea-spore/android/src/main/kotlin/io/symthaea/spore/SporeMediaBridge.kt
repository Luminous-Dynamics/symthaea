...
/**
 * Bridges media playback state to the Spore engine.
 *
 ...
 *
 * Requires notification listener permission (shares with [SporeNotificationBridge]).
 *
 * Usage:
 * ```kotlin
 * lifecycle.addObserver(SporeMediaBridge(context, engine))
 * ```
 */
class SporeMediaBridge(
    ...
    override fun onStart(owner: LifecycleOwner) {
        try {
            ...
            val component = ComponentName(context, SporeNotificationBridge::class.java)
