...
/**
 * Coroutine-friendly wrapper around [SporeEngine].
 *
 ...
 */
class SporeCoroutineEngine(
    private val engine: SporeEngine,
    private val dispatcher: CloseableCoroutineDispatcher = @OptIn(ExperimentalCoroutinesApi::class) newSingleThreadContext("SporeEngine"),
) : Closeable {
    ...
    val raw: SporeEngine get() = engine
    ...
    companion object {
        private const val TAG = "SporeCoroutine"
    }
}
