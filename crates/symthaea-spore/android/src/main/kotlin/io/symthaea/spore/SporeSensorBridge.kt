 ...
 * Usage:
 * ```kotlin
 * lifecycle.addObserver(SporeSensorBridge(context, engine))
 * ```
 */
class SporeSensorBridge(
    context: Context,
    ...
    companion object {
        private const val TAG = "SporeSensor"
    }
}
