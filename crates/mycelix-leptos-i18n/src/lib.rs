...
impl Lang {
    ...
    pub fn label(&self) -> &'static str {
        match self {
            ...
            Lang::Ve => "Tshivenda", Lang::Nr => "isiNdebele",
            Lang::Fr => "Fran\u{00E7}ais", Lang::Pt => "Portugu\u{00EA}s",
            Lang::Es => "Espa\u{00F1}ol", Lang::Sw => "Kiswahili",
    ...
    fn from_code(code: &str) -> Lang {
        match code {
            "zu" => Lang::Zu, "af" => Lang::Af, "st" => Lang::St, "xh" => Lang::Xh,
            "tn" => Lang::Tn, "nso" => Lang::Ns, "ts" => Lang::Ts, "ss" => Lang::Ss,
            "ve" => Lang::Ve, "nr" => Lang::Nr, "fr" => Lang::Fr, "pt" => Lang::Pt,
            "es" => Lang::Es, "sw" => Lang::Sw, "ar" => Lang::Ar, "hi" => Lang::Hi,
            "zh" => Lang::Zh, _ => Lang::En,
        }
    }
}
