/*!
Symthaea Gym - Simulated Consciousness Swarm

Week 0 Days 3-5 Implementation:
- Mock Symthaea agents with K-Vector signatures
...
pub mod mock_symthaea;
pub mod swarm;

// Re-export key types
pub use mock_symthaea::{BehaviorProfile, KVectorSignature, MockSymthaea};
pub use swarm::{SymthaeaSwarm, SwarmStats};
