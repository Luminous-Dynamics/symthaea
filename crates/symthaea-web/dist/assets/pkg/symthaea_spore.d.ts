 ...
 */
export function generate_sovereign_config(hardware_json: string, choices_json: string, migration_json: string): any;
 ...
 */
export function sovereign_init(hardware_json: string, migration_json: string): any;
...
export interface InitOutput {
    ...
    readonly generate_sovereign_config: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly match_app_list: (a: number, b: number) => [number, number, number];
    readonly sovereign_chat: (a: number, b: number) => [number, number, number];
    readonly sovereign_init: (a: number, b: number, c: number, d: number) => [number, number, number];
    ...
    readonly sporeengine_dominant_harmony: (a: number) => [number, number];
    ...
    readonly sporeengine_harmony_scores: (a: number) => [number, number];
