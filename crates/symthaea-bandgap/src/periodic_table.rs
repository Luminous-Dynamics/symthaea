...
static ELEMENTS: [Element; 103] = [
    // ---- Period 1 ----
    el(1,   "H",  "Hydrogen",       2.20,  25.0,  13.598,  0.754, 1.008,     1, 1, 1),
    el(2,   "He", "Helium",         0.00,  31.0,  24.587,  0.000, 4.003,    18, 1, 2),
    // ---- Period 2 ----
    el(3,   "Li", "Lithium",        0.98, 145.0,   5.392,  0.618, 6.941,     1, 2, 1),
    el(4,   "Be", "Beryllium",      1.57, 105.0,   9.323,  0.000, 9.012,     2, 2, 2),
    el(5,   "B",  "Boron",          2.04,  85.0,   8.298,  0.277, 10.81,    13, 2, 3),
    el(6,   "C",  "Carbon",         2.55,  70.0,  11.260,  1.263, 12.011,   14, 2, 4),
    el(7,   "N",  "Nitrogen",       3.04,  65.0,  14.534,  0.000, 14.007,   15, 2, 5),
    el(8,   "O",  "Oxygen",         3.44,  60.0,  13.618,  1.461, 15.999,   16, 2, 6),
    el(9,   "F",  "Fluorine",       3.98,  50.0,  17.423,  3.401, 18.998,   17, 2, 7),
    el(10,  "Ne", "Neon",           0.00,  38.0,  21.565,  0.000, 20.180,   18, 2, 8),
    // ---- Period 3 ----
    el(11,  "Na", "Sodium",         0.93, 180.0,   5.139,  0.548, 22.990,    1, 3, 1),
    el(12,  "Mg", "Magnesium",      1.31, 150.0,   7.646,  0.000, 24.305,    2, 3, 2),
    el(13,  "Al", "Aluminium",      1.61, 125.0,   5.986,  0.441, 26.982,   13, 3, 3),
    el(14,  "Si", "Silicon",        1.90, 110.0,   8.152,  1.390, 28.086,   14, 3, 4),
    el(15,  "P",  "Phosphorus",     2.19, 100.0,  10.487,  0.747, 30.974,   15, 3, 5),
    el(16,  "S",  "Sulfur",         2.58, 100.0,  10.360,  2.077, 32.06,    16, 3, 6),
    el(17,  "Cl", "Chlorine",       3.16, 100.0,  12.968,  3.617, 35.45,    17, 3, 7),
    el(18,  "Ar", "Argon",          0.00,  71.0,  15.760,  0.000, 39.948,   18, 3, 8),
    // ---- Period 4 ----
    el(19,  "K",  "Potassium",      0.82, 220.0,   4.341,  0.501, 39.098,    1, 4, 1),
    el(20,  "Ca", "Calcium",        1.00, 180.0,   6.113,  0.025, 40.078,    2, 4, 2),
    el(21,  "Sc", "Scandium",       1.36, 160.0,   6.562,  0.188, 44.956,    3, 4, 2),
    el(22,  "Ti", "Titanium",       1.54, 140.0,   6.828,  0.079, 47.867,    4, 4, 2),
    el(23,  "V",  "Vanadium",       1.63, 135.0,   6.746,  0.525, 50.942,    5, 4, 2),
    el(24,  "Cr", "Chromium",       1.66, 140.0,   6.767,  0.666, 51.996,    6, 4, 1),
    el(25,  "Mn", "Manganese",      1.55, 140.0,   7.434,  0.000, 54.938,    7, 4, 2),
    el(26,  "Fe", "Iron",           1.83, 140.0,   7.902,  0.151, 55.845,    8, 4, 2),
    el(27,  "Co", "Cobalt",         1.88, 135.0,   7.881,  0.662, 58.933,    9, 4, 2),
    el(28,  "Ni", "Nickel",         1.91, 135.0,   7.640,  1.156, 58.693,   10, 4, 2),
    el(29,  "Cu", "Copper",         1.90, 135.0,   7.726,  1.236, 63.546,   11, 4, 1),
    el(30,  "Zn", "Zinc",           1.65, 135.0,   9.394,  0.000, 65.38,    12, 4, 2),
    el(31,  "Ga", "Gallium",        1.81, 130.0,   5.999,  0.300, 69.723,   13, 4, 3),
    el(32,  "Ge", "Germanium",      2.01, 125.0,   7.900,  1.233, 72.630,   14, 4, 4),
    el(33,  "As", "Arsenic",        2.18, 115.0,   9.789,  0.810, 74.922,   15, 4, 5),
    el(34,  "Se", "Selenium",       2.55, 115.0,   9.752,  2.021, 78.971,   16, 4, 6),
    el(35,  "Br", "Bromine",        2.96, 115.0,  11.814,  3.364, 79.904,   17, 4, 7),
    el(36,  "Kr", "Krypton",        3.00,  88.0,  14.000,  0.000, 83.798,   18, 4, 8),
    // ---- Period 5 ----
    el(37,  "Rb", "Rubidium",       0.82, 235.0,   4.177,  0.486, 85.468,    1, 5, 1),
    el(38,  "Sr", "Strontium",      0.95, 200.0,   5.695,  0.052, 87.62,     2, 5, 2),
    el(39,  "Y",  "Yttrium",        1.22, 180.0,   6.217,  0.307, 88.906,    3, 5, 2),
    el(40,  "Zr", "Zirconium",      1.33, 155.0,   6.634,  0.426, 91.224,    4, 5, 2),
    el(41,  "Nb", "Niobium",        1.60, 145.0,   6.759,  0.893, 92.906,    5, 5, 1),
    el(42,  "Mo", "Molybdenum",     2.16, 145.0,   7.092,  0.746, 95.95,     6, 5, 1),
    el(43,  "Tc", "Technetium",     1.90, 135.0,   7.280,  0.550, 98.0,      7, 5, 2),
    el(44,  "Ru", "Ruthenium",      2.20, 130.0,   7.361,  1.050, 101.07,    8, 5, 1),
    el(45,  "Rh", "Rhodium",        2.28, 135.0,   7.459,  1.137, 102.906,   9, 5, 1),
    el(46,  "Pd", "Palladium",      2.20, 140.0,   8.337,  0.557, 106.42,   10, 5, 0),
    el(47,  "Ag", "Silver",         1.93, 160.0,   7.576,  1.302, 107.868,  11, 5, 1),
    el(48,  "Cd", "Cadmium",        1.69, 155.0,   8.994,  0.000, 112.414,  12, 5, 2),
    el(49,  "In", "Indium",         1.78, 155.0,   5.786,  0.300, 114.818,  13, 5, 3),
    el(50,  "Sn", "Tin",            1.96, 145.0,   7.344,  1.112, 118.710,  14, 5, 4),
    el(51,  "Sb", "Antimony",       2.05, 145.0,   8.640,  1.047, 121.760,  15, 5, 5),
    el(52,  "Te", "Tellurium",      2.10, 140.0,   9.010,  1.971, 127.60,   16, 5, 6),
    el(53,  "I",  "Iodine",         2.66, 140.0,  10.451,  3.059, 126.904,  17, 5, 7),
    el(54,  "Xe", "Xenon",          2.60, 108.0,  12.130,  0.000, 131.293,  18, 5, 8),
    // ---- Period 6 ----
    el(55,  "Cs", "Caesium",        0.79, 260.0,   3.894,  0.472, 132.905,   1, 6, 1),
    el(56,  "Ba", "Barium",         0.89, 215.0,   5.212,  0.145, 137.327,   2, 6, 2),
    // Lanthanides (group = 0)
    el(57,  "La", "Lanthanum",      1.10, 195.0,   5.577,  0.500, 138.905,   0, 6, 2),
    el(58,  "Ce", "Cerium",         1.12, 185.0,   5.539,  0.500, 140.116,   0, 6, 2),
    el(59,  "Pr", "Praseodymium",   1.13, 185.0,   5.473,  0.500, 140.908,   0, 6, 2),
    el(60,  "Nd", "Neodymium",      1.14, 185.0,   5.525,  0.500, 144.242,   0, 6, 2),
    el(61,  "Pm", "Promethium",     1.13, 185.0,   5.582,  0.500, 145.0,     0, 6, 2),
    el(62,  "Sm", "Samarium",       1.17, 185.0,   5.644,  0.500, 150.36,    0, 6, 2),
    el(63,  "Eu", "Europium",       1.20, 185.0,   5.670,  0.500, 151.964,   0, 6, 2),
    el(64,  "Gd", "Gadolinium",     1.20, 180.0,   6.150,  0.500, 157.25,    0, 6, 2),
    el(65,  "Tb", "Terbium",        1.20, 175.0,   5.864,  0.500, 158.925,   0, 6, 2),
    el(66,  "Dy", "Dysprosium",     1.22, 175.0,   5.939,  0.500, 162.500,   0, 6, 2),
    el(67,  "Ho", "Holmium",        1.23, 175.0,   6.022,  0.500, 164.930,   0, 6, 2),
    el(68,  "Er", "Erbium",         1.24, 175.0,   6.108,  0.500, 167.259,   0, 6, 2),
    el(69,  "Tm", "Thulium",        1.25, 175.0,   6.184,  0.500, 168.934,   0, 6, 2),
    el(70,  "Yb", "Ytterbium",      1.10, 175.0,   6.254,  0.500, 173.045,   0, 6, 2),
    el(71,  "Lu", "Lutetium",       1.27, 175.0,   5.426,  0.500, 174.967,   3, 6, 2),
    // Post-lanthanide d-block
    el(72,  "Hf", "Hafnium",        1.30, 155.0,   6.825,  0.000, 178.49,    4, 6, 2),
    el(73,  "Ta", "Tantalum",       1.50, 145.0,   7.550,  0.322, 180.948,   5, 6, 2),
    el(74,  "W",  "Tungsten",       2.36, 135.0,   7.864,  0.816, 183.84,    6, 6, 2),
    el(75,  "Re", "Rhenium",        1.90, 135.0,   7.833,  0.150, 186.207,   7, 6, 2),
    el(76,  "Os", "Osmium",         2.20, 130.0,   8.438,  1.100, 190.23,    8, 6, 2),
    el(77,  "Ir", "Iridium",        2.20, 135.0,   8.967,  1.565, 192.217,   9, 6, 2),
    el(78,  "Pt", "Platinum",       2.28, 135.0,   8.959,  2.128, 195.084,  10, 6, 1),
    el(79,  "Au", "Gold",           2.54, 135.0,   9.226,  2.309, 196.967,  11, 6, 1),
    el(80,  "Hg", "Mercury",        2.00, 150.0,  10.437,  0.000, 200.592,  12, 6, 2),
    // Post-lanthanide p-block
    el(81,  "Tl", "Thallium",       1.62, 190.0,   6.108,  0.200, 204.38,   13, 6, 3),
    el(82,  "Pb", "Lead",           2.33, 180.0,   7.417,  0.364, 207.2,    14, 6, 4),
    el(83,  "Bi", "Bismuth",        2.02, 160.0,   7.286,  0.946, 208.980,  15, 6, 5),
    el(84,  "Po", "Polonium",       2.00, 190.0,   8.414,  1.900, 209.0,    16, 6, 6),
    el(85,  "At", "Astatine",       2.20, 127.0,   9.318,  2.800, 210.0,    17, 6, 7),
    el(86,  "Rn", "Radon",          0.00, 120.0,  10.749,  0.000, 222.0,    18, 6, 8),
    // ---- Period 7 ----
    el(87,  "Fr", "Francium",       0.70, 260.0,   4.073,  0.000, 223.0,     1, 7, 1),
    el(88,  "Ra", "Radium",         0.90, 215.0,   5.278,  0.000, 226.0,     2, 7, 2),
    // Actinides (group = 0)
    el(89,  "Ac", "Actinium",       1.10, 195.0,   5.170,  0.000, 227.0,     0, 7, 2),
    el(90,  "Th", "Thorium",        1.30, 180.0,   6.307,  0.000, 232.038,   0, 7, 2),
    el(91,  "Pa", "Protactinium",   1.50, 180.0,   5.890,  0.000, 231.036,   0, 7, 2),
    el(92,  "U",  "Uranium",        1.38, 175.0,   6.194,  0.000, 238.029,   0, 7, 2),
    el(93,  "Np", "Neptunium",      1.36, 175.0,   6.266,  0.000, 237.0,     0, 7, 2),
    el(94,  "Pu", "Plutonium",      1.28, 175.0,   6.026,  0.000, 244.0,     0, 7, 2),
    el(95,  "Am", "Americium",      1.30, 175.0,   5.974,  0.000, 243.0,     0, 7, 2),
    el(96,  "Cm", "Curium",         1.30, 176.0,   5.991,  0.000, 247.0,     0, 7, 2),
    el(97,  "Bk", "Berkelium",      1.30, 176.0,   6.198,  0.000, 247.0,     0, 7, 2),
    el(98,  "Cf", "Californium",    1.30, 176.0,   6.282,  0.000, 251.0,     0, 7, 2),
    el(99,  "Es", "Einsteinium",    1.30, 176.0,   6.420,  0.000, 252.0,     0, 7, 2),
    el(100, "Fm", "Fermium",        1.30, 176.0,   6.500,  0.000, 257.0,     0, 7, 2),
    el(101, "Md", "Mendelevium",    1.30, 176.0,   6.580,  0.000, 258.0,     0, 7, 2),
    el(102, "No", "Nobelium",       1.30, 176.0,   6.650,  0.000, 259.0,     0, 7, 2),
    el(103, "Lr", "Lawrencium",     1.30, 176.0,   4.900,  0.000, 266.0,     0, 7, 3),
];
...
pub fn atomic_number(symbol: &str) -> Option<u8> {
    ELEMENT_SYMBOLS.iter().position(|&s| s == symbol).map(|i| i as u8)
}
    ...
    fn test_struct_and_array_consistency() {
        ...
        for z in 1u8..=103 {
            ...
            assert!(
                ...
                e.symbol, z, e.electronegativity, en_array
            );
        }
    }
