...
pub fn extract_features(composition: &[(u8, f64)], crystal: &CrystalSystem) -> [f64; N_FEATURES] {
    ...
    let en_values: Vec<f64> = composition.iter().map(|&(z, _)| electronegativity(z)).collect();
    ...
    let radii: Vec<f64> = composition.iter().map(|&(z, _)| covalent_radius(z)).collect();
    ...
    // ── 7: Weighted mean atomic mass (amu) ──
    let mean_mass: f64 = composition
        .iter()
        .map(|&(z, f)| atomic_mass(z) * f)
        .sum();
...
fn max_oxidation_state(z: u8) -> i8 {
    match z {
        1 => 1,  2 => 0,
        3 => 1,  4 => 2,
        5 => 3,  6 => 4,  7 => 5,  8 => -2, 9 => -1, 10 => 0,
        11 => 1, 12 => 2,
        13 => 3, 14 => 4, 15 => 5, 16 => 6, 17 => 7, 18 => 0,
        19 => 1, 20 => 2,
        21 => 3, 22 => 4, 23 => 5, 24 => 6, 25 => 7, 26 => 3,
        27 => 3, 28 => 3, 29 => 2, 30 => 2,
        31 => 3, 32 => 4, 33 => 5, 34 => 6, 35 => 5, 36 => 2,
        37 => 1, 38 => 2,
        39 => 3, 40 => 4, 41 => 5, 42 => 6, 43 => 7, 44 => 8,
        45 => 4, 46 => 4, 47 => 1, 48 => 2,
        49 => 3, 50 => 4, 51 => 5, 52 => 6, 53 => 7, 54 => 8,
        55 => 1, 56 => 2,
        57 => 3, 58 => 4, 59 => 4, 60 => 3, 64 => 3,
        72 => 4, 73 => 5, 74 => 6, 75 => 7,
        80 => 2, 81 => 3, 82 => 4, 83 => 5,
