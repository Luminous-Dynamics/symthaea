...
pub fn load_training_data() -> Vec<MaterialEntry> {
    vec![
        ...
        me("TiO2-rut", &[(TI, 1.0/3.0), (O, 2.0/3.0)], 3.03, Tetragonal),
        me("TiO2-ana", &[(TI, 1.0/3.0), (O, 2.0/3.0)], 3.20, Tetragonal),
        me("Fe2O3",    &[(FE, 2.0/5.0), (O, 3.0/5.0)], 2.10,  Trigonal),
        me("WO3",      &[(W, 0.25), (O, 0.75)],         2.60,  Monoclinic),
        me("V2O5",     &[(V, 2.0/7.0), (O, 5.0/7.0)],  2.30,  Orthorhombic),
        ...
        me("Bi2S3",    &[(BI, 2.0/5.0), (S, 3.0/5.0)], 1.30,  Orthorhombic),
        me("Sb2S3",    &[(SB, 2.0/5.0), (S, 3.0/5.0)], 1.72,  Orthorhombic),
        me("In2S3",    &[(IN, 2.0/5.0), (S, 3.0/5.0)], 2.10,  Tetragonal),
        ...
        me("BaTiO3",   &[(BA, 0.2), (TI, 0.2), (O, 0.6)],     3.20,  Tetragonal),
        me("PbTiO3",   &[(PB, 0.2), (TI, 0.2), (O, 0.6)],     3.40,  Tetragonal),
        me("CsPbBr3",  &[(CS, 0.2), (PB, 0.2), (BR, 0.6)],    2.30,  Orthorhombic),
        me("MAPbI3",   &[(C, 1.0/12.0), (N, 1.0/12.0), (H, 6.0/12.0), (PB, 1.0/12.0), (I, 3.0/12.0)], 1.55, Tetragonal),
        me("KNbO3",    &[(K, 0.2), (NB, 0.2), (O, 0.6)],      3.30,  Orthorhombic),
        me("NaNbO3",   &[(NA, 0.2), (NB, 0.2), (O, 0.6)],     3.40,  Orthorhombic),
        ...
        me("CsSnI3",   &[(CS, 0.2), (SN, 0.2), (I, 0.6)],    1.30,  Orthorhombic),
        ...
        me("Ta3N5",    &[(TA, 3.0/8.0), (N, 5.0/8.0)], 2.10,  Orthorhombic),

        // ══════════════════════════════════════════════════════════════════
        // Phosphides & Arsenides (beyond III-V)
        // ══════════════════════════════════════════════════════════════════
        me("ZnP2",     &[(ZN, 1.0/3.0), (P, 2.0/3.0)], 2.18,  Tetragonal),
        me("Zn3P2",    &[(ZN, 3.0/5.0), (P, 2.0/5.0)], 1.50,  Tetragonal),
        me("CdP2",     &[(CD, 1.0/3.0), (P, 2.0/3.0)], 1.92,  Tetragonal),
        me("Cd3P2",    &[(CD, 3.0/5.0), (P, 2.0/5.0)], 0.50,  Tetragonal),
        me("GeAs2",    &[(GE, 1.0/3.0), (AS, 2.0/3.0)], 0.57, Monoclinic),
        me("ZnAs2",    &[(ZN, 1.0/3.0), (AS, 2.0/3.0)], 0.93, Monoclinic),

        // ══════════════════════════════════════════════════════════════════
        // Tellurides (Thermoelectric & Topological)
        // ══════════════════════════════════════════════════════════════════
        me("PbTe",     &[(PB, 0.5), (TE, 0.5)],         0.31,  Cubic),
        me("Bi2Te3",   &[(BI, 2.0/5.0), (TE, 3.0/5.0)], 0.15, Trigonal),
        me("SnTe",     &[(SN, 0.5), (TE, 0.5)],         0.18,  Cubic),
        me("PbSe",     &[(PB, 0.5), (SE, 0.5)],         0.26,  Cubic),
        me("PbS",      &[(PB, 0.5), (S, 0.5)],          0.37,  Cubic),
        me("Sb2Te3",   &[(SB, 2.0/5.0), (TE, 3.0/5.0)], 0.21, Trigonal),
        me("GeTe",     &[(GE, 0.5), (TE, 0.5)],         0.36,  Trigonal),
        me("Bi2Se3",   &[(BI, 2.0/5.0), (SE, 3.0/5.0)], 0.30, Trigonal),
        me("Ag2Te",    &[(AG, 2.0/3.0), (TE, 1.0/3.0)], 0.67, Monoclinic),
        me("Cu2Te",    &[(CU, 2.0/3.0), (TE, 1.0/3.0)], 1.04, Hexagonal),
        ...
        me("CuAlO2",   &[(CU, 0.25), (AL, 0.25), (O, 0.5)], 3.50, Trigonal),
        me("ZnFe2O4",  &[(ZN, 1.0/7.0), (FE, 2.0/7.0), (O, 4.0/7.0)], 1.90, Cubic),
        me("CoFe2O4",  &[(CO, 1.0/7.0), (FE, 2.0/7.0), (O, 4.0/7.0)], 1.20, Cubic),
        me("NiFe2O4",  &[(NI, 1.0/7.0), (FE, 2.0/7.0), (O, 4.0/7.0)], 1.60, Cubic),
        me("MnFe2O4",  &[(MN, 1.0/7.0), (FE, 2.0/7.0), (O, 4.0/7.0)], 1.00, Cubic),
        ...
        // Selenides
        // ══════════════════════════════════════════════════════════════════
        me("In2Se3",   &[(IN, 2.0/5.0), (SE, 3.0/5.0)], 1.30, Hexagonal),
        me("Ga2Se3",   &[(GA, 2.0/5.0), (SE, 3.0/5.0)], 2.00, Cubic),
        me("Sb2Se3",   &[(SB, 2.0/5.0), (SE, 3.0/5.0)], 1.12, Orthorhombic),
        me("CuSe",     &[(CU, 0.5), (SE, 0.5)],          1.10, Hexagonal),
        me("Ag2Se",    &[(AG, 2.0/3.0), (SE, 1.0/3.0)],  0.15, Orthorhombic),
        me("GeSe",     &[(GE, 0.5), (SE, 0.5)],           1.10, Orthorhombic),
        me("GeSe2",    &[(GE, 1.0/3.0), (SE, 2.0/3.0)],  2.70, Monoclinic),
        me("SnSe",     &[(SN, 0.5), (SE, 0.5)],           0.90, Orthorhombic),
        me("SnSe2",    &[(SN, 1.0/3.0), (SE, 2.0/3.0)],  1.00, Hexagonal),
        me("FeSe2",    &[(FE, 1.0/3.0), (SE, 2.0/3.0)],  1.00, Orthorhombic),
        me("MoSe2",    &[(MO, 1.0/3.0), (SE, 2.0/3.0)],  1.10, Hexagonal),
        me("WSe2",     &[(W, 1.0/3.0), (SE, 2.0/3.0)],   1.20, Hexagonal),

        // ══════════════════════════════════════════════════════════════════
        // Sulfides (beyond II-VI)
        // ══════════════════════════════════════════════════════════════════
        me("Ga2S3",    &[(GA, 2.0/5.0), (S, 3.0/5.0)],  2.50, Monoclinic),
        me("GeS",      &[(GE, 0.5), (S, 0.5)],           1.55, Orthorhombic),
        me("GeS2",     &[(GE, 1.0/3.0), (S, 2.0/3.0)],  3.20, Monoclinic),
        me("As2S3",    &[(AS, 2.0/5.0), (S, 3.0/5.0)],  2.40, Monoclinic),
        ...
        // ══════════════════════════════════════════════════════════════════
        me("CuGaS2",   &[(CU, 0.25), (GA, 0.25), (S, 0.5)],   2.43, Tetragonal),
        me("CuGaSe2",  &[(CU, 0.25), (GA, 0.25), (SE, 0.5)],  1.68, Tetragonal),
        me("CuInS2",   &[(CU, 0.25), (IN, 0.25), (S, 0.5)],   1.53, Tetragonal),
        me("CuInSe2",  &[(CU, 0.25), (IN, 0.25), (SE, 0.5)],  1.04, Tetragonal),
        me("CuInTe2",  &[(CU, 0.25), (IN, 0.25), (TE, 0.5)],  0.96, Tetragonal),
        me("CuAlS2",   &[(CU, 0.25), (AL, 0.25), (S, 0.5)],   3.49, Tetragonal),
        me("CuAlSe2",  &[(CU, 0.25), (AL, 0.25), (SE, 0.5)],  2.67, Tetragonal),
        me("AgGaS2",   &[(AG, 0.25), (GA, 0.25), (S, 0.5)],   2.73, Tetragonal),
        me("AgGaSe2",  &[(AG, 0.25), (GA, 0.25), (SE, 0.5)],  1.83, Tetragonal),
        me("AgInS2",   &[(AG, 0.25), (IN, 0.25), (S, 0.5)],   1.87, Tetragonal),
        me("AgInSe2",  &[(AG, 0.25), (IN, 0.25), (SE, 0.5)],  1.24, Tetragonal),
        me("ZnSiP2",   &[(ZN, 0.25), (SI, 0.25), (P, 0.5)],   2.07, Tetragonal),
        me("ZnGeP2",   &[(ZN, 0.25), (GE, 0.25), (P, 0.5)],   1.99, Tetragonal),
        me("CdGeP2",   &[(CD, 0.25), (GE, 0.25), (P, 0.5)],   1.72, Tetragonal),

        // ══════════════════════════════════════════════════════════════════
        // Fluorides & Halides (additional)
        // ══════════════════════════════════════════════════════════════════
        me("MgF2",     &[(MG, 1.0/3.0), (F, 2.0/3.0)], 10.80, Tetragonal),
        ...
        me("HfSe2",    &[(HF, 1.0/3.0), (SE, 2.0/3.0)], 1.13, Hexagonal),
        me("ZrS2",     &[(ZR, 1.0/3.0), (S, 2.0/3.0)],  1.68, Hexagonal),
        me("ZrSe2",    &[(ZR, 1.0/3.0), (SE, 2.0/3.0)], 1.20, Hexagonal),
        me("ReS2",     &[(RE, 1.0/3.0), (S, 2.0/3.0)],  1.35, Triclinic),
        me("ReSe2",    &[(RE, 1.0/3.0), (SE, 2.0/3.0)], 1.15, Triclinic),

        // ══════════════════════════════════════════════════════════════════
        // Oxyhalides & Oxychalcogenides
        // ══════════════════════════════════════════════════════════════════
        me("Bi2O2Se",  &[(BI, 2.0/5.0), (O, 2.0/5.0), (SE, 1.0/5.0)], 0.80, Tetragonal),
        me("BiOCl",    &[(BI, 1.0/3.0), (O, 1.0/3.0), (CL, 1.0/3.0)], 3.40, Tetragonal),

        // ══════════════════════════════════════════════════════════════════
        // II-IV-V2 Pnictides
        // ══════════════════════════════════════════════════════════════════
        me("ZnSnP2",   &[(ZN, 0.25), (SN, 0.25), (P, 0.5)],   1.66, Tetragonal),
        me("CdSnP2",   &[(CD, 0.25), (SN, 0.25), (P, 0.5)],   1.17, Tetragonal),
        me("ZnSnAs2",  &[(ZN, 0.25), (SN, 0.25), (AS, 0.5)],  0.73, Tetragonal),
        me("CdSnAs2",  &[(CD, 0.25), (SN, 0.25), (AS, 0.5)],  0.26, Tetragonal),
        me("CdGeAs2",  &[(CD, 0.25), (GE, 0.25), (AS, 0.5)],  0.57, Tetragonal),
        me("ZnGeAs2",  &[(ZN, 0.25), (GE, 0.25), (AS, 0.5)],  1.15, Tetragonal),
        me("ZnSiAs2",  &[(ZN, 0.25), (SI, 0.25), (AS, 0.5)],  1.74, Tetragonal),
        me("CdSiAs2",  &[(CD, 0.25), (SI, 0.25), (AS, 0.5)],  1.55, Tetragonal),
    ]
}
...
mod tests {
    ...
    fn crystal_system_ordinals_unique() {
        use CrystalSystem::*;
        let systems = [
            Cubic, Hexagonal, Tetragonal, Orthorhombic, Monoclinic, Trigonal,
            Triclinic, Unknown,
        ];
