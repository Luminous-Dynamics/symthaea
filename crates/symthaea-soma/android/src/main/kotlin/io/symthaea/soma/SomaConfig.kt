...
/**
 * Configuration for the Soma consciousness kernel.
 *
 * Maps to the Rust `SomaConfig` struct in `config.rs`.
 * Default values match the Rust defaults (full-fidelity desktop config).
 * For mobile, use [SomaEngine.createMobile] or set reduced values.
 */
@Serializable
data class SomaConfig(
