...
/**
 * Bridges notification count to the Soma engine as social pressure.
 *
 ...
 */
class SomaNotificationBridge : NotificationListenerService() {
    ...
    companion object {
        /** Set by the activity/service that owns the SomaEngine. */
        @Volatile
        var engineRef: SomaEngine? = null
    }
}
