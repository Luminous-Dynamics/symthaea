...
impl Default for SetCameraInfo_Request {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::srv::rmw::SetCameraInfo_Request::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                camera_info: super::msg::CameraInfo::into_rmw_message(std::borrow::Cow::Owned(
                    msg.camera_info,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                camera_info: super::msg::CameraInfo::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.camera_info,
                ))
                .into_owned(),
            }),
...
impl Default for SetCameraInfo_Response {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::srv::rmw::SetCameraInfo_Response::default(),
        )
    }
}
