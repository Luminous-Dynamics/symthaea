...
use symthaea_assurance_tpm2_attestation_possession::{
    ...
    AttestationPossessionRecord, qualify_attestation_possession,
};
use symthaea_assurance_tpm2_checkquote_adapter::{Tpm2CheckquotePolicy, Tpm2QuoteQualification};
...
pub fn qualify_linux_tpm_ima_pcr_anchor(
    ...
    if quote.verification_receipt.receipt_digest() != quote_verified.verification_receipt_digest() {
        reject!(LinuxTpmImaPcrAnchorIssue::QuoteCapabilityBindingMismatch(
