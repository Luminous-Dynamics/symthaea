...
impl VoiceStopCapability for LiveVoiceStopHandle {
    ...
    fn is_speaking(&self) -> bool {
        // At the service presentation boundary, "speaking" means the generation
        // remains software-audible: synthesis/push is active OR queued PCM remains.
        // This deliberately keeps the active-generation lease alive after synthesis
        // returns until the software ring has drained (or is purged by barge-in).
        LiveVoiceStopHandle::is_playing(self)
    }
}
