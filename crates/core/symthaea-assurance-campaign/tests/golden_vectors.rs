...
fn plan(subject: &AiSubjectManifest, claim: &Claim, vector: &str) -> CampaignPlanV1 {
    ...
    let plan = CampaignPlanV1::new(
        ...
        vec![
            SupportCriterionV1::new(SupportTier::Observed, semantic("observable-authority-decision")),
...
fn assert_vector(name: &str) -> String {
    ...
    let withdrawal_statement =
        WithdrawalStatementV1::new(&registration, id("operator-withdrawal"));
    assert_eq!(
