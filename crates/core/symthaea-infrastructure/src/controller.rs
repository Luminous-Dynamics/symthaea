...
use crate::types::{InfrastructureCommand, InfrastructureConfig, NUM_ACTUATORS};
...
impl InfrastructureController {
    pub fn new(g: &GenesisSeed, c: &InfrastructureConfig) -> Self {
        ...
        let wh = ContinuousHV::from_genesis(g, "infrastructure::out_w", NUM_ACTUATORS * HDC_DIM);
    ...
    pub fn forward(&mut self, hv: &ContinuousHV, dt: f32) -> InfrastructureCommand {
        ...
        self.last_outputs = t;
        InfrastructureCommand { torques: t }
    }
    ...
    /// makes `InfrastructureTrainer` actually train (Tier 2 of
    /// SYMTHAEA_UNAUDITED_PLATFORMS_REVIEW_2026-07-07.md).
    pub fn train_step(&mut self, target: &InfrastructureCommand) -> f32 {
...
mod tests {
    ...
    #[test]
    fn test_fwd() {
        let mut c = InfrastructureController::new(
