...
use symthaea_nix::encoding::codebook::NixCodebook;
use symthaea_nix::ipc::{CausalEdgeEntry, DaemonSnapshot, SNAPSHOT_VERSION};
...
fn test_daemon_snapshot_serialization_with_new_fields() {
    let snap = DaemonSnapshot {
        ...
        alerts: vec![symthaea_nix::ipc::AlertEntry {
            ...
            severity: symthaea_nix::ipc::AlertSeverity::Critical,
...
fn test_snapshot_write_read_roundtrip_with_alerts() {
    let snap = DaemonSnapshot {
        ...
        alerts: vec![symthaea_nix::ipc::AlertEntry {
            ...
            severity: symthaea_nix::ipc::AlertSeverity::Warning,
            first_seen: 1700000000,
            last_seen: 1700000000,
...
fn test_semantic_search_rank_validity() {
    use symthaea_nix::encoding::semantic_search::search_options;
    let mut codebook = NixCodebook::new();
    let paths = [
