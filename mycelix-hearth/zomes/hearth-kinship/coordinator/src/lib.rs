...
pub fn create_hearth(input: CreateHearthInput) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_proposal(), "create_hearth")?;
    let agent = agent_info()?.agent_initial_pubkey;
    let now = sys_time()?;
...
pub fn invite_member(input: InviteMemberInput) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_proposal(), "invite_member")?;
...
pub fn accept_invitation(input: AcceptInvitationInput) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_basic(), "accept_invitation")?;
    let agent = agent_info()?.agent_initial_pubkey;
    let now = sys_time()?;
...
pub fn decline_invitation(invitation_hash: ActionHash) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_basic(), "decline_invitation")?;
    let agent = agent_info()?.agent_initial_pubkey;
...
pub fn leave_hearth(membership_hash: ActionHash) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_basic(), "leave_hearth")?;
    let agent = agent_info()?.agent_initial_pubkey;
...
pub fn update_member_role(input: UpdateMemberRoleInput) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_voting(), "update_member_role")?;
...
pub fn create_kinship_bond(input: CreateBondInput) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_proposal(), "create_kinship_bond")?;
    let agent = agent_info()?.agent_initial_pubkey;
    let now = sys_time()?;
...
pub fn tend_bond(input: TendBondInput) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_basic(), "tend_bond")?;
    let now = sys_time()?;
...
pub fn create_weekly_digest(input: WeeklyDigest) -> ExternResult<Record> {
    let _eligibility = require_consciousness(&civic_requirement_proposal(), "create_weekly_digest")?;
