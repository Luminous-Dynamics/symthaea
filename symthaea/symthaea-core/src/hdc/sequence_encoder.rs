...
mod tests {
    ...
    fn test_long_sequence_degradation() {
        ...
        assert!(sim_0 > 0.51, "Position 0 in long sequence should be recoverable, got {}", sim_0);
        assert!(sim_25 > 0.51, "Position 25 in long sequence should be recoverable, got {}", sim_25);
        assert!(sim_49 > 0.51, "Position 49 in long sequence should be recoverable, got {}", sim_49);
