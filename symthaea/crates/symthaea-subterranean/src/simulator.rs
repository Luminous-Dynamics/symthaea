...
use crate::types::{
    SubterraneanCommand, SubterraneanOperatingMode, SubterraneanState, ABORT_RECOMMENDATION,
    AQUIFER_RISK, BATTERY_RATIO, COMM_SIGNAL, CUTTER_TEMP_C, DEPTH_M, ESCAPE_CONFIDENCE, GAS_RISK,
    HULL_STRESS, LOCALIZATION_CONFIDENCE, MAPPING_CONFIDENCE, MISSION_PROGRESS, OBSTACLE_PROXIMITY,
    RELAY_DISTANCE_NORM, RELAY_LINK_QUALITY, RETURN_PATH_CONFIDENCE, ROOF_STABILITY,
    SEAL_INTEGRITY, SLIP_RATIO, SLURRY_LOAD, SPOIL_BUFFER_FILL, THERMAL_MARGIN, TOOL_WEAR,
    VEIN_SIGNAL, WATER_INGRESS_RATIO,
};
