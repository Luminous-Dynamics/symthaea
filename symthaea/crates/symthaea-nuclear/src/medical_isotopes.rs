...
const fn hours(h: f64) -> f64 { h * 3600.0 }
const fn days(d: f64) -> f64 { d * 86400.0 }
const fn minutes(m: f64) -> f64 { m * 60.0 }
const fn years(y: f64) -> f64 { y * 365.25 * 86400.0 }
...
pub fn medical_isotope_database() -> Vec<MedicalIsotope> {
    vec![
        ...
        MedicalIsotope {
            ...
            clinical_use: "FDG-PET: glucose metabolism imaging (oncology, neurology, cardiology)".into(),
            production: ProductionRoute::ProtonBombardment {
                target: "O-18 (water)".into(), target_z: 8, target_n: 10,
            },
        },
        MedicalIsotope {
            symbol: "C".into(),
            ...
            production: ProductionRoute::ProtonBombardment {
                target: "N-14 (gas)".into(), target_z: 7, target_n: 7,
            },
        },
        MedicalIsotope {
            symbol: "N".into(),
            ...
            production: ProductionRoute::ProtonBombardment {
                target: "O-16 (water)".into(), target_z: 8, target_n: 8,
            },
        },
        MedicalIsotope {
            symbol: "O".into(),
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::Generator {
                parent: "Ge-68".into(), parent_z: 32, parent_n: 36,
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::ProtonBombardment {
                target: "Ni-64".into(), target_z: 28, target_n: 36,
            },
        },
        ...
        MedicalIsotope {
            ...
            clinical_use: "Most-used medical isotope: bone, cardiac, renal, brain, thyroid scans".into(),
            production: ProductionRoute::Generator {
                parent: "Mo-99".into(), parent_z: 42, parent_n: 57,
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::NeutronCapture {
                target: "Gd-152".into(), target_z: 64, target_n: 88,
            },
        },
        ...
        MedicalIsotope {
            ...
            clinical_use: "Thyroid cancer ablation, hyperthyroidism treatment, MIBG therapy (neuroblastoma)".into(),
            production: ProductionRoute::NeutronCapture {
                target: "Te-130".into(), target_z: 52, target_n: 78,
            },
        },
        MedicalIsotope {
            symbol: "Lu".into(),
            ...
            modality: ClinicalModality::BetaTherapy,
            clinical_use: "DOTATATE (Lutathera): NET therapy; PSMA-617 (Pluvicto): prostate cancer".into(),
            production: ProductionRoute::NeutronCapture {
                target: "Lu-176".into(), target_z: 71, target_n: 105,
            },
        },
        MedicalIsotope {
            symbol: "Y".into(),
            ...
            daughter: "Zr-90".into(),
            modality: ClinicalModality::BetaTherapy,
            clinical_use: "Zevalin (NHL lymphoma), SIR-Spheres (liver metastases radioembolization)".into(),
            production: ProductionRoute::Generator {
                parent: "Sr-90".into(), parent_z: 38, parent_n: 52,
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::NeutronCapture {
                target: "Sr-88".into(), target_z: 38, target_n: 50,
            },
        },
        MedicalIsotope {
            symbol: "Sm".into(),
            ...
            production: ProductionRoute::NeutronCapture {
                target: "Sm-152".into(), target_z: 62, target_n: 90,
            },
        },
        MedicalIsotope {
            symbol: "Re".into(),
            ...
            modality: ClinicalModality::BetaTherapy,
            clinical_use: "Bone pain palliation (Re-186 HEDP), rheumatoid arthritis synovectomy".into(),
            production: ProductionRoute::NeutronCapture {
                target: "Re-185".into(), target_z: 75, target_n: 110,
            },
        },
        MedicalIsotope {
            symbol: "Re".into(),
            ...
            modality: ClinicalModality::BetaTherapy,
            clinical_use: "Coronary artery restenosis, hepatocellular carcinoma, skin cancer".into(),
            production: ProductionRoute::Generator {
                parent: "W-188".into(), parent_z: 74, parent_n: 114,
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::NeutronCapture {
                target: "Er-168".into(), target_z: 68, target_n: 100,
            },
        },
        MedicalIsotope {
            symbol: "Tb".into(),
            ...
            modality: ClinicalModality::BetaTherapy,
            clinical_use: "Targeted radionuclide therapy (similar to Lu-177 but with Auger electrons)".into(),
            production: ProductionRoute::NeutronCapture {
                target: "Gd-160".into(), target_z: 64, target_n: 96,
            },
        },
        MedicalIsotope {
            symbol: "Cu".into(),
            ...
            production: ProductionRoute::ProtonBombardment {
                target: "Zn-68".into(), target_z: 30, target_n: 38,
            },
        },
        ...
        MedicalIsotope {
            ...
            modality: ClinicalModality::AlphaTherapy,
            clinical_use: "Xofigo: bone metastases from castration-resistant prostate cancer".into(),
            production: ProductionRoute::Generator {
                parent: "Ac-227".into(), parent_z: 89, parent_n: 138,
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::Generator {
                parent: "Ra-224".into(), parent_z: 88, parent_n: 136,
        ...
        MedicalIsotope {
            ...
            modality: ClinicalModality::AlphaTherapy,
            clinical_use: "Targeted alpha therapy: AML (anti-CD33), bladder cancer, glioblastoma".into(),
            production: ProductionRoute::Generator {
                parent: "Ac-225".into(), parent_z: 89, parent_n: 136,
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::ProtonAlpha {
                target: "Bi-209".into(), target_z: 83, target_n: 126,
            },
        },
        ...
        MedicalIsotope {
            ...
            production: ProductionRoute::NeutronCapture {
                target: "Xe-124".into(), target_z: 54, target_n: 70,
            },
        },
    ]
}
...
pub fn find_theranostic_pairs(db: &[MedicalIsotope]) -> Vec<TheranosticPair> {
    // Group by element
    let mut elements: std::collections::HashMap<u16, ElementIsotopeSet> = std::collections::HashMap::new();
        ...
        for &(img_a, img_mod, ref img_name) in &eset.imaging {
            for &(ther_a, ther_mod, ref ther_name) in &eset.therapy {
                let is_known = known_pairs.iter().any(|(sym, ia, ta)| {
                    *sym == eset.symbol && ((*ia == img_a && *ta == ther_a) || (*ta == img_a && *ia == ther_a))
                });
...
pub fn find_novel_theranostic_candidates(
    ...
    for &(z, ref symbol) in &medical_elements {
        ...
        let known_a: Vec<u16> = db.iter().filter(|iso| iso.z == z).map(|iso| iso.a).collect();
        let min_a = known_a.iter().copied().min().unwrap_or(z * 2).saturating_sub(5);
        ...
        for a in min_a..=max_a {
            if a <= z { continue; }
            let n = a - z;
            if known_a.contains(&a) { continue; }

            let pred = predictor.predict(z, n);
            if pred.uncertainty > 2.0 { continue; } // Skip high-uncertainty predictions
        ...
        let known_imaging: Vec<_> = db.iter()
            .filter(|iso| iso.z == z && iso.modality.is_imaging())
            .collect();
        let known_therapy: Vec<_> = db.iter()
        ...
        for &(ther_a, ther_mod, ther_q) in &therapy_candidates {
            for known_img in &known_imaging {
                candidates.push(TheranosticPair {
                    ...
                    is_known: false,
                    notes: format!(
                        "Known imaging + ML therapy candidate: Q={:.3} MeV",
                        ther_q,
                    ),
                });
            }
        ...
        for &(img_a, img_mod, img_q) in &imaging_candidates {
            for known_ther in &known_therapy {
                candidates.push(TheranosticPair {
                    ...
                    is_known: false,
                    notes: format!(
                        "ML imaging candidate + known therapy: Q={:.3} MeV",
                        img_q,
                    ),
                });
            }
    ...
    candidates.dedup_by(|a, b| {
        a.z == b.z && a.imaging_a == b.imaging_a && a.therapy_a == b.therapy_a
    });
    candidates
}
...
pub fn analyze_production_routes(
    ...
    match &isotope.production {
        ProductionRoute::NeutronCapture { target, target_z, target_n, .. } => {
        ...
        ProductionRoute::ProtonBombardment { target, target_z, target_n, .. } => {
            let target_pred = predictor.predict(*target_z, *target_n);
        ...
        ProductionRoute::Generator { parent, parent_z, parent_n, parent_half_life_s, .. } => {
        ...
        ProductionRoute::DeuteronBombardment { target, target_z, target_n, .. } => {
            let target_pred = predictor.predict(*target_z, *target_n);
        ...
        ProductionRoute::ProtonAlpha { target, target_z, target_n, .. } => {
            let target_pred = predictor.predict(*target_z, *target_n);
...
pub fn analyze_ac225_production(predictor: &MlMassPredictor) -> Vec<ProductionAnalysis> {
    ...
    let th229 = predictor.predict(90, 139);
    {
        ...
        routes.push(ProductionAnalysis {
            ...
            route_description: "Th-229(alpha)Ac-225 generator (ORNL stockpile, ~1.7 Ci worldwide)".into(),
            q_value_ml: q,
            q_uncertainty: q_unc,
            is_exothermic: q > 0.0,
    ...
    let ra226 = predictor.predict(88, 138);
    {
        ...
        routes.push(ProductionAnalysis {
            isotope_name: "Ac-225".into(),
            route_description: "Ra-226(p,2n)Ac-225 (TRIUMF/BNL, ~16 MeV protons, most promising scale-up)".into(),
            q_value_ml: q,
            q_uncertainty: q_unc,
            is_exothermic: q > 0.0,
            specific_activity_gbq_per_g: sa_ac225,
    ...
    let th232 = predictor.predict(90, 142);
    {
        ...
        routes.push(ProductionAnalysis {
            isotope_name: "Ac-225".into(),
            route_description: "Th-232(p,X)Ac-225 high-energy spallation (~1 GeV, LANL/CERN-ISOLDE)".into(),
            q_value_ml: q,
            q_uncertainty: q_unc,
    ...
    let ra225 = predictor.predict(88, 137);
    {
        ...
        routes.push(ProductionAnalysis {
            isotope_name: "Ac-225".into(),
            route_description: "Ra-225(beta-)Ac-225 (Ra-225 from Ra-226(gamma,n) photonuclear)".into(),
            q_value_ml: q,
            q_uncertainty: q_unc,
            is_exothermic: q > 0.0,
            specific_activity_gbq_per_g: sa_ac225,
    ...
    let u233 = predictor.predict(92, 141);
    {
        ...
        routes.push(ProductionAnalysis {
            isotope_name: "Ac-225".into(),
            route_description: "U-233(alpha)Th-229(alpha)..Ra-225(beta-)Ac-225 (natural chain, DOE stockpile)".into(),
            q_value_ml: q,
            q_uncertainty: q_unc,
            is_exothermic: q > 0.0,
            specific_activity_gbq_per_g: sa_ac225,
...
pub fn scan_novel_candidates(predictor: &MlMassPredictor) -> Vec<NovelCandidate> {
    ...
    for &(z, symbol, context) in medical_elements {
        ...
        for a in a_min..=a_max {
            ...
            let pred = predictor.predict(z, n);
            if pred.uncertainty > 3.0 { continue; } // Too uncertain
                    ...
                    if is_therapeutic_half_life_alpha(&hl_category) {
                        ...
                        candidates.push(NovelCandidate {
                            ...
                            rationale: format!(
                                ...
                                q_alpha, symbol, context,
                                z - 2, n - 2, daughter.binding_energy,
                            ),
    ...
    candidates.dedup_by(|a, b| {
        a.z == b.z && a.a == b.a && a.suggested_modality == b.suggested_modality
    });
...
mod tests {
    ...
    fn test_medical_isotope_database_completeness() {
        ...
        let required = [
            "Tc-99m", "I-131", "I-125", "Lu-177", "Ac-225", "Ra-223",
            "Y-90", "Ga-68", "Cu-64", "Cu-67", "F-18", "C-11", "N-13",
            "O-15", "Pb-212", "Bi-213", "At-211", "Re-186", "Re-188",
            "Sm-153", "Er-169", "Tb-161", "Gd-153", "Sr-89",
        ];
    ...
    fn test_specific_activity() {
        ...
        assert!(tc99m.specific_activity_gbq_per_g() > 1e6,
            "Tc-99m SA should be very high");
        assert!(f18.specific_activity_gbq_per_g() > tc99m.specific_activity_gbq_per_g(),
    ...
    fn test_decay_constants() {
        ...
        assert!((lambda - 3.206e-5).abs() < 1e-7,
            "Tc-99m decay constant: got {}, expected ~3.206e-5", lambda);

        let i131 = db.iter().find(|i| i.name == "I-131").unwrap();
        let lambda_i = i131.decay_constant();
        // lambda = ln(2) / (8.0207 * 86400) = 1.0e-6 s^-1
        assert!(lambda_i > 9e-7 && lambda_i < 1.1e-6,
            "I-131 decay constant: got {}", lambda_i);
    }
    ...
    fn test_theranostic_pairs_known() {
        ...
        for pair in &pairs {
            println!("{:<8} {:<14} {:<12} {:<14} {:<14} {}",
                ...
                if pair.is_known { "KNOWN" } else { "database-derived" },
            );
        }

        // Cu-64 (PET) / Cu-67 (therapy) must be found
        assert!(pairs.iter().any(|p| {
            p.element == "Cu" && p.imaging_a == 64 && p.therapy_a == 67
        }), "Cu-64/Cu-67 theranostic pair not found");

        assert!(!pairs.is_empty(), "Should find at least one theranostic pair");
    }
    ...
    fn test_novel_theranostic_candidates() {
        ...
        println!("\n=== ML-PREDICTED NOVEL THERANOSTIC CANDIDATES ({} found) ===", novel.len());
        println!("{:<8} {:<16} {:<12} {:<16} {:<14} {}",
            "Element", "Imaging", "Modality", "Therapy", "Modality", "Notes");
        println!("{}", "-".repeat(100));
    ...
    fn test_production_routes_ml() {
        ...
        for iso in &db {
            ...
            for route in &routes {
                println!("{:<10} {:<50} {:>10.3} {:>8.3} {:>6} {:>14.2e}",
                    route.isotope_name,
        ...
        assert!(tc_routes.iter().any(|r| r.equilibrium.is_some()),
    ...
    fn test_ac225_production_analysis() {
        ...
        println!("{:<65} {:>10} {:>8} {:>6} {:>12}",
            "Route", "Q (MeV)", "+/- MeV", "Exo?", "Equilibrium");
        println!("{}", "-".repeat(110));

        for route in &routes {
            println!("{:<65} {:>10.3} {:>8.3} {:>6} {:>12}",
                &route.route_description[..route.route_description.len().min(65)],
                route.q_value_ml,
                route.q_uncertainty,
                if route.is_exothermic { "yes" } else { "no" },
                route.equilibrium.map(|e| format!("{}", e)).unwrap_or_default(),
            );
        }
        ...
        let th229_route = routes.iter().find(|r| r.route_description.contains("Th-229")).unwrap();
    ...
    fn test_novel_candidate_scan() {
        ...
        println!("\n=== NOVEL ISOTOPE CANDIDATE SCAN ({} candidates) ===", candidates.len());
        ...
        assert!(!beta_therapy.is_empty(), "Should find beta therapy candidates");
    }
    ...
    fn test_separation_energies() {
        ...
        assert!(sn_o16 > 10.0 && sn_o16 < 25.0, "O-16 S_n out of range: {}", sn_o16);
        ...
        assert!(sp_ca48 > 5.0 && sp_ca48 < 25.0, "Ca-48 S_p out of range: {}", sp_ca48);
    ...
    fn test_q_value_functions() {
        ...
        assert!(q_fe56 > 4.0 && q_fe56 < 12.0,
            "Fe-56 (n,gamma) Q out of range: {}", q_fe56);
    ...
    fn test_generator_equilibrium_classification() {
        ...
        println!("\n=== GENERATOR SYSTEMS ===");
        println!("{:<12} {:<20} {:>14} {:>14} {:>10} {}",
            "Daughter", "Parent", "Parent t1/2", "Daughter t1/2", "Ratio", "Equilibrium");
        println!("{}", "-".repeat(90));

        for iso in &db {
            if let ProductionRoute::Generator { parent, parent_half_life_s, .. } = &iso.production {
        ...
        let tc99m = db.iter().find(|i| i.name == "Tc-99m").unwrap();
        if let ProductionRoute::Generator { parent_half_life_s, .. } = &tc99m.production {
            let ratio = parent_half_life_s / tc99m.half_life_s;
            assert!(ratio > 5.0 && ratio < 20.0,
                "Mo-99/Tc-99m ratio should be ~11, got {}", ratio);
        }
    }
