...
fn main() {
    ...
    println!("Sweeping Z=104-130, N=150-200 ({} isotopes)...\n",
        (130-104+1) * (200-150+1));
    ...
    println!("  Mean residual:   {:.2} MeV (systematic bias)", report.calibration.mean_residual);
    println!("  RMS residual:    {:.2} MeV (overall accuracy)", report.calibration.rms_residual);
    println!("  Max residual:    {:.2} MeV", report.calibration.max_residual);
    println!("  Within 1σ:       {:.0}%\n", report.calibration.fraction_within_1sigma * 100.0);

    // 4. Top discovery candidates
    println!("=== Top {} Discovery Candidates ===", report.candidates.len());
    println!("{:<6} {:<6} {:<6} | {:<8} | {:<8} | {:<12} | {}",
        "Z", "N", "A", "Interest", "σ (MeV)", "Shell (MeV)", "Reason");
    println!("{}", "-".repeat(90));

    for c in &report.candidates {
        println!("{:<6} {:<6} {:<6} | {:<8.3} | {:<8.1} | {:<12.1} | {}",
    ...
    let mut best_candidates: Vec<_> = report.candidates.iter()
    ...
    if best_candidates.is_empty() {
        ...
        for c in best_candidates.iter().take(10) {
            ...
            println!("  {} (Z={}, N={}, A={})", element_symbol(c.z), c.z, c.n, c.a);
    ...
    println!("Calibration: {} nuclei from AME2020", report.calibration.n_calibration);
    println!("RMS accuracy: {:.1} MeV (vs ~0.5 MeV for FRDM(2012))", report.calibration.rms_residual);
    println!();
    println!("LIMITATIONS:");
...
fn element_symbol(z: u16) -> &'static str {
    match z {
        ...
        116 => "Lv", 117 => "Ts", 118 => "Og", 119 => "E119",
        120 => "E120", 121 => "E121", 122 => "E122", 123 => "E123",
        124 => "E124", 125 => "E125", 126 => "E126", 127 => "E127",
        128 => "E128", 129 => "E129", 130 => "E130",
        _ => "?",
    }
}
