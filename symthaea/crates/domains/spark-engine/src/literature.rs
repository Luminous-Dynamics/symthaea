...
impl LiteratureDatabase {
    ...
    fn load_canonical(&mut self) {
        ...
        self.observations.push(Observation {
            ...
            effects: vec![ObservedEffect::Neutrons {
                rate_per_s: 1e3,
                energy_mev: Some(2.45),
            }],
            signal: SignalClaim {
        ...
        self.observations.push(Observation {
            ...
            effects: vec![ObservedEffect::ExcessHeat {
                power_w: 4.0,
                duration_s: 3600.0,
            }],
            signal: SignalClaim {
            ...
            notes: "Original 'cold fusion' claim. Controversial. Calorimetry questioned."
                .to_string(),
        });
        ...
        self.observations.push(Observation {
            ...
            effects: vec![ObservedEffect::ChargedParticles {
        ...
        self.observations.push(Observation {
            ...
            notes: "Confirms anomalously large screening in metals. Ti shows Ue = 363 eV."
                .to_string(),
        });
        ...
        self.observations.push(Observation {
            ...
            notes: "Meta-analysis claiming He-4/heat correlation = 24 MeV (D+D→He4 Q-value)."
                .to_string(),
        });
        ...
        self.observations.push(Observation {
            ...
            notes: "Controversial transmutation claims. Requires Cs or Sr surface layer."
                .to_string(),
        });
    ...
    pub fn with_neutrons(&self) -> Vec<&Observation> {
        self.observations
            ...
            .filter(|o| {
                o.effects
                    .iter()
                    .any(|e| matches!(e, ObservedEffect::Neutrons { .. }))
            })
            .collect()
    }
    ...
    pub fn with_excess_heat(&self) -> Vec<&Observation> {
        self.observations
            ...
            .filter(|o| {
                o.effects
                    .iter()
                    .any(|e| matches!(e, ObservedEffect::ExcessHeat { .. }))
            })
            .collect()
    }
