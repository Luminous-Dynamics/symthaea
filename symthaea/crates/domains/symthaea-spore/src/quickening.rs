...
pub const HARMONY_TONES: [HarmonyTone; 8] = [
    ...
    // 6. Sacred Reciprocity → A4 → Broca Weights
    HarmonyTone {
        harmony_name: "Sacred Reciprocity",
        frequency_hz: 440.00,
        note_name: "A4",
    ...
    fn subsystem_narration(subsystem: &InstallSubsystem) -> Vec<&'static str> {
        match subsystem {
            ...
            InstallSubsystem::BrocaWeights => vec![
                ...
                "Sacred Reciprocity sounds — A4, 440.00 Hz.",
            ],
...
mod tests {
    ...
    #[test]
    fn test_a4_is_440() {
        let a4 = &HARMONY_TONES[5]; // Sacred Reciprocity
    ...
    fn test_tone_for_subsystem() {
        ...
        assert_eq!(tone.harmony_name, "Sacred Reciprocity");
