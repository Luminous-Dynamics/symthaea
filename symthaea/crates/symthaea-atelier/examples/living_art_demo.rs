...
fn main() {
    ...
    let states: Vec<(&str, CognitiveSnapshot)> = vec![
        ("serene", CognitiveSnapshot {
            consciousness_level: 0.85, valence: 0.6, arousal: 0.25,
            dopamine: 0.5, serotonin: 0.8, noradrenaline: 0.15,
        ...
        ("turbulent", CognitiveSnapshot {
            consciousness_level: 0.55, valence: -0.7, arousal: 0.9,
            dopamine: 0.3, serotonin: 0.2, noradrenaline: 0.85,
        ...
        ("contemplative", CognitiveSnapshot {
            consciousness_level: 0.92, valence: 0.15, arousal: 0.1,
            dopamine: 0.35, serotonin: 0.75, noradrenaline: 0.08,
    ...
    for (name, snapshot) in &states {
        ...
        println!("  {name}: Ψ={:.2}, {} bytes → {}",
            snapshot.consciousness_level, html.len(), path.display());
    }
