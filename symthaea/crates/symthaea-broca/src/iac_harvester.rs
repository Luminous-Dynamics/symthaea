...
impl IaCHarvester {
    ...
    pub fn harvest_iac_repos(&mut self) {
        ...
        let examples = vec![
            ("kubernetes", "Deploy nginx with K8s Deployment", "apiVersion: apps/v1\nkind: Deployment\nmetadata:\n  name: nginx\nspec:\n  replicas: 3\n  template:\n    spec:\n      containers:\n      - name: nginx\n        image: nginx:1.14.2"),
            ("opentofu", "OpenTofu S3 bucket module", "resource \"aws_s3_bucket\" \"example\" {\n  bucket = var.bucket_name\n  tags = var.tags\n}\n\nmodule \"vpc\" {\n  source = \"terraform-aws-modules/vpc/aws\"\n}"),
            ("cdk", "AWS CDK TypeScript Lambda", "import * as cdk from 'aws-cdk-lib';\nimport * as lambda from 'aws-cdk-lib/aws-lambda';\n\nexport class MyStack extends cdk.Stack {\n  constructor(scope: cdk.App, id: string) {\n    super(scope, id);\n    new lambda.Function(this, 'MyFunc', { runtime: lambda.Runtime.NODEJS_18_X, code: lambda.Code.fromInline('exports.handler = async () => {}') });\n  }\n}"),
            ("bicep", "Azure storage with Bicep", "param location string = resourceGroup().location\nresource storage 'Microsoft.Storage/storageAccounts@2022-09-01' = {\n  name: 'mystorage'\n  location: location\n  sku: { name: 'Standard_LRS' }\n  kind: 'StorageV2'\n}"),
            ("crossplane", "Crossplane AWS RDS claim", "apiVersion: database.example.org/v1alpha1\nkind: RDSInstanceClaim\nmetadata:\n  name: my-db\nspec:\n  forProvider:\n    region: us-east-1\n    engine: postgres\n  compositionSelector:\n    matchLabels:\n      provider: aws"),
            ("argocd", "Argo CD App for microservice", "apiVersion: argoproj.io/v1alpha1\nkind: Application\nmetadata:\n  name: my-app\nspec:\n  project: default\n  source:\n    repoURL: https://github.com/myorg/myapp.git\n    targetRevision: HEAD\n    path: k8s\n  destination:\n    server: https://kubernetes.default.svc\n    namespace: default\n  syncPolicy:\n    automated: { prune: true, selfHeal: true }"),
            ("helm_values", "Helm values for prometheus", "replicaCount: 2\nimage:\n  repository: prom/prometheus\n  tag: v2.45.0\nservice:\n  type: ClusterIP\n  port: 9090\ningress:\n  enabled: true\n  hosts:\n    - host: prometheus.local\n      paths:\n        - path: /\n          pathType: Prefix"),
            ("ansible", "Ansible role for nginx install", "- hosts: webservers\n  become: yes\n  tasks:\n    - name: Install nginx\n      apt:\n        name: nginx\n        state: latest\n    - name: Start nginx\n      service:\n        name: nginx\n        state: started\n        enabled: yes"),
            ("cloudformation", "CFN EC2 with security group", "AWSTemplateFormatVersion: '2010-09-09'\nResources:\n  MyEC2:\n    Type: AWS::EC2::Instance\n    Properties:\n      ImageId: ami-0c55b159cbfafe1f0\n      InstanceType: t2.micro\n      SecurityGroups:\n        - !Ref MySG\n  MySG:\n    Type: AWS::EC2::SecurityGroup\n    Properties:\n      GroupDescription: Allow SSH\n      SecurityGroupIngress:\n        - IpProtocol: tcp\n          FromPort: 22\n          ToPort: 22\n          CidrIp: 0.0.0.0/0"),
            ("pulumi", "Pulumi TS AWS bucket", "import * as pulumi from '@pulumi/pulumi';\nimport * as aws from '@pulumi/aws';\nconst bucket = new aws.s3.Bucket('my-bucket');\nexport const bucketName = bucket.id;"),
        ];
