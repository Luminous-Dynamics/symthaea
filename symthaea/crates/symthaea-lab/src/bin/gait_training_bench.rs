...
use symthaea_humanoid::types::{HumanoidConfig, HumanoidState, HumanoidCommand};
...
async fn main() -> Result<()> {
    ...
    info!("🤖 Controller Initialized: {} Layers | {} Actuators", 
          config.network_layers, morphology.num_actuators());
