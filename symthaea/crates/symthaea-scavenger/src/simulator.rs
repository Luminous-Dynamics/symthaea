...
use crate::types::{
    ScavengerCommand, ScavengerOperatingMode, ScavengerState, BATTERY_RATIO, BLADE_BIND_RISK,
    CONTAINMENT_BREACH_RISK, CONTAMINATION_RISK, HOPPER_FILL, HUMAN_PROXIMITY, INCIDENT_RISK,
    JAM_RISK, QUARANTINE_LOAD_RATIO, SALVAGE_PURITY, SALVAGE_VALUE_RATE, SORTER_CLOG_RISK,
