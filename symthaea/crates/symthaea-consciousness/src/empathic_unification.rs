...
use crate::user_state_inference::{
    UserStateInference, ContextKind, ExplorationMode, TimePressure, RecentEvents,
};
use crate::language::emotional_core::{
    CoreEmotion, EmotionalState, EmpathyModel, EmpathyType, EmpathicCue,
    EmotionalRegulator, RegulationStrategy,
};
use crate::consciousness::consciousness_unification::{
    EmotionalBridge, UnifiedEmotionalState,
};
...
impl EmpathicUnification {
    ...
    fn update_emotional_bridge(&mut self, user_state: &UserEmotionalState, response: &EmpathicResponse) {
