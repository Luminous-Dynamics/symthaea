    ...
    vec![
        ...
        CaseStudy {
            ...
            claim: "Deuterium fusion at room temperature in a palladium electrode, \
                    producing excess heat and neutrons.".into(),
            outcome: "Never replicated. Gamow tunneling factor gives probability ~10^-2700 \
                     ...
                     DOE review panels (1989, 2004) found no convincing evidence.".into(),
            lesson: "The Gamow factor alone should have flagged this as E0. A structural \
                    ...
                    short by ~20 orders of magnitude.".into(),
            lem: LEMClassification { empirical: 0, normative: 0, materiality: 0 },
            equations: vec![
        ...
        CaseStudy {
            ...
            claim: "Inertial confinement fusion achieving energy gain Q > 1, with \
                    progressive improvements to Q > 4.".into(),
            outcome: "Verified. Q ratio progression: 1.54 (Dec 2022) → 1.89 → 2.36 → 4.13 \
                     ...
                     by peer review and multiple diagnostic systems.".into(),
            lesson: "Same physics as cold fusion (Gamow peak, Lawson criterion) but at \
                    ...
                    improvement from 1.5→4.1 shows reproducible, incremental verification.".into(),
            lem: LEMClassification { empirical: 4, normative: 3, materiality: 3 },
            equations: vec![
                "Lawson Criterion".into(),
        ...
        CaseStudy {
            ...
            claim: "Lead-substituted copper phosphate apatite (Pb₁₀₋ₓCuₓ(PO₄)₆O) \
                    is a room-temperature, ambient-pressure superconductor.".into(),
            outcome: "Debunked in 3 weeks — fastest verification cycle in modern physics. \
                     ...
                     replications failed globally.".into(),
            lesson: "The global replication effort was exemplary — hundreds of labs attempted \
                    ...
                    attempts in real-time would have provided the definitive timeline.".into(),
            lem: LEMClassification { empirical: 0, normative: 0, materiality: 0 },
            equations: vec![
        ...
        CaseStudy {
            ...
            claim: "Bilayer nickelate La₃Ni₂O₇ exhibits high-temperature \
                    ...
                    via compressive strain from substrates.".into(),
            outcome: "Progressively verified. Multiple groups reproduced Tc~80K. \
                     ...
                     confirm bulk superconductivity.".into(),
            lesson: "The anti-LK-99: same year, same domain, opposite trajectory. \
                    ...
                    complementary techniques. This is how E1→E3 progression should work.".into(),
            lem: LEMClassification { empirical: 3, normative: 2, materiality: 2 },
            equations: vec![
                "BCS Gap Equation".into(),
        ...
        CaseStudy {
            ...
            claim: "Organic semiconductor single-crystal transistors with extraordinary \
                    mobility, superconductivity in C₆₀, and single-molecule devices.".into(),
            outcome: "Fabricated data. Investigation revealed identical noise patterns \
                     ...
                     failed completely — no reviewer checked for duplicated noise.".into(),
            lesson: "Hash-based data provenance (BLAKE3 of raw datasets) would have \
                    ...
                    requiring data hashes at submission — prevents this class of fraud.".into(),
            lem: LEMClassification { empirical: 0, normative: 2, materiality: 0 },
            equations: vec![
                "Ohm Law".into(),
                "BCS Gap Equation".into(),
        ...
        CaseStudy {
            ...
            claim: "Room-temperature superconductivity in carbonaceous sulfur hydride \
                    (267K at 267 GPa) and nitrogen-doped lutetium hydride (294K at 1 GPa).".into(),
            outcome: "Same failure mode as Schön, 20 years later. Data manipulation \
                     ...
                     peer review failed again — identical class of fraud was not caught.".into(),
            lesson: "Two decades after Schön, the same fraud pattern succeeded through \
                    ...
                    data fabrication. Automated provenance verification is necessary.".into(),
            lem: LEMClassification { empirical: 0, normative: 2, materiality: 0 },
            equations: vec![
                "BCS Gap Equation".into(),
        ...
        CaseStudy {
            ...
            claim: "Direct detection of gravitational waves from a binary black hole \
                    merger, confirming general relativity's prediction.".into(),
            outcome: "Matched-filter SNR=24, false alarm rate < 1 per 203,000 years, \
                     ...
                     numerical relativity waveform templates. Nobel Prize 2017.".into(),
            lesson: "The gold standard for scientific verification: independent detectors, \
                    ...
                    reproducible methodology. Every element is E4.".into(),
            lem: LEMClassification { empirical: 4, normative: 3, materiality: 3 },
            equations: vec![
        ...
        CaseStudy {
            ...
            claim: "Discovery of a scalar boson at ~125 GeV consistent with the \
                    Standard Model Higgs mechanism.".into(),
            outcome: "Independently discovered by ATLAS and CMS (two separate detectors, \
                     ...
                     confirmed. Combined significance: 5.9σ. Nobel Prize 2013.".into(),
            lesson: "Independent replication at the highest standard: two experiments \
                    ...
                    (network consensus) looks like in practice.".into(),
            lem: LEMClassification { empirical: 4, normative: 3, materiality: 3 },
            equations: vec![
        ...
        CaseStudy {
            ...
            claim: "The expansion rate of the universe measured locally (H₀ ≈ 73 km/s/Mpc, \
                    ...
                    Planck CMB) at 5σ significance.".into(),
            outcome: "Unresolved. Both measurements are independently E4-verified. JWST \
                     ...
                     has been definitively established.".into(),
            lesson: "Both sides are right by their own methods. This is what a genuine \
                    ...
                    consensus that the tension is real, but no N3 resolution.".into(),
            lem: LEMClassification { empirical: 4, normative: 2, materiality: 3 },
            equations: vec![
        ...
        CaseStudy {
            ...
            claim: "Microwave cavity thruster produces thrust without propellant, \
                    violating conservation of momentum.".into(),
            outcome: "Dead. TU Dresden (2021) found all measured thrust was from \
                     ...
                     When properly shielded, thrust = 0 within measurement error.".into(),
            lesson: "Conservation law violation should be an automatic epistemic red \
                    ...
                    or conservation of momentum.".into(),
            lem: LEMClassification { empirical: 0, normative: 0, materiality: 0 },
            equations: vec![
                "Newton Second Law".into(),
                "Angular Momentum".into(),
            ],
...
mod tests {
    ...
    fn test_equations_reference_catalog() {
        ...
        for study in all_case_studies() {
            assert!(!study.equations.is_empty(), "Study {} has no equations", study.id);
        }
    }
