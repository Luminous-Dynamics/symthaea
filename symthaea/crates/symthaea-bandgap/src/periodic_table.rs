...
static ELEMENTS: [Element; 103] = [
    ...
    el(65,  "Tb", "Terbium",        1.10, 175.0,   5.864,  0.500, 158.925,   0, 6, 2),
    ...
    el(86,  "Rn", "Radon",          2.20, 120.0,  10.749,  0.000, 222.0,    18, 6, 8),
    // ---- Period 7 ----
    ...
    el(95,  "Am", "Americium",      1.13, 175.0,   5.974,  0.000, 243.0,     0, 7, 2),
    el(96,  "Cm", "Curium",         1.28, 176.0,   5.991,  0.000, 247.0,     0, 7, 2),
