...
impl Default for JointTrajectory {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::JointTrajectory::default(),
        )
    }
}
        ...
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                points: msg
                    ...
                    .into_iter()
                    .map(|elem| {
                        super::msg::JointTrajectoryPoint::into_rmw_message(std::borrow::Cow::Owned(
                            elem,
                        ))
                        .into_owned()
                    })
            ...
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                points: msg
                    ...
                    .iter()
                    .map(|elem| {
                        super::msg::JointTrajectoryPoint::into_rmw_message(
...
impl Default for JointTrajectoryPoint {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::JointTrajectoryPoint::default(),
        )
    }
}
...
impl rosidl_runtime_rs::Message for JointTrajectoryPoint {
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                time_from_start: builtin_interfaces::msg::Duration::into_rmw_message(
                    std::borrow::Cow::Owned(msg.time_from_start),
                )
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                time_from_start: builtin_interfaces::msg::Duration::into_rmw_message(
                    std::borrow::Cow::Borrowed(&msg.time_from_start),
                )
                .into_owned(),
            }),
        }
    ...
    fn from_rmw_message(msg: Self::RmwMsg) -> Self {
        Self {
            positions: msg.positions.into_iter().collect(),
            velocities: msg.velocities.into_iter().collect(),
            accelerations: msg.accelerations.into_iter().collect(),
            effort: msg.effort.into_iter().collect(),
            time_from_start: builtin_interfaces::msg::Duration::from_rmw_message(
                msg.time_from_start,
            ),
        }
    }
...
impl Default for MultiDOFJointTrajectory {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::MultiDOFJointTrajectory::default(),
        )
    }
}
        ...
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                points: msg
                    ...
                    .into_iter()
                    .map(|elem| {
                        super::msg::MultiDOFJointTrajectoryPoint::into_rmw_message(
...
impl Default for MultiDOFJointTrajectoryPoint {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::MultiDOFJointTrajectoryPoint::default(),
        )
    }
}
