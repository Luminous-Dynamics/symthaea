    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                linear: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Owned(msg.linear))
                    .into_owned(),
                angular: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Owned(
                    msg.angular,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                linear: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.linear,
                ))
                .into_owned(),
                angular: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.angular,
                ))
                .into_owned(),
            }),
...
impl Default for AccelStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::AccelStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                accel: super::msg::Accel::into_rmw_message(std::borrow::Cow::Owned(msg.accel))
                    .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                accel: super::msg::Accel::into_rmw_message(std::borrow::Cow::Borrowed(&msg.accel))
                    .into_owned(),
            }),
        }
    }
...
impl Default for AccelWithCovariance {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::AccelWithCovariance::default(),
        )
    }
}
...
impl Default for AccelWithCovarianceStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::AccelWithCovarianceStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                accel: super::msg::AccelWithCovariance::into_rmw_message(std::borrow::Cow::Owned(
                    msg.accel,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                accel: super::msg::AccelWithCovariance::into_rmw_message(
                    std::borrow::Cow::Borrowed(&msg.accel),
                )
                .into_owned(),
            }),
        }
...
impl rosidl_runtime_rs::Message for Inertia {
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                m: msg.m,
                com: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Owned(msg.com))
                    .into_owned(),
                ixx: msg.ixx,
                ixy: msg.ixy,
                ixz: msg.ixz,
            ...
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                m: msg.m,
                com: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Borrowed(&msg.com))
                    .into_owned(),
                ixx: msg.ixx,
                ixy: msg.ixy,
                ixz: msg.ixz,
...
impl Default for InertiaStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::InertiaStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                inertia: super::msg::Inertia::into_rmw_message(std::borrow::Cow::Owned(
                    msg.inertia,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                inertia: super::msg::Inertia::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.inertia,
                ))
                .into_owned(),
            }),
...
impl Default for PointStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::PointStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                point: super::msg::Point::into_rmw_message(std::borrow::Cow::Owned(msg.point))
                    .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(
                ...
                .into_owned(),
                point: super::msg::Point::into_rmw_message(std::borrow::Cow::Borrowed(&msg.point))
                    .into_owned(),
            }),
        }
    }
        ...
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                points: msg
                    ...
                    .into_iter()
                    .map(|elem| {
                        super::msg::Point32::into_rmw_message(std::borrow::Cow::Owned(elem))
                            .into_owned()
                    })
                    .collect(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                points: msg
                    ...
                    .iter()
                    .map(|elem| {
                        super::msg::Point32::into_rmw_message(std::borrow::Cow::Borrowed(elem))
                            .into_owned()
                    })
                    .collect(),
            }),
...
impl Default for PolygonInstance {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::PolygonInstance::default(),
        )
    }
}
...
impl rosidl_runtime_rs::Message for PolygonInstance {
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                polygon: super::msg::Polygon::into_rmw_message(std::borrow::Cow::Owned(
                    msg.polygon,
                ))
                .into_owned(),
                id: msg.id,
            ...
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                polygon: super::msg::Polygon::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.polygon,
                ))
                .into_owned(),
                id: msg.id,
...
impl Default for PolygonInstanceStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::PolygonInstanceStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                polygon: super::msg::PolygonInstance::into_rmw_message(std::borrow::Cow::Owned(
                    msg.polygon,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                polygon: super::msg::PolygonInstance::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.polygon,
                ))
                .into_owned(),
            }),
...
impl Default for PolygonStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::PolygonStamped::default(),
        )
    }
}
...
impl rosidl_runtime_rs::Message for Pose {
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                position: super::msg::Point::into_rmw_message(std::borrow::Cow::Owned(
                    msg.position,
                ))
                .into_owned(),
                orientation: super::msg::Quaternion::into_rmw_message(std::borrow::Cow::Owned(
                    msg.orientation,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                position: super::msg::Point::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.position,
                ))
                .into_owned(),
                orientation: super::msg::Quaternion::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.orientation,
                ))
                .into_owned(),
            }),
        ...
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                poses: msg
                    ...
                    .into_iter()
                    .map(|elem| {
                        super::msg::Pose::into_rmw_message(std::borrow::Cow::Owned(elem))
                            .into_owned()
                    })
                    .collect(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                poses: msg
                    ...
                    .iter()
                    .map(|elem| {
                        super::msg::Pose::into_rmw_message(std::borrow::Cow::Borrowed(elem))
                            .into_owned()
                    })
                    .collect(),
            }),
...
impl Default for PoseStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::PoseStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                pose: super::msg::Pose::into_rmw_message(std::borrow::Cow::Owned(msg.pose))
                    .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(
                ...
                .into_owned(),
                pose: super::msg::Pose::into_rmw_message(std::borrow::Cow::Borrowed(&msg.pose))
                    .into_owned(),
            }),
        }
    }
...
impl Default for PoseWithCovariance {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::PoseWithCovariance::default(),
        )
    }
}
...
impl Default for PoseWithCovarianceStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::PoseWithCovarianceStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                pose: super::msg::PoseWithCovariance::into_rmw_message(std::borrow::Cow::Owned(
                    msg.pose,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                pose: super::msg::PoseWithCovariance::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.pose,
                ))
                .into_owned(),
            }),
...
impl Default for Quaternion {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::Quaternion::default(),
        )
    }
}
...
impl Default for QuaternionStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::QuaternionStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                quaternion: super::msg::Quaternion::into_rmw_message(std::borrow::Cow::Owned(
                    msg.quaternion,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                quaternion: super::msg::Quaternion::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.quaternion,
                ))
                .into_owned(),
            }),
...
impl rosidl_runtime_rs::Message for Transform {
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                translation: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Owned(
                    msg.translation,
                ))
                .into_owned(),
                rotation: super::msg::Quaternion::into_rmw_message(std::borrow::Cow::Owned(
                    msg.rotation,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                translation: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.translation,
                ))
                .into_owned(),
                rotation: super::msg::Quaternion::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.rotation,
                ))
                .into_owned(),
            }),
...
impl Default for TransformStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::TransformStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                transform: super::msg::Transform::into_rmw_message(std::borrow::Cow::Owned(
                    msg.transform,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                child_frame_id: msg.child_frame_id.as_str().into(),
                transform: super::msg::Transform::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.transform,
                ))
                .into_owned(),
            }),
...
impl Default for TwistStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::TwistStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                twist: super::msg::Twist::into_rmw_message(std::borrow::Cow::Owned(msg.twist))
                    .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(
                ...
                .into_owned(),
                twist: super::msg::Twist::into_rmw_message(std::borrow::Cow::Borrowed(&msg.twist))
                    .into_owned(),
            }),
        }
    }
...
impl Default for TwistWithCovariance {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::TwistWithCovariance::default(),
        )
    }
}
...
impl Default for TwistWithCovarianceStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::TwistWithCovarianceStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                twist: super::msg::TwistWithCovariance::into_rmw_message(std::borrow::Cow::Owned(
                    msg.twist,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                twist: super::msg::TwistWithCovariance::into_rmw_message(
                    std::borrow::Cow::Borrowed(&msg.twist),
                )
                .into_owned(),
            }),
        }
...
impl Default for Vector3Stamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::Vector3Stamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                vector: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Owned(msg.vector))
                    .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(
                ...
                .into_owned(),
                vector: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.vector,
                ))
                .into_owned(),
            }),
...
impl Default for VelocityStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::VelocityStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                velocity: super::msg::Twist::into_rmw_message(std::borrow::Cow::Owned(
                    msg.velocity,
                ))
                .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                body_frame_id: msg.body_frame_id.as_str().into(),
                reference_frame_id: msg.reference_frame_id.as_str().into(),
                velocity: super::msg::Twist::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.velocity,
                ))
                .into_owned(),
            }),
...
impl rosidl_runtime_rs::Message for Wrench {
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                force: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Owned(msg.force))
                    .into_owned(),
                torque: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Owned(msg.torque))
                    .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                force: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.force,
                ))
                .into_owned(),
                torque: super::msg::Vector3::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.torque,
                ))
                .into_owned(),
            }),
...
impl Default for WrenchStamped {
    fn default() -> Self {
        <Self as rosidl_runtime_rs::Message>::from_rmw_message(
            super::msg::rmw::WrenchStamped::default(),
        )
    }
}
    ...
    fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
        match msg_cow {
            std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                ...
                .into_owned(),
                wrench: super::msg::Wrench::into_rmw_message(std::borrow::Cow::Owned(msg.wrench))
                    .into_owned(),
            }),
            std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
                header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(
                ...
                .into_owned(),
                wrench: super::msg::Wrench::into_rmw_message(std::borrow::Cow::Borrowed(
                    &msg.wrench,
                ))
                .into_owned(),
            }),
