...
pub fn predict_stability(
    ...
    let mixing_entropy: f64 = -k_b_ev * elements
        .iter()
...
fn estimate_formation_energy(elements: &[(u16, f64)]) -> f64 {
    ...
    let electroneg = |z: u16| -> f64 {
        match z {
            1 => 2.20, 2 => 0.0, 3 => 0.98, 4 => 1.57, 5 => 2.04,
            6 => 2.55, 7 => 3.04, 8 => 3.44, 11 => 0.93, 12 => 1.31,
            13 => 1.61, 14 => 1.90, 15 => 2.19, 16 => 2.58, 17 => 3.16,
            19 => 0.82, 20 => 1.00, 22 => 1.54, 24 => 1.66, 25 => 1.55,
            26 => 1.83, 27 => 1.88, 28 => 1.91, 29 => 1.90, 30 => 1.65,
            32 => 2.01, 33 => 2.18, 34 => 2.55, 42 => 2.16, 47 => 1.93,
            48 => 1.69, 50 => 1.96, 56 => 0.89, 74 => 2.36, 78 => 2.28,
            79 => 2.54, 82 => 2.33, 83 => 2.02, 92 => 1.38,
...
fn element_symbol(z: u16) -> &'static str {
    match z {
        ...
        16 => "S", 17 => "Cl", 20 => "Ca", 22 => "Ti", 24 => "Cr",
        26 => "Fe", 28 => "Ni", 29 => "Cu", 30 => "Zn",
        47 => "Ag", 48 => "Cd", 50 => "Sn", 74 => "W", 78 => "Pt",
        79 => "Au", 82 => "Pb", 83 => "Bi", 92 => "U",
        _ => "X",
    }
}
