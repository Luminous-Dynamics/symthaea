...
// Path C re-exports
pub use literature::{LiteratureDatabase, Observation, Credibility, HostMaterial as LitHostMaterial, TriggerMethod};
pub use hypothesis_models::{HypothesisType, HypothesisComparison, HotSpotModel, PhononCascadeModel, SuperScreeningModel};
pub use rate_gap::{RateGapCalculator, RateGapAnalysis, ExperimentalConditions};
pub use experimental_design::{ExperimentDesigner, ExperimentDesign, ExperimentalProgram};
...
pub mod prelude {
    ...
    pub use crate::anomaly::{AnomalyAnalysis, AnomalyHypothesis, AnomalyGap};
    ...
    pub use crate::hypothesis_models::{HypothesisType, HypothesisComparison, HotSpotModel, PhononCascadeModel, SuperScreeningModel};
    pub use crate::rate_gap::{RateGapCalculator, RateGapAnalysis};
    pub use crate::experimental_design::{ExperimentDesigner, ExperimentDesign, ExperimentalProgram};

    pub use crate::constants;
    pub use crate::{SparkError, Result};
}
