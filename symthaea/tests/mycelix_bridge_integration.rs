...
//!
//! This test intentionally does not compile in Symthaea's main workspace. The
//! Holochain-bound `mycelix_bridge_common` crate pins serde for WASM
//! determinism and must be tested from the isolated Mycelix/Holochain workspace.
