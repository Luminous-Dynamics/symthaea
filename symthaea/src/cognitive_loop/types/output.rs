...
pub struct CycleResult {
    ...
    /// Text generated by the language system this cycle, if any.
    /// Populated by full Broca (when `ssm_language` enabled) or BrocaLite fallback.
    /// `None` when consciousness is too low or no novel content triggered generation.
    pub language_output: Option<String>,

    /// Source tier of the language output: "broca_lite", "broca", or "llm".
    /// Allows consumers to distinguish structured grammar from LLM translation.
