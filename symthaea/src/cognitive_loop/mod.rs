...
// FlowState, FlowTemporalSummary, ResponseStrategy moved to flow.rs
// CycleLearningResult, ClosedLearningLoop moved to learning.rs
// EpisodicMemory, EpisodicMemoryBridge, MemoryBridgeStats moved to memory_bridge.rs
// CognitiveGoal, GoalSystemBridge, WorldModelBridge moved to goal_world.rs
// Drives (EmotionContagion, CuriosityDrive, SelfReflection) moved to drives.rs
// Routing (CognitiveDepth, ThalamicRouter, ActiveInferenceBridge) moved to routing.rs
// ConsciousnessSnapshot moved to snapshot.rs

// ══════════════ The types below remain in mod.rs ══════════════
