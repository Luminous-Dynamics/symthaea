...
use super::{
    ActionHint, AdaptiveBehavior, ClosedLearningLoop, CognitiveLoopService, CycleLearningResult,
    CycleResult, CycleUrgency, EpisodicMemoryBridge, Experience, LoopStats, MoralJudgmentSummary,
    ResponseStrategy,
};
...
// ═══════════════════════════════════════════════════════════════════════════════
// Phase 5: Free functions for parallel post-processing branches
...
pub(super) struct EpisodicLearningContext<'a> {
...
pub(super) fn run_stability_regime(
...
pub(super) fn parallel_semantic_causal(
...
#[allow(clippy::too_many_arguments)]
pub(super) fn parallel_episodic_learning(
