...
impl CognitiveLoopService {
    ...
    pub(super) fn phase_output(
        ...
        metadata.modulation.flow_lr_boost =
            self.flow_state.in_flow && self.flow_state.intensity > FLOW_INTENSITY_TELEMETRY_THRESHOLD;
        ...
        metadata.modulation.pipeline_consciousness_gated = {
            ...
            (pc > super::thresholds::PIPELINE_CONSCIOUSNESS_HIGH_THRESHOLD as f64 || (pc < super::thresholds::PIPELINE_CONSCIOUSNESS_LOW_THRESHOLD as f64 && pc > 0.0)) && self.stats.total_cycles > 15
        };
