...
impl SensoriMotorExecution {
    ...
    pub fn new(
        ...
        >,
        #[cfg(any(feature = "humanoid", feature = "helicopter", feature = "flight", feature = "vehicle", feature = "auv", feature = "manipulator", feature = "exoskeleton", feature = "surgical", feature = "orbital", feature = "quadruped", feature = "phone"))] embodiment_telemetry: super::motor_bridge::EmbodimentTelemetry,
    ) -> Self {
        Self {
            vision_sensory,
            motor_rendering,
