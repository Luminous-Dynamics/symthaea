...
//! Cross-domain bridge: Nuclear Safeguards -> Safety Agent
//!
//! Maps safeguards free energy into `SafetyMetrics` so the Safety Agent
//! can monitor nuclear safeguards through the same NRC-grade framework.
//!
//! # Feature gates
//!
...
/// Adapter that translates safeguards free energy into Safety Agent inputs.
pub struct SafeguardsSafetyAdapter {
    agent: SafetyAgent,
    cycle: usize,
}

impl SafeguardsSafetyAdapter {
    pub fn new() -> Self {
        Self {
    ...
    /// Assess safeguards safety directly from free energy.
    ...
    /// Gate a safeguards operation based on free energy.
...
impl Default for SafeguardsSafetyAdapter {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_healthy_safeguards_maps_to_green() {
        let mut adapter = SafeguardsSafetyAdapter::new();
    ...
    fn test_gate_blocks_risky_at_orange() {
        let adapter = SafeguardsSafetyAdapter::new();
