...
impl Harmony {
    ...
    pub fn base_weight(&self) -> f32 {
        match self {
            Self::ResonantCoherence => 0.20,
            Self::PanSentientFlourishing => 0.20,
            Self::IntegralWisdom => 0.15,
            Self::InfinitePlay => 0.10,
            Self::UniversalInterconnectedness => 0.15,
            Self::SacredReciprocity => 0.10,
            Self::EvolutionaryProgression => 0.10,
        }
    }
    ...
    pub fn epistemic_mode(&self) -> &'static str {
        match self {
            ...
            Self::InfinitePlay => "Creative-Knowing",
            Self::UniversalInterconnectedness => "Relational-Knowing",
            Self::SacredReciprocity => "Exchange-Knowing",
            Self::EvolutionaryProgression => "Developmental-Knowing",
        }
    }
    ...
    pub fn focus_question(&self) -> &'static str {
        match self {
            Self::ResonantCoherence => "How do the parts relate?",
            Self::PanSentientFlourishing => "Who is affected?",
            Self::IntegralWisdom => "What is verifiable?",
            Self::InfinitePlay => "What possibilities exist?",
            Self::UniversalInterconnectedness => "What connections exist?",
            Self::SacredReciprocity => "What flows back?",
            Self::EvolutionaryProgression => "What is emerging?",
        }
    }
    ...
    pub fn code(&self) -> &'static str {
        match self {
            Self::ResonantCoherence => "RC",
            Self::PanSentientFlourishing => "PSF",
            Self::IntegralWisdom => "IW",
            Self::InfinitePlay => "IP",
            Self::UniversalInterconnectedness => "UI",
            Self::SacredReciprocity => "SR",
            Self::EvolutionaryProgression => "EP",
        }
    }
