...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let broadcast_cmd = "Share the 'Selective Similarity' optimization with the swarm topic 'optimization'.";
    ...
    let payload = b"Optimize LTC neurons using linear attention kernels to reduce complexity to O(N).";
