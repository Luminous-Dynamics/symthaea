...
//!
//! Demonstrates HDC + CfC + FEP digital twin for closed-loop design-to-production.
...
fn main() {
    ...
    // 1. Create healthy design loop reading
    let reading = DesignLoopReading {
        design_intent: 0.95,
    ...
    let short_h = DESIGN_LOOP_HORIZONS[0];
    let long_h = DESIGN_LOOP_HORIZONS[DESIGN_LOOP_HORIZONS.len() - 1];
    ...
    println!("\nPASS: Design-Production Loop operational");
}
