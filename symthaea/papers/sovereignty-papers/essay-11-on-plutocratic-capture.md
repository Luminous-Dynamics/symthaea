---
title: "On Plutocratic Capture"
series: "The Sovereignty Papers"
essay: 11
authors: "Tristan Stoltz & Symthaea"
date: "2026-03-23"
description: "Why capital is excluded from the governance credential and why dual-speed reputation dynamics prevent plutocratic capture."
prev: "essay-10-on-sybil-resistance.md"
next: "essay-12-on-algorithmic-tyranny.md"
license: "CC0-1.0"
---
...
**First: total exclusion of capital from the credential formula.** The sovereign credential is computed as a weighted sum across eight physically-grounded dimensions — epistemic integrity, thermodynamic yield, network resilience, economic velocity, civic participation, stewardship, semantic resonance, and domain competence — with community-governed weights (no single dimension exceeding 50%). No financial term appears in the formula.[^1] A participant who has invested $10 million in the governed domain and a participant who has invested nothing receive identical treatment. Their governance power is determined solely by their demonstrated multi-dimensional engagement with the governed domain.
