...
\textbf{Lines of code:} ${\sim}346$K main crate (24 workspace crates, 17 extracted sub-crates), ${\sim}3{,}700$ core FEP, ${\sim}17{,}700$ mathematical foundations, ${\sim}8{,}100$ code understanding\par
\textbf{Test suite:} 7,100+ tests (2,751 main lib + 3,473 core lib + ${\sim}870$ integration/sub-crate), 40 ignored, 0 failures\par
