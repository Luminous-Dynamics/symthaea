...
\textbf{Consciousness equation dimensionality.} In text-only mode, 2 of 4 inputs to the consciousness level computation (temporal coherence and flow intensity) have zero variance, making the equation effectively 1-dimensional. With sensory input via \texttt{cycle\_with\_hv()}, all inputs are exercised and consciousness becomes modality-agnostic. This finding (discovered during systematic ablation testing) identifies the exact architectural boundary between text-processing and multi-modal consciousness measurement.
