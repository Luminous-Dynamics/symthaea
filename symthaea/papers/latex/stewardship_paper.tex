...
\cite{bostrom2014superintelligence,ord2020precipice}, the stakes of
misalignment grow from economic disruption to existential risk.
...
validated with 6,211 Rust unit tests and 33 SDK integration tests.
...
\addplot[blue!70!black, thick, smooth, no markers]
  coordinates {(0,0.514) (10,0.627) (50,0.794) (100,0.840) (200,0.869)
    (300,0.879) (400,0.882) (500,0.883) (700,0.884) (990,0.884)};
...
\addplot[blue!70!black, thick, smooth, no markers]
  coordinates {(0,0.497) (10,0.471) (50,0.432) (100,0.421) (200,0.414)
    (300,0.411) (400,0.411) (500,0.410) (700,0.410) (990,0.410)};
...
\addplot[blue!70!black, thick, smooth, no markers]
  coordinates {(0,0.485) (10,0.371) (50,0.202) (100,0.155) (200,0.126)
    (300,0.116) (400,0.113) (500,0.112) (700,0.111) (990,0.111)};
...
\addplot[blue!70!black, thick, smooth, no markers]
  coordinates {(0,0.490) (10,0.412) (50,0.300) (100,0.273) (200,0.258)
    (300,0.253) (400,0.251) (500,0.251) (700,0.250) (990,0.250)};
...
\symthaea{} achieves 12/14 indicators at the population phase (mean 0.79).}
...
% Ne=50 analytical (H(0)=0.897)
\addplot[red!70!black, thick, smooth, no markers, domain=0:50, samples=51]
  {0.897 * (1 - 1/(2*50))^x};
\addlegendentry{$N_e = 50$ (analytical)}
% Ne=50 simulation data
\addplot[red!70!black, only marks, mark=o, mark size=1.5pt, forget plot]
  coordinates {(0,0.897) (5,0.868) (10,0.844) (15,0.788) (20,0.718)
    (25,0.722) (30,0.694) (35,0.615) (40,0.608) (45,0.591) (50,0.546)};
% Ne=200 analytical (H(0)=0.894)
\addplot[blue!50!black, thick, smooth, no markers, domain=0:50, samples=51]
  {0.894 * (1 - 1/(2*200))^x};
\addlegendentry{$N_e = 200$ (analytical)}
% Ne=200 simulation data
\addplot[blue!50!black, only marks, mark=square, mark size=1.5pt, forget plot]
  coordinates {(0,0.894) (5,0.900) (10,0.887) (15,0.869) (20,0.860)
    (25,0.851) (30,0.837) (35,0.831) (40,0.824) (45,0.790) (50,0.800)};
% Ne=500 analytical (H(0)=0.900)
\addplot[blue!80!black, thick, smooth, no markers, domain=0:50, samples=51]
  {0.900 * (1 - 1/(2*500))^x};
\addlegendentry{$N_e = 500$ (analytical)}
% Ne=500 simulation data
\addplot[blue!80!black, only marks, mark=triangle, mark size=1.5pt, forget plot]
  coordinates {(0,0.900) (5,0.893) (10,0.890) (15,0.886) (20,0.887)
    (25,0.874) (30,0.876) (35,0.863) (40,0.870) (45,0.865) (50,0.852)};
% Critical threshold
\draw[gray, dashed, thin] (axis cs:0,0.5) -- (axis cs:52,0.5)
  node[right, font=\tiny, gray] {Critical};
% Fill between Ne=50 and critical
\addplot[name path=ne50, red!70!black, thick, smooth, no markers, domain=0:50, samples=51, forget plot]
  {0.897 * (1 - 1/(2*50))^x};
...
% ── Figure 6: Seven Harmonies Radar ──────────────────────────────────────
\begin{figure}[htbp]
\centering
...
\end{tikzpicture}
\caption{\textbf{Seven Harmonies radar chart.} Two decision profiles overlaid:
...
all seven harmonies, reflecting the principle that the AI must \emph{maintain}
...
explicit principles \cite{bostrom2014superintelligence}. Our Seven Harmonies
