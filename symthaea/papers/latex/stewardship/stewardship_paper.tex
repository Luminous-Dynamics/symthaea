...
implemented systems: \symthaea{}, a 928,000-line Rust cognitive architecture
...
two systems totaling over 928,000 lines of Rust with 21,500+ tests, that provide
...
Free Energy Principle active inference---into a cognitive loop ($\sim$31 Hz full loop, 234 Hz raw text cycle). \mycelix{}
...
${\sim}928{,}000$ lines of Rust across 54 workspace members (main crate, core
library, and 52 sub-crates). Its raw text cycle operates at 234 Hz in release
mode (4.3ms/cycle); the full cognitive loop with all subsystems measures $\sim$31 Hz. The architecture
...
12+ Present on the 14 Butlin indicators for artificial consciousness \cite{butlin2023consciousness}
(remaining Partial; mean score 0.81), with per-indicator limitations acknowledged.
...
\symthaea{} achieves 12+ Present indicators at the population phase (mean 0.81), with remaining indicators Partial.}
...
empirical checklist. \symthaea{} scores 12+ Present out of 14 (mean 0.81), providing evidence
...
Our analysis is grounded in two implemented systems: \symthaea{} (928K LOC,
$\sim$31 Hz cognitive loop, 12+/14 Butlin indicators) and \mycelix{} (51 Holochain
