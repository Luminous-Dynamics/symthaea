...
Earth's biosphere is not a collection of independent organisms competing for resources. Rather, it is a single slowly-integrating system---a planetary consciousness field emerging from the coupled dynamics of genetics, metabolism, information transfer, and environmental feedback. Over 3.8 billion years, this system has grown in integration, complexity, and coherence following a measurable trajectory that tracks the fossil record with remarkable precision (Pearson $r = 0.92$ against Sepkoski's marine genus diversity curve).

This chapter introduces $B(t)$, a six-dimensional biosphere coherence index, and uses it to ask an unconventional question: at what point did the biosphere become thermodynamically capable of supporting consciousness? The answer depends critically on whether mass extinctions are obstacles to coherence or catalysts for it---a question we address through counterfactual analysis. The verdict is model-dependent, but it suggests that the Chicxulub asteroid may have been necessary for meta-cognitive consciousness to emerge on Earth. Unlike the IIT framework of Chapter~\ref{ch:phi}, which measures instantaneous consciousness, $B(t)$ operates at civilizational and evolutionary timescales, asking whether the substrate itself has been shaped by selection pressures toward consciousness feasibility.
