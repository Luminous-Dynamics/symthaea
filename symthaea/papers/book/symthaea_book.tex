...
The system is implemented in approximately 1.1 million lines of Rust code across 93 workspace members (86 sub-crates), with over 36,500 automated tests. Key sub-crates include:
...
\begin{itemize}
  ...
  \item \texttt{symthaea-psych-bench}: Cognitive benchmark suite (143 benchmarks, 27 domains)
...
% ========================================================================
\chapter{Psych-Bench: 143 Benchmarks, 27 Domains}
\label{ch:psychbench}
% ========================================================================
