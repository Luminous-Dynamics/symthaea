...
The system is implemented in approximately 1.1 million lines of Rust code across 93 workspace members (86 sub-crates), with over 24,800 automated tests. Key sub-crates include:
...
\begin{itemize}
  ...
  \item \texttt{symthaea-psych-bench}: Cognitive benchmark suite (164+ benchmarks, 30 domains)
...
3 & Holon & Desktop/Server & NixOS, 93 crates & ${\sim}$24,800 \\
...
Architecture & Automated tests & 24,800+ & \ref{ch:introduction} \\
