//! # CGC (Civic Gifting Credits) Integration Tests
//!
...
mod allocation_tests {
    ...
    async fn test_allocation_non_accumulation() {
        ...
        assert!(allocation.cycle_end.as_micros() > allocation.cycle_start.as_micros(),
...
mod gifting_tests {
    ...
    async fn test_basic_gift() {
        ...
        println!("  - Gift created: {} CGC from {} to {}", gift.amount, gift.giver_did, gift.receiver_did);
        ...
        match result {
            Err(e) => {
                ...
                assert!(
                    ...
                    "Should reject gift exceeding allocation, got: {}", error_msg
                );
        ...
        match result {
            Err(e) => {
                ...
                assert!(
                    ...
                    "Should reject self-gift, got: {}", error_msg
                );
...
mod high_activity_tests {
    ...
    async fn test_high_volume_flag() {
        ...
        assert_eq!(HIGH_ACTIVITY_THRESHOLD_VOLUME, 100,
            "High activity volume threshold should be 100");

        println!("  - HIGH_ACTIVITY_THRESHOLD_VOLUME: {}", HIGH_ACTIVITY_THRESHOLD_VOLUME);
    ...
    async fn test_concentrated_source_flag() {
        ...
        assert_eq!(HIGH_ACTIVITY_THRESHOLD_SINGLE_SOURCE, 50,
            "High activity single source threshold should be 50");

        println!("  - HIGH_ACTIVITY_THRESHOLD_SINGLE_SOURCE: {}", HIGH_ACTIVITY_THRESHOLD_SINGLE_SOURCE);
...
mod recognition_summary_tests {
    ...
    async fn test_recognition_summary() {
        ...
        let summary: CgcRecognition = conductor
            .call(&bob_cell.zome("cgc"), "get_recognition_summary", summary_input)
            .await
...
mod cultural_alias_tests {
    ...
    async fn test_cultural_alias() {
        ...
        let alias: CulturalAlias = conductor
            .call(&alice_cell.zome("cgc"), "register_cultural_alias", alias_input)
            .await
        ...
        println!("  - Registered alias: {} -> {}", alias.alias, alias.canonical);
...
mod unit_tests {
    ...
    fn test_cgc_constants() {
        ...
        assert_eq!(HIGH_ACTIVITY_THRESHOLD_VOLUME, 100, "Volume threshold should be 100");
        assert_eq!(HIGH_ACTIVITY_THRESHOLD_SINGLE_SOURCE, 50, "Single source threshold should be 50");
    }
    ...
    fn test_recognition_category_serialization() {
        ...
        for category in categories {
            ...
            let deserialized: ContributionType = serde_json::from_str(&json).expect("Deserialize failed");
