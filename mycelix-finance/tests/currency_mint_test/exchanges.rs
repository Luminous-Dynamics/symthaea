...
/// Test 13.1: Full two-party confirmation flow with pending list queries
#[tokio::test(flavor = "multi_thread")]
#[ignore]
...
/// Test E1: Self-exchange is rejected
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_self_exchange_rejected() {
    ...
    let cell = &apps[0].cells()[0];
    let zome = cell.zome("currency_mint");
    let self_did = format!("did:mycelix:{}", agents[0]);
...
/// Test E2: NaN hours rejected
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_nan_hours_rejected() {
...
/// Test E4: Credit limit enforcement — provider ceiling and receiver floor
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_credit_limit_enforcement() {
...
/// Test E5: Empty service description is rejected
#[tokio::test(flavor = "multi_thread")]
#[ignore]
...
/// Test E13: Double-confirm is idempotent — no double-credit
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_double_confirm_idempotent() {
...
/// Test E14: min_service_minutes boundary enforcement
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_min_service_minutes() {
...
/// Test E15: max_service_hours boundary enforcement
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_max_service_hours() {
...
/// Test E16: NaN and Infinity hours are rejected by is_finite() guard
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_nan_inf_hours_rejected() {
...
/// Test E17: Zero and negative hours are rejected
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_zero_negative_hours_rejected() {
...
/// Test E18: Confirm exchange blocked when currency is suspended mid-flow
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_confirm_on_suspended_currency() {
...
/// Test E20: Daily rate limit enforcement (max_exchanges_per_day)
#[tokio::test(flavor = "multi_thread")]
#[ignore]
async fn test_daily_rate_limit() {
