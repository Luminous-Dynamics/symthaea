...
//!
//! 46 sweettest scenarios covering all 30 coordinator externs.
//!
//! ## Running Tests
//!
//! ```bash
...
//!   record_minted_exchange   → 2.1, 2.2, 12.1, E1, E2, E4, E5, E14, E15, E16, E17
...
//!   get_minted_balance       → 2.1, 3.1, 13.1, 16.1 (demurrage), E18
...
//!   apply_minted_demurrage   → 16.1, E7
//!   apply_demurrage_all      → 18.1, E9
//!   redistribute_compost     → 16.2, E8
//!
//! ### Disputes (3 externs) → disputes.rs
//!   open_minted_dispute      → 8.1, E3, E19
//!   resolve_minted_dispute   → 8.2
//!   get_dispute              → 8.2
